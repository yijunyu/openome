...
//			file.createNewFile();
	...
	public static void nodiff(String output_file, String expected_output_file) {
		try {
			BufferedReader i = new BufferedReader(
					new FileReader(new File(output_file)));
			BufferedReader o = new BufferedReader(
					new FileReader(new File(expected_output_file)));
			try {
				boolean nodiff = true;
				int l= 0;
				for (String a = i.readLine(), b = o.readLine(); a !=null && b!=null; a = i.readLine(), b= o.readLine()) {
					l ++;
					if (!a.equalsIgnoreCase(b)) {
						System.out.println(output_file + "@"+ l + ":" + a);
						System.out.println("--------------------------------");
						System.out.println(expected_output_file + "@"+ l + ":" + b);
						nodiff = false; break;
					}
				}
