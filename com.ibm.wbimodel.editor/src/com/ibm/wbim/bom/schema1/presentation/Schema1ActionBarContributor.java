...
/**
 * This is the action bar contributor for the Schema1 model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Schema1ActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(WbimodelerEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(WbimodelerEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("schema1-settings"));
		toolBarManager.add(new Separator("schema1-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(WbimodelerEditorPlugin.INSTANCE.getString("_UI_Schema1Editor_menu"), "com.ibm.wbim.bom.schema1MenuID");
		...
		//
		createChildMenuManager = new MenuManager(WbimodelerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(WbimodelerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
