...
/**
 * This is the item provider adapter for a {@link org.xmlsoap.schemas.wsdl.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentRoot_arrayType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_arrayType_feature", "_UI_DocumentRoot_type"),
				 WsdlPackage.eINSTANCE.getDocumentRoot_ArrayType(),
				 true,
	...
	protected void addRequiredPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DocumentRoot_required_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_required_feature", "_UI_DocumentRoot_type"),
				 WsdlPackage.eINSTANCE.getDocumentRoot_Required(),
				 true,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WsdlPackage.eINSTANCE.getDocumentRoot_Mixed());
		}
	...
	public String getText(Object object) {
		String label = ((DocumentRoot)object).getArrayType();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WsdlPackage.eINSTANCE.getDocumentRoot_Mixed(),
		...
		newChildDescriptors.add
			(createChildParameter
				(WsdlPackage.eINSTANCE.getDocumentRoot_Mixed(),
				 FeatureMapUtil.createEntry
					(WsdlPackage.eINSTANCE.getDocumentRoot_Definitions(),
					 WsdlFactory.eINSTANCE.createTDefinitions())));
	}
