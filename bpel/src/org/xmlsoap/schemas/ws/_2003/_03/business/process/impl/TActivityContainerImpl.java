...
public class TActivityContainerImpl extends TExtensibleElementsImpl implements TActivityContainer {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.eINSTANCE.getTActivityContainer();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case ProcessPackage.TACTIVITY_CONTAINER__ANY:
					return ((InternalEList)getAny()).basicRemove(otherEnd, msgs);
				case ProcessPackage.TACTIVITY_CONTAINER__ANY_ATTRIBUTE:
