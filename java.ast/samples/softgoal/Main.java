...
public class Main {
	...
	boolean maintainability_debugging = false;
	boolean usability_assured_progress = false;
	boolean usability_language_customization = false;
	boolean usability_look_and_feel = false;
	boolean usability_font_configuration = false;
	...
	private void add_tray_icon_to_system_tray() {
		// Add the tray icon to the System tray
		ColumbaTrayIcon.getInstance().addToSystemTray();
	}

	private void enable_debugging_repaint_manager_for_swing_gui_access() {
