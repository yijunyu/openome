...
public class GroupMembersTypeImpl extends EObjectImpl implements GroupMembersType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getGroupMembersType();
	}
	...
	public void setGroup(String newGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_MEMBERS_TYPE__GROUP, oldGroup, group));
	}
	...
	public void setDomain(String newDomain) {
		...
		domain = newDomain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_MEMBERS_TYPE__DOMAIN, oldDomain, domain));
	}
	...
	public void setIncludeSubgroups(boolean newIncludeSubgroups) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_MEMBERS_TYPE__INCLUDE_SUBGROUPS, oldIncludeSubgroups, includeSubgroups, !oldIncludeSubgroupsESet));
	}
	...
	public void unsetIncludeSubgroups() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Schema1Package.GROUP_MEMBERS_TYPE__INCLUDE_SUBGROUPS, oldIncludeSubgroups, INCLUDE_SUBGROUPS_EDEFAULT, oldIncludeSubgroupsESet));
	}
	...
	public void setAlternativeName1(String newAlternativeName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_MEMBERS_TYPE__ALTERNATIVE_NAME1, oldAlternativeName1, alternativeName1));
	}
	...
	public void setAlternativeName2(String newAlternativeName2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_MEMBERS_TYPE__ALTERNATIVE_NAME2, oldAlternativeName2, alternativeName2));
	}
	...
	public String toString() {
		...
		if (includeSubgroupsESet) result.append(includeSubgroups); else result.append("<unset>");
