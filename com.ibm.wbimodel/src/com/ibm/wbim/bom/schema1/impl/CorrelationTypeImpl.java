...
public class CorrelationTypeImpl extends EObjectImpl implements CorrelationType {
	 ...
	 * @ordered
	 */
	protected static final MultipleInstancesMatch MULTIPLE_INSTANCES_SATISFY_CONDITION_EDEFAULT = MultipleInstancesMatch.TREAT_AS_ERROR_LITERAL;
	 ...
	 * @ordered
	 */
	protected static final NoInstancesMatch NO_INSTANCES_SATISFY_CONDITION_EDEFAULT = NoInstancesMatch.TREAT_AS_ERROR_LITERAL;
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getCorrelationType();
	}
	...
	public NotificationChain basicSetPredicate(Expression newPredicate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.CORRELATION_TYPE__PREDICATE, oldPredicate, newPredicate);
	...
	public void setPredicate(Expression newPredicate) {
		if (newPredicate != predicate) {
			...
			if (predicate != null)
				msgs = ((InternalEObject)predicate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.CORRELATION_TYPE__PREDICATE, null, msgs);
			if (newPredicate != null)
				msgs = ((InternalEObject)newPredicate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.CORRELATION_TYPE__PREDICATE, null, msgs);
			msgs = basicSetPredicate(newPredicate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.CORRELATION_TYPE__PREDICATE, newPredicate, newPredicate));
	}
	 ...
	 * @generated
	 */
	public void setMultipleInstancesSatisfyCondition(MultipleInstancesMatch newMultipleInstancesSatisfyCondition) {
		MultipleInstancesMatch oldMultipleInstancesSatisfyCondition = multipleInstancesSatisfyCondition;
		multipleInstancesSatisfyCondition = newMultipleInstancesSatisfyCondition == null ? MULTIPLE_INSTANCES_SATISFY_CONDITION_EDEFAULT : newMultipleInstancesSatisfyCondition;
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.CORRELATION_TYPE__MULTIPLE_INSTANCES_SATISFY_CONDITION, oldMultipleInstancesSatisfyCondition, multipleInstancesSatisfyCondition, !oldMultipleInstancesSatisfyConditionESet));
	}
	...
	public void unsetMultipleInstancesSatisfyCondition() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Schema1Package.CORRELATION_TYPE__MULTIPLE_INSTANCES_SATISFY_CONDITION, oldMultipleInstancesSatisfyCondition, MULTIPLE_INSTANCES_SATISFY_CONDITION_EDEFAULT, oldMultipleInstancesSatisfyConditionESet));
	}
	 ...
	 * @generated
	 */
	public void setNoInstancesSatisfyCondition(NoInstancesMatch newNoInstancesSatisfyCondition) {
		NoInstancesMatch oldNoInstancesSatisfyCondition = noInstancesSatisfyCondition;
		noInstancesSatisfyCondition = newNoInstancesSatisfyCondition == null ? NO_INSTANCES_SATISFY_CONDITION_EDEFAULT : newNoInstancesSatisfyCondition;
		boolean oldNoInstancesSatisfyConditionESet = noInstancesSatisfyConditionESet;
		noInstancesSatisfyConditionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.CORRELATION_TYPE__NO_INSTANCES_SATISFY_CONDITION, oldNoInstancesSatisfyCondition, noInstancesSatisfyCondition, !oldNoInstancesSatisfyConditionESet));
	}
	...
	public void unsetNoInstancesSatisfyCondition() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Schema1Package.CORRELATION_TYPE__NO_INSTANCES_SATISFY_CONDITION, oldNoInstancesSatisfyCondition, NO_INSTANCES_SATISFY_CONDITION_EDEFAULT, oldNoInstancesSatisfyConditionESet));
	}
	...
	public String toString() {
		...
		if (multipleInstancesSatisfyConditionESet) result.append(multipleInstancesSatisfyCondition); else result.append("<unset>");
		result.append(", noInstancesSatisfyCondition: ");
		if (noInstancesSatisfyConditionESet) result.append(noInstancesSatisfyCondition); else result.append("<unset>");
		result.append(')');
