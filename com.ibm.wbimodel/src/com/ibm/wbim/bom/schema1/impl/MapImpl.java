...
public class MapImpl extends TaskImpl implements Map {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getMap();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case Schema1Package.MAP__INPUTS:
					return basicSetInputs(null, msgs);
				case Schema1Package.MAP__OUTPUTS:
					return basicSetOutputs(null, msgs);
				case Schema1Package.MAP__PRECONDITION:
					return ((InternalEList)getPrecondition()).basicRemove(otherEnd, msgs);
				case Schema1Package.MAP__POSTCONDITION:
					return ((InternalEList)getPostcondition()).basicRemove(otherEnd, msgs);
				case Schema1Package.MAP__RESOURCES:
					return basicSetResources(null, msgs);
				case Schema1Package.MAP__ORGANIZATIONS:
					return basicSetOrganizations(null, msgs);
				case Schema1Package.MAP__OPERATIONAL_DATA:
					return basicSetOperationalData(null, msgs);
				case Schema1Package.MAP__EXTENDED_ATTRIBUTES:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case Schema1Package.MAP__DESCRIPTION:
