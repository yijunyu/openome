...
public class DistributionTypeImpl extends EObjectImpl implements DistributionType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getDistributionType();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExponential(ExponentialType newExponential, NotificationChain msgs) {
		ExponentialType oldExponential = exponential;
		exponential = newExponential;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__EXPONENTIAL, oldExponential, newExponential);
	...
	public void setExponential(ExponentialType newExponential) {
		if (newExponential != exponential) {
			...
			if (exponential != null)
				msgs = ((InternalEObject)exponential).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__EXPONENTIAL, null, msgs);
			if (newExponential != null)
				msgs = ((InternalEObject)newExponential).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__EXPONENTIAL, null, msgs);
			msgs = basicSetExponential(newExponential, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__EXPONENTIAL, newExponential, newExponential));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGamma(GammaType newGamma, NotificationChain msgs) {
		GammaType oldGamma = gamma;
		gamma = newGamma;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__GAMMA, oldGamma, newGamma);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGamma(GammaType newGamma) {
		if (newGamma != gamma) {
			NotificationChain msgs = null;
			if (gamma != null)
				msgs = ((InternalEObject)gamma).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__GAMMA, null, msgs);
			if (newGamma != null)
				msgs = ((InternalEObject)newGamma).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__GAMMA, null, msgs);
			msgs = basicSetGamma(newGamma, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__GAMMA, newGamma, newGamma));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLognormal(LognormalType newLognormal, NotificationChain msgs) {
		LognormalType oldLognormal = lognormal;
		lognormal = newLognormal;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__LOGNORMAL, oldLognormal, newLognormal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLognormal(LognormalType newLognormal) {
		if (newLognormal != lognormal) {
			NotificationChain msgs = null;
			if (lognormal != null)
				msgs = ((InternalEObject)lognormal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__LOGNORMAL, null, msgs);
			if (newLognormal != null)
				msgs = ((InternalEObject)newLognormal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__LOGNORMAL, null, msgs);
			msgs = basicSetLognormal(newLognormal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__LOGNORMAL, newLognormal, newLognormal));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNormal(NormalType newNormal, NotificationChain msgs) {
		NormalType oldNormal = normal;
		normal = newNormal;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__NORMAL, oldNormal, newNormal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNormal(NormalType newNormal) {
		if (newNormal != normal) {
			NotificationChain msgs = null;
			if (normal != null)
				msgs = ((InternalEObject)normal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__NORMAL, null, msgs);
			if (newNormal != null)
				msgs = ((InternalEObject)newNormal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__NORMAL, null, msgs);
			msgs = basicSetNormal(newNormal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__NORMAL, newNormal, newNormal));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPoisson(PoissonType newPoisson, NotificationChain msgs) {
		PoissonType oldPoisson = poisson;
		poisson = newPoisson;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__POISSON, oldPoisson, newPoisson);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPoisson(PoissonType newPoisson) {
		if (newPoisson != poisson) {
			NotificationChain msgs = null;
			if (poisson != null)
				msgs = ((InternalEObject)poisson).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__POISSON, null, msgs);
			if (newPoisson != null)
				msgs = ((InternalEObject)newPoisson).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__POISSON, null, msgs);
			msgs = basicSetPoisson(newPoisson, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__POISSON, newPoisson, newPoisson));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRandomList(RandomListType newRandomList, NotificationChain msgs) {
		RandomListType oldRandomList = randomList;
		randomList = newRandomList;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__RANDOM_LIST, oldRandomList, newRandomList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRandomList(RandomListType newRandomList) {
		if (newRandomList != randomList) {
			NotificationChain msgs = null;
			if (randomList != null)
				msgs = ((InternalEObject)randomList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__RANDOM_LIST, null, msgs);
			if (newRandomList != null)
				msgs = ((InternalEObject)newRandomList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__RANDOM_LIST, null, msgs);
			msgs = basicSetRandomList(newRandomList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__RANDOM_LIST, newRandomList, newRandomList));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetUniform(UniformType newUniform, NotificationChain msgs) {
		UniformType oldUniform = uniform;
		uniform = newUniform;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__UNIFORM, oldUniform, newUniform);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUniform(UniformType newUniform) {
		if (newUniform != uniform) {
			NotificationChain msgs = null;
			if (uniform != null)
				msgs = ((InternalEObject)uniform).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__UNIFORM, null, msgs);
			if (newUniform != null)
				msgs = ((InternalEObject)newUniform).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__UNIFORM, null, msgs);
			msgs = basicSetUniform(newUniform, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__UNIFORM, newUniform, newUniform));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetWeightedList(WeightedListType newWeightedList, NotificationChain msgs) {
		WeightedListType oldWeightedList = weightedList;
		weightedList = newWeightedList;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__WEIGHTED_LIST, oldWeightedList, newWeightedList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWeightedList(WeightedListType newWeightedList) {
		if (newWeightedList != weightedList) {
			...
			if (weightedList != null)
				msgs = ((InternalEObject)weightedList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__WEIGHTED_LIST, null, msgs);
			if (newWeightedList != null)
				msgs = ((InternalEObject)newWeightedList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.DISTRIBUTION_TYPE__WEIGHTED_LIST, null, msgs);
			msgs = basicSetWeightedList(newWeightedList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.DISTRIBUTION_TYPE__WEIGHTED_LIST, newWeightedList, newWeightedList));
	}
