...
public class BulkResourceRequirementImpl extends EObjectImpl implements BulkResourceRequirement {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getBulkResourceRequirement();
	}
	...
	public NotificationChain basicSetResourceQuantity(Quantity newResourceQuantity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.BULK_RESOURCE_REQUIREMENT__RESOURCE_QUANTITY, oldResourceQuantity, newResourceQuantity);
	...
	public void setResourceQuantity(Quantity newResourceQuantity) {
		if (newResourceQuantity != resourceQuantity) {
			...
			if (resourceQuantity != null)
				msgs = ((InternalEObject)resourceQuantity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.BULK_RESOURCE_REQUIREMENT__RESOURCE_QUANTITY, null, msgs);
			if (newResourceQuantity != null)
				msgs = ((InternalEObject)newResourceQuantity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.BULK_RESOURCE_REQUIREMENT__RESOURCE_QUANTITY, null, msgs);
			msgs = basicSetResourceQuantity(newResourceQuantity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.BULK_RESOURCE_REQUIREMENT__RESOURCE_QUANTITY, newResourceQuantity, newResourceQuantity));
	}
	...
	public void setBulkResource(String newBulkResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.BULK_RESOURCE_REQUIREMENT__BULK_RESOURCE, oldBulkResource, bulkResource));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.BULK_RESOURCE_REQUIREMENT__NAME, oldName, name));
	}
	...
	public boolean eIsSet(EStructuralFeature eFeature) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case Schema1Package.BULK_RESOURCE_REQUIREMENT__BULK_RESOURCE:
				return BULK_RESOURCE_EDEFAULT == null ? bulkResource != null : !BULK_RESOURCE_EDEFAULT.equals(bulkResource);
			case Schema1Package.BULK_RESOURCE_REQUIREMENT__NAME:
