...
public class FlowContentTypeImpl extends EObjectImpl implements FlowContentType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getFlowContentType();
	}
	...
	public EList getStartNode() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_StartNode());
	}
	...
	public EList getStopNode() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_StopNode());
	}
	...
	public EList getEndNode() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_EndNode());
	}
	...
	public EList getTask() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Task());
	}
	...
	public EList getDecision() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Decision());
	}
	...
	public EList getMerge() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Merge());
	}
	...
	public EList getFork() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Fork());
	}
	...
	public EList getJoin() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Join());
	}
	...
	public EList getNotificationBroadcaster() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_NotificationBroadcaster());
	}
	...
	public EList getNotificationReceiver() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_NotificationReceiver());
	}
	...
	public EList getObserver() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Observer());
	}
	...
	public EList getTimer() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Timer());
	}
	 ...
	 */
	public EList getMap() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Map());
	}
	...
	public EList getLoop() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Loop());
	}
	...
	public EList getForLoop() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_ForLoop());
	}
	...
	public EList getProcess() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Process());
	}
	...
	public EList getLocalRepository() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_LocalRepository());
	}
	...
	public EList getCallToProcess() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_CallToProcess());
	}
	...
	public EList getCallToTask() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_CallToTask());
	}
	...
	public EList getCallToService() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_CallToService());
	}
	...
	public EList getConnection() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Connection());
	}
	...
	public EList getAnnotation() {
		return ((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getFlowContentType_Annotation());
	}
