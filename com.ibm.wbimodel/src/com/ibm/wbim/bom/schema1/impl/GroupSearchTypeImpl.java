...
public class GroupSearchTypeImpl extends EObjectImpl implements GroupSearchType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getGroupSearchType();
	}
	...
	public void setGroupId(String newGroupId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__GROUP_ID, oldGroupId, groupId));
	}
	...
	public void setProfile(String newProfile) {
		...
		profile = newProfile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__PROFILE, oldProfile, profile));
	}
	...
	public void setIndustryType(String newIndustryType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__INDUSTRY_TYPE, oldIndustryType, industryType));
	}
	...
	public void setBusinessType(String newBusinessType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__BUSINESS_TYPE, oldBusinessType, businessType));
	}
	...
	public void setGeographicLocation(String newGeographicLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__GEOGRAPHIC_LOCATION, oldGeographicLocation, geographicLocation));
	}
	...
	public void setAffiliates(String newAffiliates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__AFFILIATES, oldAffiliates, affiliates));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__DISPLAY_NAME, oldDisplayName, displayName));
	}
	...
	public void setSecretary(String newSecretary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__SECRETARY, oldSecretary, secretary));
	}
	...
	public void setAssistant(String newAssistant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__ASSISTANT, oldAssistant, assistant));
	}
	...
	public void setManager(String newManager) {
		...
		manager = newManager;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__MANAGER, oldManager, manager));
	}
	...
	public void setBusinessCategory(String newBusinessCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__BUSINESS_CATEGORY, oldBusinessCategory, businessCategory));
	}
	...
	public void setParentCompany(String newParentCompany) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GROUP_SEARCH_TYPE__PARENT_COMPANY, oldParentCompany, parentCompany));
	}
	...
	public boolean eIsSet(EStructuralFeature eFeature) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case Schema1Package.GROUP_SEARCH_TYPE__INDUSTRY_TYPE:
				return INDUSTRY_TYPE_EDEFAULT == null ? industryType != null : !INDUSTRY_TYPE_EDEFAULT.equals(industryType);
			case Schema1Package.GROUP_SEARCH_TYPE__BUSINESS_TYPE:
				return BUSINESS_TYPE_EDEFAULT == null ? businessType != null : !BUSINESS_TYPE_EDEFAULT.equals(businessType);
			case Schema1Package.GROUP_SEARCH_TYPE__GEOGRAPHIC_LOCATION:
				return GEOGRAPHIC_LOCATION_EDEFAULT == null ? geographicLocation != null : !GEOGRAPHIC_LOCATION_EDEFAULT.equals(geographicLocation);
			case Schema1Package.GROUP_SEARCH_TYPE__AFFILIATES:
				return AFFILIATES_EDEFAULT == null ? affiliates != null : !AFFILIATES_EDEFAULT.equals(affiliates);
			case Schema1Package.GROUP_SEARCH_TYPE__DISPLAY_NAME:
			...
			case Schema1Package.GROUP_SEARCH_TYPE__PARENT_COMPANY:
				return PARENT_COMPANY_EDEFAULT == null ? parentCompany != null : !PARENT_COMPANY_EDEFAULT.equals(parentCompany);
		}
