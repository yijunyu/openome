...
public class ExtendedAttributeTypeImpl extends EObjectImpl implements ExtendedAttributeType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getExtendedAttributeType();
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)((FeatureMap)getMixed()).list(Schema1Package.eINSTANCE.getExtendedAttributeType_Group());
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap)((FeatureMap)getGroup()).list(Schema1Package.eINSTANCE.getExtendedAttributeType_Any());
	}
