...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gamma Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.ibm.wbim.bom.schema1.impl.GammaTypeImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link com.ibm.wbim.bom.schema1.impl.GammaTypeImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GammaTypeImpl extends EObjectImpl implements GammaType {
	/**
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getGammaType();
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GAMMA_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Schema1Package.GAMMA_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public void setStandardDeviation(double newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.GAMMA_TYPE__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation, !oldStandardDeviationESet));
	}
	...
	public void unsetStandardDeviation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Schema1Package.GAMMA_TYPE__STANDARD_DEVIATION, oldStandardDeviation, STANDARD_DEVIATION_EDEFAULT, oldStandardDeviationESet));
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case Schema1Package.GAMMA_TYPE__MEAN:
				return new Double(getMean());
			case Schema1Package.GAMMA_TYPE__STANDARD_DEVIATION:
