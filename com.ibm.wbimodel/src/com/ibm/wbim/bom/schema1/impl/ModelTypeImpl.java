...
public class ModelTypeImpl extends EObjectImpl implements ModelType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.eINSTANCE.getModelType();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCatalogs(CatalogsType newCatalogs, NotificationChain msgs) {
		CatalogsType oldCatalogs = catalogs;
		catalogs = newCatalogs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__CATALOGS, oldCatalogs, newCatalogs);
	...
	public void setCatalogs(CatalogsType newCatalogs) {
		if (newCatalogs != catalogs) {
			...
			if (catalogs != null)
				msgs = ((InternalEObject)catalogs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__CATALOGS, null, msgs);
			if (newCatalogs != null)
				msgs = ((InternalEObject)newCatalogs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__CATALOGS, null, msgs);
			msgs = basicSetCatalogs(newCatalogs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__CATALOGS, newCatalogs, newCatalogs));
	}
	...
	public NotificationChain basicSetDataModel(DataModel newDataModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__DATA_MODEL, oldDataModel, newDataModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDataModel(DataModel newDataModel) {
		if (newDataModel != dataModel) {
			NotificationChain msgs = null;
			if (dataModel != null)
				msgs = ((InternalEObject)dataModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__DATA_MODEL, null, msgs);
			if (newDataModel != null)
				msgs = ((InternalEObject)newDataModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__DATA_MODEL, null, msgs);
			msgs = basicSetDataModel(newDataModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__DATA_MODEL, newDataModel, newDataModel));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetResourceModel(ResourceModel newResourceModel, NotificationChain msgs) {
		ResourceModel oldResourceModel = resourceModel;
		resourceModel = newResourceModel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__RESOURCE_MODEL, oldResourceModel, newResourceModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResourceModel(ResourceModel newResourceModel) {
		if (newResourceModel != resourceModel) {
			...
			if (resourceModel != null)
				msgs = ((InternalEObject)resourceModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__RESOURCE_MODEL, null, msgs);
			if (newResourceModel != null)
				msgs = ((InternalEObject)newResourceModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__RESOURCE_MODEL, null, msgs);
			msgs = basicSetResourceModel(newResourceModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__RESOURCE_MODEL, newResourceModel, newResourceModel));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrganizationModel(OrganizationModel newOrganizationModel, NotificationChain msgs) {
		OrganizationModel oldOrganizationModel = organizationModel;
		organizationModel = newOrganizationModel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__ORGANIZATION_MODEL, oldOrganizationModel, newOrganizationModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOrganizationModel(OrganizationModel newOrganizationModel) {
		if (newOrganizationModel != organizationModel) {
			...
			if (organizationModel != null)
				msgs = ((InternalEObject)organizationModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__ORGANIZATION_MODEL, null, msgs);
			if (newOrganizationModel != null)
				msgs = ((InternalEObject)newOrganizationModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__ORGANIZATION_MODEL, null, msgs);
			msgs = basicSetOrganizationModel(newOrganizationModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__ORGANIZATION_MODEL, newOrganizationModel, newOrganizationModel));
	}
	...
	public NotificationChain basicSetProcessModel(ProcessModel newProcessModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__PROCESS_MODEL, oldProcessModel, newProcessModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessModel(ProcessModel newProcessModel) {
		if (newProcessModel != processModel) {
			...
			if (processModel != null)
				msgs = ((InternalEObject)processModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__PROCESS_MODEL, null, msgs);
			if (newProcessModel != null)
				msgs = ((InternalEObject)newProcessModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Schema1Package.MODEL_TYPE__PROCESS_MODEL, null, msgs);
			msgs = basicSetProcessModel(newProcessModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__PROCESS_MODEL, newProcessModel, newProcessModel));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__NAME, oldName, name));
	}
	...
	public void setSchemaVersion(String newSchemaVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Schema1Package.MODEL_TYPE__SCHEMA_VERSION, oldSchemaVersion, schemaVersion, !oldSchemaVersionESet));
	}
	...
	public void unsetSchemaVersion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Schema1Package.MODEL_TYPE__SCHEMA_VERSION, oldSchemaVersion, SCHEMA_VERSION_EDEFAULT, oldSchemaVersionESet));
	}
