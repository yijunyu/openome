...
public final class MultipleInstancesMatch extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final MultipleInstancesMatch TREAT_AS_ERROR_LITERAL = new MultipleInstancesMatch(TREAT_AS_ERROR, "TREAT_AS_ERROR");
	 ...
	 * @ordered
	 */
	public static final MultipleInstancesMatch DISCARD_INPUT_LITERAL = new MultipleInstancesMatch(DISCARD_INPUT, "DISCARD_INPUT");
	 ...
	 * @ordered
	 */
	public static final MultipleInstancesMatch DELIVER_TO_ALL_INSTANCES_LITERAL = new MultipleInstancesMatch(DELIVER_TO_ALL_INSTANCES, "DELIVER_TO_ALL_INSTANCES");
	 ...
	 * @ordered
	 */
	public static final MultipleInstancesMatch DELIVER_TO_ANY_INSTANCE_LITERAL = new MultipleInstancesMatch(DELIVER_TO_ANY_INSTANCE, "DELIVER_TO_ANY_INSTANCE");
	 ...
	 * @generated
	 */
	public static MultipleInstancesMatch get(String name) {
	...
	/**
	 * Returns the '<em><b>Multiple Instances Match</b></em>' literal with the specified value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private MultipleInstancesMatch(int value, String name) {
		super(value, name);
	}
