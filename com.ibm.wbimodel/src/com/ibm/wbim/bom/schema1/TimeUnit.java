...
public final class TimeUnit extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final TimeUnit YEAR_LITERAL = new TimeUnit(YEAR, "Year");
	 ...
	 * @ordered
	 */
	public static final TimeUnit MONTH_LITERAL = new TimeUnit(MONTH, "Month");
	 ...
	 * @ordered
	 */
	public static final TimeUnit DAY_LITERAL = new TimeUnit(DAY, "Day");
	 ...
	 * @ordered
	 */
	public static final TimeUnit HOUR_LITERAL = new TimeUnit(HOUR, "Hour");
	 ...
	 * @ordered
	 */
	public static final TimeUnit MINUTE_LITERAL = new TimeUnit(MINUTE, "Minute");
	 ...
	 * @ordered
	 */
	public static final TimeUnit SECOND_LITERAL = new TimeUnit(SECOND, "Second");
	...
	/**
	 * Returns the '<em><b>Time Unit</b></em>' literal with the specified value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
