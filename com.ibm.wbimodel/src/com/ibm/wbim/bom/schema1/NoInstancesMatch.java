...
public final class NoInstancesMatch extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final NoInstancesMatch TREAT_AS_ERROR_LITERAL = new NoInstancesMatch(TREAT_AS_ERROR, "TREAT_AS_ERROR");
	 ...
	 * @ordered
	 */
	public static final NoInstancesMatch DISCARD_INPUT_LITERAL = new NoInstancesMatch(DISCARD_INPUT, "DISCARD_INPUT");
	 ...
	 * @ordered
	 */
	public static final NoInstancesMatch CREATE_NEW_INSTANCE_LITERAL = new NoInstancesMatch(CREATE_NEW_INSTANCE, "CREATE_NEW_INSTANCE");
	 ...
	 * @generated
	 */
	public static NoInstancesMatch get(String name) {
	...
	/**
	 * Returns the '<em><b>No Instances Match</b></em>' literal with the specified value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private NoInstancesMatch(int value, String name) {
		super(value, name);
	}
