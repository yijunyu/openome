 ...
 * @generated
 */
public class BoxViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = MyEditor.diagram.part.MyeditorVisualIDRegistry
					.getType(MyEditor.diagram.edit.parts.BoxEditPart.VISUAL_ID);
		...
		if (!MyEditor.diagram.edit.parts.MyCanvasEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put(
							"modelID", MyEditor.diagram.edit.parts.MyCanvasEditPart.MODEL_ID); //$NON-NLS-1$
