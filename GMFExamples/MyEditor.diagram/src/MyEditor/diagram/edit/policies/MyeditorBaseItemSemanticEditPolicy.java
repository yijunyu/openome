 ...
 * @generated
 */
public class MyeditorBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest
					.setParameter(
							MyEditor.diagram.edit.helpers.MyeditorBaseEditHelper.EDIT_POLICY_COMMAND,
							command);
		}
		if (elementType != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateLine_3001(MyEditor.MyCanvas container,
				MyEditor.Box source, MyEditor.Box target) {
			return canExistLine_3001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistLine_3001(MyEditor.MyCanvas container,
				MyEditor.Box source, MyEditor.Box target) {
