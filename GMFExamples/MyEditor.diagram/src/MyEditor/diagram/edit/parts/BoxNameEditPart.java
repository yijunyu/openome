...
public class BoxNameEditPart extends CompartmentEditPart implements
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof MyEditor.diagram.edit.policies.MyeditorTextSelectionEditPolicy) {
			((MyEditor.diagram.edit.policies.MyeditorTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					...
					MyEditor.diagram.edit.parts.MyeditorEditPartFactory
