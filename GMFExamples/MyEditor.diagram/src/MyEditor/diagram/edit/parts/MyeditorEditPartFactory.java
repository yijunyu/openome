 ...
 * @generated
 */
public class MyeditorEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case MyEditor.diagram.edit.parts.MyCanvasEditPart.VISUAL_ID:
				return new MyEditor.diagram.edit.parts.MyCanvasEditPart(view);

			case MyEditor.diagram.edit.parts.BoxEditPart.VISUAL_ID:
				return new MyEditor.diagram.edit.parts.BoxEditPart(view);

			case MyEditor.diagram.edit.parts.BoxNameEditPart.VISUAL_ID:
				return new MyEditor.diagram.edit.parts.BoxNameEditPart(view);

			case MyEditor.diagram.edit.parts.LineEditPart.VISUAL_ID:
				return new MyEditor.diagram.edit.parts.LineEditPart(view);
			}
		}
