 ...
 * @generated
 */
public class MyeditorViewProvider extends AbstractViewProvider {
	...
	protected Class getDiagramViewClass(IAdaptable semanticAdapter,
		...
		if (MyEditor.diagram.edit.parts.MyCanvasEditPart.MODEL_ID
			...
			return MyEditor.diagram.view.factories.MyCanvasViewFactory.class;
		}
		return null;
	}
	...
	protected Class getNodeViewClass(IAdaptable semanticAdapter,
		...
		if (semanticHint == null) {
			...
			visualID = MyEditor.diagram.part.MyeditorVisualIDRegistry
			...
			if (elementType != null) {
				...
				case MyEditor.diagram.edit.parts.BoxNameEditPart.VISUAL_ID:
					if (MyEditor.diagram.edit.parts.BoxEditPart.VISUAL_ID != MyEditor.diagram.part.MyeditorVisualIDRegistry
	...
	protected Class getNodeViewClass(View containerView, int visualID) {
		...
		switch (visualID) {
		case MyEditor.diagram.edit.parts.BoxEditPart.VISUAL_ID:
			return MyEditor.diagram.view.factories.BoxViewFactory.class;
		case MyEditor.diagram.edit.parts.BoxNameEditPart.VISUAL_ID:
			return MyEditor.diagram.view.factories.BoxNameViewFactory.class;
		}
		return null;
	}
	...
	protected Class getEdgeViewClass(int visualID) {
		...
		case MyEditor.diagram.edit.parts.LineEditPart.VISUAL_ID:
			return MyEditor.diagram.view.factories.LineViewFactory.class;
		}
		return null;
	}
