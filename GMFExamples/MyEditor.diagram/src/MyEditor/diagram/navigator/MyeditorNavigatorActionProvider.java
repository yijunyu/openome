 ...
 * @generated
 */
public class MyeditorNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					MyEditor.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof MyEditor.diagram.navigator.MyeditorNavigatorItem) {
					selectedElement = ((MyEditor.diagram.navigator.MyeditorNavigatorItem) selectedElement)
							.getView();
