...
/**
 * This is the action bar contributor for the Goalmodel model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoalmodelActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(GoalEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(GoalEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(GoalEditorPlugin.INSTANCE.getString("_UI_GoalmodelEditor_menu"), "edu.toronto.cs.goalmodelMenuID");
		...
		//
		createChildMenuManager = new MenuManager(GoalEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(GoalEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
