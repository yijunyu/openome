...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>goalmodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GoalmodelExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.goalmodel"));
				actor root = GoalmodelFactory.eINSTANCE.createactor();
