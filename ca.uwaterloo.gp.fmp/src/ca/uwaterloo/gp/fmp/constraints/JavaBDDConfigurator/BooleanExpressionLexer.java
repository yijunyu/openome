...
// $ANTLR 2.7.5 (20050201): "t5.g" -> "BooleanExpressionLexer.java"$
...
public class BooleanExpressionLexer extends antlr.CharScanner implements BooleanExpressionParserTokenTypes, TokenStream
 {
public BooleanExpressionLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public BooleanExpressionLexer(Reader in) {
	this(new CharBuffer(in));
}
public BooleanExpressionLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public BooleanExpressionLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("false", this), new Integer(8));
	literals.put(new ANTLRHashString("exists", this), new Integer(10));
	literals.put(new ANTLRHashString("true", this), new Integer(7));
	literals.put(new ANTLRHashString("for all", this), new Integer(9));
