...
public class FmpPackageImpl extends EPackageImpl implements FmpPackage {
	...
	public static FmpPackage init() {
		...
		FmpPackageImpl theFmpPackage = (FmpPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof FmpPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new FmpPackageImpl());
