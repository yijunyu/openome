 ...
 */
public class MakeMandatoryAction extends CommandActionHandler {
	AdapterFactory adapterFactory;
	
	public MakeMandatoryAction(EditingDomain domain) {
		super(domain, "Make Mandatory");
		command = UnexecutableCommand.INSTANCE;
	}
	public MakeMandatoryAction()  {
	    super(null, "Make Mandatory");
	    command = UnexecutableCommand.INSTANCE;
	}
	...
	public Command createCommand(Collection selection) {
		if (selection.size() == 1) {
			...
			return new MakeMandatoryOptionalCommand(domain, obj, true);
		}
		else
