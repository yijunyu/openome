...
public class MultiLineTableCellEditor extends CellEditor {
	...
	private static final int SINGLE_LINE_HEIGHT = 21;
	...
	private ExtendedTableEditor tableEditor;
     ...
     * 
     */
    public MultiLineTableCellEditor(ExtendedTableEditor editor, Table parent, int style) {
        super(parent, style);
        this.tableEditor = editor;
        tableEditor.minimumHeight = SINGLE_LINE_HEIGHT;
...
//   	    button.setImage((Image) featureMdlEditPlugin.INSTANCE.getImage("full/obj16/Unchecked"));
    	...
    	text.addFocusListener(new FocusAdapter() {
    		public void focusLost(FocusEvent e) {
    		    if (!button.isFocusControl()) {
        		    MultiLineTableCellEditor.this.focusLost();
    ...
    public void performSizeChange() {
        if (!multiline) {
		    ...
		    tableEditor.minimumHeight = MULTI_LINE_HEIGHT;
