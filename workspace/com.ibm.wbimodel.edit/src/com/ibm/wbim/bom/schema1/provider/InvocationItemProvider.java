...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.Invocation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InvocationItemProvider extends ItemProviderAdapter implements
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCallSynchronouslyPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Call Synchronously feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCallSynchronouslyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Invocation_callSynchronously_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Invocation_callSynchronously_feature",
						"_UI_Invocation_type"),
				Schema1Package.Literals.INVOCATION__CALL_SYNCHRONOUSLY, true,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Invocation_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Invocation_name_feature", "_UI_Invocation_type"),
				Schema1Package.Literals.INVOCATION__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.INVOCATION__INPUT_CONSTANT_VALUE);
			childrenFeatures
					.add(Schema1Package.Literals.INVOCATION__INPUT_REPOSITORY_VALUE);
			childrenFeatures
					.add(Schema1Package.Literals.INVOCATION__OUTPUT_REPOSITORY_VALUE);
			childrenFeatures
					.add(Schema1Package.Literals.INVOCATION__ADDITIONAL_INPUT);
			childrenFeatures
					.add(Schema1Package.Literals.INVOCATION__ADDITIONAL_OUTPUT);
		}
