 ...
 * @generated
 */
public class CostPerQuantityAndTimeUnitItemProvider
	extends CostPerQuantityItemProvider
	implements	
	...
	public String getText(Object object) {
		String label = ((CostPerQuantityAndTimeUnit)object).getUnit();
		return label == null || label.length() == 0 ?
			getString("_UI_CostPerQuantityAndTimeUnit_type") :
			getString("_UI_CostPerQuantityAndTimeUnit_type") + " " + label;
	}
