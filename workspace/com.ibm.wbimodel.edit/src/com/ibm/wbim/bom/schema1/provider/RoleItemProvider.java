...
public class RoleItemProvider extends ItemProviderAdapter implements
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Role_documentation_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Role_documentation_feature", "_UI_Role_type"),
				Schema1Package.Literals.ROLE__DOCUMENTATION, true, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Schema1Package.Literals.ROLE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.ROLE__INDIVIDUAL_RESOURCE_COST_TYPE);
			childrenFeatures.add(Schema1Package.Literals.ROLE__AVAILABILITY);
			childrenFeatures
					.add(Schema1Package.Literals.ROLE__EXTENDED_ATTRIBUTES);
		}
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == Schema1Package.Literals.ROLE__ONE_TIME_COST
