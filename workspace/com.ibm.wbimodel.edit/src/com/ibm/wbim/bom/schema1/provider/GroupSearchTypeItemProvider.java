 ...
 * @generated
 */
public class GroupSearchTypeItemProvider extends ItemProviderAdapter implements
	...
	protected void addGroupIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_GroupSearchType_groupId_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_groupId_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__GROUP_ID, true,
	...
	protected void addProfilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_GroupSearchType_profile_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_profile_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__PROFILE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addIndustryTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_industryType_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__INDUSTRY_TYPE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addBusinessTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_businessType_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__BUSINESS_TYPE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addGeographicLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_geographicLocation_feature",
						"_UI_GroupSearchType_type"),
	...
	protected void addAffiliatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_GroupSearchType_affiliates_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_affiliates_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__AFFILIATES, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addDisplayNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_displayName_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__DISPLAY_NAME, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addSecretaryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_GroupSearchType_secretary_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_secretary_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__SECRETARY, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addAssistantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_GroupSearchType_assistant_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_assistant_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__ASSISTANT, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addManagerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_GroupSearchType_manager_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_manager_feature",
						"_UI_GroupSearchType_type"),
				Schema1Package.Literals.GROUP_SEARCH_TYPE__MANAGER, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addBusinessCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_businessCategory_feature",
						"_UI_GroupSearchType_type"),
	...
	protected void addParentCompanyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GroupSearchType_parentCompany_feature",
						"_UI_GroupSearchType_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_GroupSearchType_type")
