...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider extends ItemProviderAdapter implements
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Connection_description_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Connection_description_feature",
						"_UI_Connection_type"),
				Schema1Package.Literals.CONNECTION__DESCRIPTION, true, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Connection_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Connection_name_feature", "_UI_Connection_type"),
				Schema1Package.Literals.CONNECTION__NAME, true, false, false,
