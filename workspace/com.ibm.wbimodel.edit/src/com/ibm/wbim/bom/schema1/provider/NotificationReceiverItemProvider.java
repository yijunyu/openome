...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.NotificationReceiver} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NotificationReceiverItemProvider extends TaskItemProvider
	 ...
	 * @generated
	 */
	public NotificationReceiverItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNotificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_NotificationReceiver_notification_feature",
						"_UI_NotificationReceiver_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.NOTIFICATION_RECEIVER__NOTIFICATION_FILTER);
		}
	...
	/**
	 * This returns NotificationReceiver.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/NotificationReceiver"));
	}
	...
	public String getText(Object object) {
		String label = ((NotificationReceiver) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_NotificationReceiver_type")
				: getString("_UI_NotificationReceiver_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NotificationReceiver.class)) {
