...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends ItemProviderAdapter implements
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Attribute_description_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Attribute_description_feature",
						"_UI_Attribute_type"),
				Schema1Package.Literals.ATTRIBUTE__DESCRIPTION, true, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Attribute_isOrdered_feature",
								"_UI_Attribute_type"),
						Schema1Package.Literals.ATTRIBUTE__IS_ORDERED, true,
						false, false,
	...
	protected void addIsReadOnlyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Attribute_isReadOnly_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Attribute_isReadOnly_feature",
						"_UI_Attribute_type"),
				Schema1Package.Literals.ATTRIBUTE__IS_READ_ONLY, true, false,
	...
	protected void addIsStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(), getResourceLocator(),
						getString("_UI_Attribute_isStatic_feature"), getString(
								"_UI_PropertyDescriptor_description",
								"_UI_Attribute_isStatic_feature",
								"_UI_Attribute_type"),
						Schema1Package.Literals.ATTRIBUTE__IS_STATIC, true,
						false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addIsUniquePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(), getResourceLocator(),
						getString("_UI_Attribute_isUnique_feature"), getString(
								"_UI_PropertyDescriptor_description",
								"_UI_Attribute_isUnique_feature",
								"_UI_Attribute_type"),
						Schema1Package.Literals.ATTRIBUTE__IS_UNIQUE, true,
						false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addMaximumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Attribute_maximum_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Attribute_maximum_feature", "_UI_Attribute_type"),
				Schema1Package.Literals.ATTRIBUTE__MAXIMUM, true, false, false,
	...
	protected void addMinimumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Attribute_minimum_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Attribute_minimum_feature", "_UI_Attribute_type"),
				Schema1Package.Literals.ATTRIBUTE__MINIMUM, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Attribute_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Attribute_name_feature", "_UI_Attribute_type"),
				Schema1Package.Literals.ATTRIBUTE__NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Schema1Package.Literals.ATTRIBUTE__TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.ATTRIBUTE__DEFAULT_VALUE);
		}
