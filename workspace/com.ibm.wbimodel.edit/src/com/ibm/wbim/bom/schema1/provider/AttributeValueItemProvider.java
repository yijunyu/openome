...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.AttributeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeValueItemProvider extends ItemProviderAdapter implements
	...
	protected void addLiteralValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_AttributeValue_literalValue_feature",
						"_UI_AttributeValue_type"),
				Schema1Package.Literals.ATTRIBUTE_VALUE__LITERAL_VALUE, true,
	...
	protected void addAttributePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_AttributeValue_attribute_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_AttributeValue_attribute_feature",
						"_UI_AttributeValue_type"),
				Schema1Package.Literals.ATTRIBUTE_VALUE__ATTRIBUTE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.ATTRIBUTE_VALUE__GROUP);
		}
	...
	public String getText(Object object) {
		String label = ((AttributeValue) object).getAttribute();
