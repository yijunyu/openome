...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.Join} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JoinItemProvider extends ItemProviderAdapter implements
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Join_description_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Join_description_feature", "_UI_Join_type"),
				Schema1Package.Literals.JOIN__DESCRIPTION, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Join_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Join_name_feature", "_UI_Join_type"),
				Schema1Package.Literals.JOIN__NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
