 ...
 * @generated
 */
public class ProcessItemProvider extends ItemProviderAdapter implements
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Process_description_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Process_description_feature", "_UI_Process_type"),
				Schema1Package.Literals.PROCESS__DESCRIPTION, true, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Process_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Process_name_feature", "_UI_Process_type"),
				Schema1Package.Literals.PROCESS__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.PROCESS__POSTCONDITION);
			childrenFeatures
					.add(Schema1Package.Literals.PROCESS__ORGANIZATIONS);
			childrenFeatures
					.add(Schema1Package.Literals.PROCESS__OPERATIONAL_DATA);
			childrenFeatures.add(Schema1Package.Literals.PROCESS__FLOW_CONTENT);
			childrenFeatures
					.add(Schema1Package.Literals.PROCESS__EXTENDED_ATTRIBUTES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification
				.getFeatureID(com.ibm.wbim.bom.schema1.Process.class)) {
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == Schema1Package.Literals.PROCESS__PRECONDITION
