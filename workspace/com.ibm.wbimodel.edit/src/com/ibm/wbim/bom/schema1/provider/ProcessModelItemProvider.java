...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.ProcessModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessModelItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.PROCESS_MODEL__PROCESSES);
			childrenFeatures.add(Schema1Package.Literals.PROCESS_MODEL__TASKS);
			childrenFeatures
					.add(Schema1Package.Literals.PROCESS_MODEL__REPOSITORIES);
			childrenFeatures
					.add(Schema1Package.Literals.PROCESS_MODEL__SERVICES);
		}
	...
	public String getText(Object object) {
		return getString("_UI_ProcessModel_type");
	}
