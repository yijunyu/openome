 ...
 * @generated
 */
public class ResourceModelItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.RESOURCE_MODEL__INDIVIDUAL_RESOURCE_DEFINITION_TEMPLATES);
			childrenFeatures
					.add(Schema1Package.Literals.RESOURCE_MODEL__INDIVIDUAL_RESOURCE_DEFINITIONS);
			childrenFeatures
					.add(Schema1Package.Literals.RESOURCE_MODEL__BULK_RESOURCE_DEFINITION_TEMPLATES);
			childrenFeatures
					.add(Schema1Package.Literals.RESOURCE_MODEL__BULK_RESOURCE_DEFINITIONS);
			childrenFeatures
					.add(Schema1Package.Literals.RESOURCE_MODEL__INDIVIDUAL_RESOURCES);
			childrenFeatures
					.add(Schema1Package.Literals.RESOURCE_MODEL__BULK_RESOURCES);
			childrenFeatures.add(Schema1Package.Literals.RESOURCE_MODEL__ROLES);
			childrenFeatures
					.add(Schema1Package.Literals.RESOURCE_MODEL__TIMETABLES);
		}
