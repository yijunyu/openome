...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.DataModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataModelItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.DATA_MODEL__BUSINESS_ITEM_TEMPLATES);
			childrenFeatures
					.add(Schema1Package.Literals.DATA_MODEL__BUSINESS_ITEMS);
			childrenFeatures
					.add(Schema1Package.Literals.DATA_MODEL__BUSINESS_ITEM_INSTANCES);
			childrenFeatures
					.add(Schema1Package.Literals.DATA_MODEL__NOTIFICATION_TEMPLATES);
			childrenFeatures
					.add(Schema1Package.Literals.DATA_MODEL__NOTIFICATIONS);
		}
