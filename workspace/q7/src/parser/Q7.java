 ...
 */
  ...
  Advice t;
  java.util.ArrayList<Advice> a = new java.util.ArrayList<Advice>();
    label_1:
    while (true) {
...
String r = null;
  ...
  static final public java.util.ArrayList<Pointcut> Where() throws ParseException {
  ...
  static final public java.util.ArrayList<Effect> HowMuch() throws ParseException {
  ...
  static final public java.util.ArrayList<Effect> Agents() throws ParseException {
  java.util.ArrayList<Effect> effects;
  java.util.ArrayList<Effect> howmuch = null;
  Effect effect = null;
    effect = DepEffect();
