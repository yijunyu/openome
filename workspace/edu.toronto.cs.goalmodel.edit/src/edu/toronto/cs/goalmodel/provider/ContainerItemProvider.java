...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.goalmodel.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource		
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GoalmodelPackage.Literals.CONTAINER__NAME,
				 true,
				 false,
				 false,
  ...
  public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GoalmodelPackage.Literals.CONTAINER__SUB);
			childrenFeatures.add(GoalmodelPackage.Literals.CONTAINER__INTENTIONS);
		}
  ...
  protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GoalmodelPackage.Literals.CONTAINER__SUB,
				 GoalmodelFactory.eINSTANCE.createActor()));

		newChildDescriptors.add
			(createChildParameter
				(GoalmodelPackage.Literals.CONTAINER__INTENTIONS,
