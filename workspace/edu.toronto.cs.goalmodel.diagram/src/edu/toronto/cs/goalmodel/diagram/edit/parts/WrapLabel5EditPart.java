 ...
 * @generated
 */
public class WrapLabel5EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				GoalmodelVisualIDRegistry
						.getType(edu.toronto.cs.goalmodel.diagram.edit.parts.WrapLabel5EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public WrapLabel5EditPart(View view) {
		super(view);
	}
