...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Softgoal5ItemSemanticEditPolicy;
import edu.toronto.cs.goalmodel.diagram.part.GoalmodelVisualIDRegistry;

/**
 * @generated
 */
public class Softgoal5EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Softgoal5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftgoalName5EditPart) {
			((SoftgoalName5EditPart) childEditPart).setLabel(getPrimaryShape()
