package edu.toronto.cs.goalmodel.diagram.expressions;
 ...
 * @generated
 */
public abstract class GoalmodelAbstractExpression {
	/**
	 * @generated
	 */
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(GoalmodelDiagramEditorPlugin
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = GoalmodelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	public static final GoalmodelAbstractExpression createNullExpression(
			EClassifier context) {
		return new GoalmodelAbstractExpression(context) {
