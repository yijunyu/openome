 ...
 * @generated
 */
public class TaskName6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TaskName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new GoalmodelParserProvider.HintAdapter(
					GoalmodelElementTypes.Task_2020, getParserElement(),
					parserHint);
