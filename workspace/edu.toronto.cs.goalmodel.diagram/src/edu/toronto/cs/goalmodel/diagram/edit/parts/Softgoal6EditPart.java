...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Softgoal6ItemSemanticEditPolicy;
...
public class Softgoal6EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftgoalName6EditPart) {
			((SoftgoalName6EditPart) childEditPart).setLabel(getPrimaryShape()
