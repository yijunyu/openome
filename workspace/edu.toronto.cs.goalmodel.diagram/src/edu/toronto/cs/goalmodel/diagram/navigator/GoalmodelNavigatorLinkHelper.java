...
public class GoalmodelNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = GoalmodelDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		GoalmodelAbstractNavigatorItem abstractNavigatorItem = (GoalmodelAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof GoalmodelNavigatorItem) {
			navigatorView = ((GoalmodelNavigatorItem) abstractNavigatorItem)
					.getView();
		} else if (abstractNavigatorItem instanceof GoalmodelNavigatorGroup) {
			GoalmodelNavigatorGroup navigatorGroup = (GoalmodelNavigatorGroup) abstractNavigatorItem;
			if (navigatorGroup.getParent() instanceof GoalmodelNavigatorItem) {
				navigatorView = ((GoalmodelNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
