...
public class GoalmodelNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public GoalmodelNavigatorContentProvider() {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ModelEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), ActorEditPart.VISUAL_ID);
		...
		case ActorEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), ActorActorCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Goal2EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					ActorActorCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Softgoal2EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					ActorActorCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Resource2EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					ActorActorCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Task2EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case AgentEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), AgentAgentCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Goal3EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					AgentAgentCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Softgoal3EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					AgentAgentCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Resource3EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					AgentAgentCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Task3EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case PositionEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(connectedViews,
					Goal4EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PositionPositionCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Softgoal4EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PositionPositionCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Resource4EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					PositionPositionCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Task4EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case RoleEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), RoleRoleCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Goal5EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					RoleRoleCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Softgoal5EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					RoleRoleCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Resource5EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					RoleRoleCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Task5EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case AspectEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), AspectAspectCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Goal6EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					AspectAspectCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Softgoal6EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					AspectAspectCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Resource6EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					AspectAspectCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					Task6EditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case GoalEditPart.VISUAL_ID: {
			...
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_1006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_1006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view), DependencyEditPart.VISUAL_ID);
		...
		case SoftgoalEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_1007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_1007_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case TaskEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_1008_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_1008_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case ResourceEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_1009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_1009_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Softgoal2EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Goal3EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2005_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2005_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Softgoal3EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Resource3EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2007_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2007_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Goal4EditPart.VISUAL_ID: {
			...
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					...
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2009_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Softgoal4EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2010_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Resource4EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2011_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2011_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Task4EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_2012_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_2012_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Goal5EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2013_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2013_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Softgoal5EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2014_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2014_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Resource5EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2015_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2015_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Task5EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_2016_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_2016_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Goal6EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2017_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2017_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Softgoal6EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2018_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Softgoal_2018_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Resource6EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2019_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Resource_2019_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case Task6EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup incominglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_2020_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup outgoinglinks = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Task_2020_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), DependencyEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
		...
		case DependencyEditPart.VISUAL_ID: {
			...
			GoalmodelNavigatorGroup target = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Dependency_3001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup source = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_Dependency_3001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), GoalEditPart.VISUAL_ID);
		...
		case AndDecompositionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup target = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_AndDecomposition_3002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup source = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_AndDecomposition_3002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), GoalEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case OrDecompositionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup target = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_OrDecomposition_3003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup source = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_OrDecomposition_3003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), GoalEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case MakeContributionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup target = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_MakeContribution_3004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup source = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_MakeContribution_3004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), GoalEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case HelpContributionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup target = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_HelpContribution_3005_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup source = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_HelpContribution_3005_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), GoalEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case HurtContributionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup target = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_HurtContribution_3006_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup source = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_HurtContribution_3006_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), GoalEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
		...
		case BreakContributionEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			GoalmodelNavigatorGroup target = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_BreakContribution_3007_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GoalmodelNavigatorGroup source = new GoalmodelNavigatorGroup(
					Messages.NavigatorGroupName_BreakContribution_3007_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), GoalEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
	...
	private Collection getLinksSourceByType(Collection edges, int visualID) {
		Collection result = new ArrayList();
		String type = GoalmodelVisualIDRegistry.getType(visualID);
