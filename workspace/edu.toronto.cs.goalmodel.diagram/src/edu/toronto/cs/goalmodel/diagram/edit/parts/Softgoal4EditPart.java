...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Softgoal4ItemSemanticEditPolicy;
import edu.toronto.cs.goalmodel.diagram.part.GoalmodelVisualIDRegistry;

/**
 * @generated
 */
public class Softgoal4EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Softgoal4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftgoalName4EditPart) {
			((SoftgoalName4EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureSoftgoalNameFigure());
			return true;
		}
		return false;
	}
