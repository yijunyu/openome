 ...
 * @generated
 */
public class HurtContributionCreateCommand extends CreateElementCommand {
	...
	public boolean canExecute() {
		...
		return GoalmodelBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateHurtContribution_3006(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.toronto.cs.goalmodel.HurtContribution newElement = (edu.toronto.cs.goalmodel.HurtContribution) super.doDefaultElementCreation();
		HurtContribution newElement = GoalmodelFactory.eINSTANCE
