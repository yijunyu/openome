...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Softgoal3ItemSemanticEditPolicy;
import edu.toronto.cs.goalmodel.diagram.part.GoalmodelVisualIDRegistry;

/**
 * @generated
 */
public class Softgoal3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Softgoal3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SoftgoalName3EditPart) {
			((SoftgoalName3EditPart) childEditPart).setLabel(getPrimaryShape()
