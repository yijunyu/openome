...
public class HurtContributionReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (!(getElementToEdit() instanceof HurtContribution)) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GoalmodelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistHurtContribution_3006(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Model container = (Model) getLink().eContainer();
		return GoalmodelBaseItemSemanticEditPolicy.LinkConstraints
				.canExistHurtContribution_3006(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected HurtContribution getLink() {
		return (HurtContribution) getElementToEdit();
	}
