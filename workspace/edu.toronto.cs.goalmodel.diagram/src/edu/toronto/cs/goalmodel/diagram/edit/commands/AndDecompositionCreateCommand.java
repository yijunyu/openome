...
public class AndDecompositionCreateCommand extends CreateElementCommand {
	...
	protected EObject doDefaultElementCreation() {
		// edu.toronto.cs.goalmodel.AndDecomposition newElement = (edu.toronto.cs.goalmodel.AndDecomposition) super.doDefaultElementCreation();
		AndDecomposition newElement = GoalmodelFactory.eINSTANCE
