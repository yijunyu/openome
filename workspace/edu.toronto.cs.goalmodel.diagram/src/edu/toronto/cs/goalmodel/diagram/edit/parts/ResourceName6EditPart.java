 ...
 * @generated
 */
public class ResourceName6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new GoalmodelParserProvider.HintAdapter(
					GoalmodelElementTypes.Resource_2019, getParserElement(),
					parserHint);
