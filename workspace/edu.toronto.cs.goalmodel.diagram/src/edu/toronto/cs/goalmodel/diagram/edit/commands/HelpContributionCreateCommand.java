...
public class HelpContributionCreateCommand extends CreateElementCommand {
	...
	public boolean canExecute() {
		...
		return GoalmodelBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateHelpContribution_3005(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// edu.toronto.cs.goalmodel.HelpContribution newElement = (edu.toronto.cs.goalmodel.HelpContribution) super.doDefaultElementCreation();
		HelpContribution newElement = GoalmodelFactory.eINSTANCE
