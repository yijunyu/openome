 ...
 * @generated
 */
public class GoalmodelSheetLabelProvider extends DecoratingLabelProvider {

	/**
	 * @generated
	 */
	public GoalmodelSheetLabelProvider() {
		super(new AdapterFactoryLabelProvider(GoalmodelDiagramEditorPlugin
	...
	public String getText(Object element) {
		...
		if (selected instanceof GoalmodelNavigatorGroup) {
			return ((GoalmodelNavigatorGroup) selected).getGroupName();
		}
