...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Resource6ItemSemanticEditPolicy;
...
public class Resource6EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Resource6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ResourceName6EditPart) {
			((ResourceName6EditPart) childEditPart).setLabel(getPrimaryShape()
