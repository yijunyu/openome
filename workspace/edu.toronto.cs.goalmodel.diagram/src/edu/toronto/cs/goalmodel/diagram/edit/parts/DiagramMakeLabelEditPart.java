 ...
 * @generated
 */
public class DiagramMakeLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(GoalmodelVisualIDRegistry
				.getType(DiagramMakeLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public DiagramMakeLabelEditPart(View view) {
		super(view);
	}
	 ...
	 * @generated
	 */
	public class MakeLabel extends WrapLabel {
		/**
		 * @generated
		 */
		public MakeLabel() {
