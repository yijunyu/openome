...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Goal6ItemSemanticEditPolicy;
...
public class Goal6EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Goal6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GoalName6EditPart) {
			((GoalName6EditPart) childEditPart).setLabel(getPrimaryShape()
