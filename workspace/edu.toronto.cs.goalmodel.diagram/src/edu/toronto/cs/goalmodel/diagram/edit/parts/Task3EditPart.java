...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Task3ItemSemanticEditPolicy;
import edu.toronto.cs.goalmodel.diagram.part.GoalmodelVisualIDRegistry;

/**
 * @generated
 */
public class Task3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TaskName3EditPart) {
			((TaskName3EditPart) childEditPart).setLabel(getPrimaryShape()
