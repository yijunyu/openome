...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Task6ItemSemanticEditPolicy;
...
public class Task6EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Task6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TaskName6EditPart) {
			((TaskName6EditPart) childEditPart).setLabel(getPrimaryShape()
