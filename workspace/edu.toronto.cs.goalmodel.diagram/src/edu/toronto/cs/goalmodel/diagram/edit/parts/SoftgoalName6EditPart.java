 ...
 * @generated
 */
public class SoftgoalName6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SoftgoalName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new GoalmodelParserProvider.HintAdapter(
					GoalmodelElementTypes.Softgoal_2018, getParserElement(),
					parserHint);
