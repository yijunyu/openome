 ...
 * @generated
 */
public class WrapLabel6EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				GoalmodelVisualIDRegistry
						.getType(edu.toronto.cs.goalmodel.diagram.edit.parts.WrapLabel6EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public WrapLabel6EditPart(View view) {
		super(view);
	}
