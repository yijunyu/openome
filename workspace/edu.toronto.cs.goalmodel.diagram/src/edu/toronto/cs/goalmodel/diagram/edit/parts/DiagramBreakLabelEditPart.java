 ...
 * @generated
 */
public class DiagramBreakLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(GoalmodelVisualIDRegistry
				.getType(DiagramBreakLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public DiagramBreakLabelEditPart(View view) {
		super(view);
	}
	 ...
	 * @generated
	 */
	public class BreakLabel extends WrapLabel {
		/**
		 * @generated
		 */
		public BreakLabel() {
