 ...
 * @generated
 */
public class GoalmodelMatchingStrategy implements IEditorMatchingStrategy {
	...
	public boolean matches(IEditorReference editorRef, IEditorInput input) {
		...
		if (input instanceof DiagramEditorInput
				&& editor instanceof GoalmodelDiagramEditor) {
			Diagram editorDiagram = ((GoalmodelDiagramEditor) editor)
					.getDiagram();
