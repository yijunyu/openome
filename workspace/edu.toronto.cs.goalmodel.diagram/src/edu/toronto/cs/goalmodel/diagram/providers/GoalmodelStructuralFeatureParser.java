 ...
 * @generated
 */
public class GoalmodelStructuralFeatureParser extends GoalmodelAbstractParser {
	 ...
	 * @generated
	 */
	public GoalmodelStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(GoalmodelDiagramEditorPlugin.ID,
