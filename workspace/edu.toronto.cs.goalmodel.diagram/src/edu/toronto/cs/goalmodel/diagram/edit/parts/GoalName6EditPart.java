 ...
 * @generated
 */
public class GoalName6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GoalName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new GoalmodelParserProvider.HintAdapter(
					GoalmodelElementTypes.Goal_2017, getParserElement(),
					parserHint);
