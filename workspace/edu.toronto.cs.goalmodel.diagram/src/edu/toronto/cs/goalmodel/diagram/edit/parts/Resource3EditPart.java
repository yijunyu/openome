...
import edu.toronto.cs.goalmodel.diagram.edit.policies.Resource3ItemSemanticEditPolicy;
import edu.toronto.cs.goalmodel.diagram.part.GoalmodelVisualIDRegistry;

/**
 * @generated
 */
public class Resource3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ResourceName3EditPart) {
			((ResourceName3EditPart) childEditPart).setLabel(getPrimaryShape()
