 ...
 * @generated
 */
public class DiagramHurtLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(GoalmodelVisualIDRegistry
				.getType(DiagramHurtLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public DiagramHurtLabelEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof GoalmodelTextSelectionEditPolicy) {
			((GoalmodelTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), GoalmodelEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new HurtLabel();
	}

	/**
	 * @generated
	 */
	public class HurtLabel extends WrapLabel {
		/**
		 * @generated
		 */
		public HurtLabel() {
