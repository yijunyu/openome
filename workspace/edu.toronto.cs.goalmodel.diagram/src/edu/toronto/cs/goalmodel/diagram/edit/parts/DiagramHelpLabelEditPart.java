 ...
 * @generated
 */
public class DiagramHelpLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(GoalmodelVisualIDRegistry
				.getType(DiagramHelpLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public DiagramHelpLabelEditPart(View view) {
		super(view);
	}
	 ...
	 * @generated
	 */
	public class HelpLabel extends WrapLabel {
		/**
		 * @generated
		 */
		public HelpLabel() {
