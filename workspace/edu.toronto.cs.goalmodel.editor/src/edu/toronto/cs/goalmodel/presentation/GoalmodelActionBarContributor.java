  ...
  implements ISelectionChangedListener
{
  ...
  public void contributeToMenu(IMenuManager menuManager) {
		...
		//
		createChildMenuManager = new MenuManager(GoalmodelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(GoalmodelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
  ...
  public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(GoalmodelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(GoalmodelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
