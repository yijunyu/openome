...
public class AgentAgentCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (NotationPackage.eINSTANCE.getSize_Width().equals(feature)
			...
			// hide the intentions inside of the agent, as well as any
			// connections
			// that link to any intentions inside of the agent
			...
			if (isCollapsed) {
				...
				// resizes the agent figure down to 100 pixels and then collapses..
				// when the user tries to expand the agent figure again, they won't
				...
				// restore the width and height of the agent
				Rectangle newBounds = new Rectangle(xLocation, yLocation,
