...
public class HelpContributionEditPart extends ConnectionNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.WrapLabel4EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.WrapLabel4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureHelpLabel());
			return true;
		}
		return false;
	}
	...
	public class HelpContributionFigure extends PolylineConnectionEx {
		...
		private RotatableDecoration createTargetDecoration() {
			openome_model.figures.HelpDecoration df = new openome_model.figures.HelpDecoration();
