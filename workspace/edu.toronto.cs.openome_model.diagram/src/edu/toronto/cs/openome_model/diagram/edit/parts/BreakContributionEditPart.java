...
public class BreakContributionEditPart extends ConnectionNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.WrapLabel6EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.WrapLabel6EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureBreakLabel());
			return true;
		}
		return false;
	}
	...
	public class BreakContributionFigure extends PolylineConnectionEx {
		...
		private RotatableDecoration createTargetDecoration() {
			openome_model.figures.BreakDecoration df = new openome_model.figures.BreakDecoration();
