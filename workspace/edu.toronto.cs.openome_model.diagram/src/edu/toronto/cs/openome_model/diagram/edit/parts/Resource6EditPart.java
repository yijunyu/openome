 ...
 * @generated
 */
public class Resource6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Resource6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.Resource6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.ResourceName6EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.ResourceName6EditPart) childEditPart)
