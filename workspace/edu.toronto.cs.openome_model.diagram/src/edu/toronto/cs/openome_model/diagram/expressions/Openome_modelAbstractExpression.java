...
public abstract class Openome_modelAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform
							.getDebugOption(edu.toronto.cs.openome_model.diagram.part.Openome_modelDiagramEditorPlugin
	 ...
	 * @generated
	 */
	protected Openome_modelAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	public static final Openome_modelAbstractExpression createNullExpression(
			EClassifier context) {
		return new Openome_modelAbstractExpression(context) {
