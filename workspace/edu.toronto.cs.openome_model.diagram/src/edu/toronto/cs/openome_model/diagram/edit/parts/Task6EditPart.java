 ...
 * @generated
 */
public class Task6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Task6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.Task6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.TaskName6EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.TaskName6EditPart) childEditPart)
