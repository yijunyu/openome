 ...
 * @generated
 */
public class Goal6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Goal6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new edu.toronto.cs.openome_model.diagram.edit.policies.Goal6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof edu.toronto.cs.openome_model.diagram.edit.parts.GoalName6EditPart) {
			((edu.toronto.cs.openome_model.diagram.edit.parts.GoalName6EditPart) childEditPart)
