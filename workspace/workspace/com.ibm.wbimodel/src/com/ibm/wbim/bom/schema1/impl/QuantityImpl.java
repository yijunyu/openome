...
public class QuantityImpl extends EObjectImpl implements Quantity {
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.QUANTITY__VALUE, oldValue, value,
					!oldValueESet));
	}
	...
	public void unsetValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.QUANTITY__VALUE, oldValue, VALUE_EDEFAULT,
					oldValueESet));
	}
	...
	public void setUnit(Unit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.QUANTITY__UNIT, oldUnit, unit, !oldUnitESet));
	}
	...
	public void unsetUnit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.QUANTITY__UNIT, oldUnit, UNIT_EDEFAULT,
					oldUnitESet));
	}
