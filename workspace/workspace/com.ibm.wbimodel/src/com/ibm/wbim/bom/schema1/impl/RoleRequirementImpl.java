...
public class RoleRequirementImpl extends EObjectImpl implements RoleRequirement {
	...
	public NotificationChain basicSetResourceQuantity(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.ROLE_REQUIREMENT__RESOURCE_QUANTITY,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ROLE_REQUIREMENT__NAME, oldName, name));
	}
	...
	public void setRole(String newRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ROLE_REQUIREMENT__ROLE, oldRole, role));
	}
	...
	public void setTimeRequired(Duration newTimeRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ROLE_REQUIREMENT__TIME_REQUIRED,
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ROLE_REQUIREMENT__TYPE, oldType, type));
	}
