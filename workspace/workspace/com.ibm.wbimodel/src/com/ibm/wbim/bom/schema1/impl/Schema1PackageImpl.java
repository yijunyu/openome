...
public class Schema1PackageImpl extends EPackageImpl implements Schema1Package {
	 ...
	 * @generated
	 */
	private EEnum predefinedOrganizationTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EEnum predefinedResourceTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType predefinedOrganizationTypeObjectEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType predefinedResourceTypeObjectEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType unitObjectEDataType = null;
	...
	public static Schema1Package init() {
		if (isInited)
			return (Schema1Package) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI);

		// Obtain or create and register package
		Schema1PackageImpl theSchema1Package = (Schema1PackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof Schema1PackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
				: new Schema1PackageImpl());
		...
		EValidator.Registry.INSTANCE.put(theSchema1Package,
	...
	public EClass getAdditionalInputType() {
		if (additionalInputTypeEClass == null) {
			additionalInputTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							0);
		}
	...
	public EReference getAdditionalInputType_InputCriterion() {
		return (EReference) getAdditionalInputType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getAdditionalInputType_Name() {
		return (EAttribute) getAdditionalInputType().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getAdditionalOutputType() {
		if (additionalOutputTypeEClass == null) {
			additionalOutputTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							1);
		}
	...
	public EReference getAdditionalOutputType_OutputCriterion() {
		return (EReference) getAdditionalOutputType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getAdditionalOutputType_Name() {
		return (EAttribute) getAdditionalOutputType().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getAnnotatedNodeType() {
		if (annotatedNodeTypeEClass == null) {
			annotatedNodeTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							2);
		}
	...
	public EAttribute getAnnotatedNodeType_Name() {
		return (EAttribute) getAnnotatedNodeType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getAnnotation() {
		if (annotationEClass == null) {
			annotationEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(3);
		}
	...
	public EClass getAttribute() {
		if (attributeEClass == null) {
			attributeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(5);
		}
	...
	public EClass getAttributeValue() {
		if (attributeValueEClass == null) {
			attributeValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							6);
		}
	...
	public EClass getAvailability() {
		if (availabilityEClass == null) {
			availabilityEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							7);
		}
	...
	public EClass getBasedOnTimetableType() {
		if (basedOnTimetableTypeEClass == null) {
			basedOnTimetableTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							8);
		}
	...
	public EAttribute getBasedOnTimetableType_Timetable() {
		return (EAttribute) getBasedOnTimetableType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getBulkResource() {
		if (bulkResourceEClass == null) {
			bulkResourceEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							11);
		}
	...
	public EClass getBulkResourceDefinitionsType() {
		if (bulkResourceDefinitionsTypeEClass == null) {
			bulkResourceDefinitionsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							12);
		}
	...
	public EReference getBulkResourceDefinitionsType_BulkResourceDefinition() {
		return (EReference) getBulkResourceDefinitionsType()
	...
	public EClass getBulkResourceDefinitionTemplatesType() {
		if (bulkResourceDefinitionTemplatesTypeEClass == null) {
			bulkResourceDefinitionTemplatesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							13);
		}
	...
	public EReference getBulkResourceDefinitionTemplatesType_BulkResourceDefinitionTemplate() {
		return (EReference) getBulkResourceDefinitionTemplatesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getBulkResourceRequirement() {
		if (bulkResourceRequirementEClass == null) {
			bulkResourceRequirementEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							14);
		}
	...
	public EReference getBulkResourceRequirement_ResourceQuantity() {
		return (EReference) getBulkResourceRequirement()
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getBulkResourceRequirement_BulkResource() {
		return (EAttribute) getBulkResourceRequirement()
	...
	public EClass getBulkResourcesType() {
		if (bulkResourcesTypeEClass == null) {
			bulkResourcesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							15);
		}
	...
	public EReference getBulkResourcesType_BulkResource() {
		return (EReference) getBulkResourcesType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getBusinessItemInstancesType() {
		if (businessItemInstancesTypeEClass == null) {
			businessItemInstancesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							16);
		}
	...
	public EReference getBusinessItemInstancesType_BusinessItemInstance() {
		return (EReference) getBusinessItemInstancesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getBusinessItemsType() {
		if (businessItemsTypeEClass == null) {
			businessItemsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							17);
		}
	...
	public EReference getBusinessItemsType_BusinessItem() {
		return (EReference) getBusinessItemsType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getBusinessItemTemplatesType() {
		if (businessItemTemplatesTypeEClass == null) {
			businessItemTemplatesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							18);
		}
	...
	public EReference getBusinessItemTemplatesType_BusinessItemTemplate() {
		return (EReference) getBusinessItemTemplatesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getCallToProcessType() {
		if (callToProcessTypeEClass == null) {
			callToProcessTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							19);
		}
	...
	public EAttribute getCallToProcessType_Process() {
		return (EAttribute) getCallToProcessType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getCallToServiceType() {
		if (callToServiceTypeEClass == null) {
			callToServiceTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							20);
		}
	...
	public EAttribute getCallToServiceType_Service() {
		return (EAttribute) getCallToServiceType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getCallToTaskType() {
		if (callToTaskTypeEClass == null) {
			callToTaskTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							21);
		}
	...
	public EClass getCatalog() {
		if (catalogEClass == null) {
			catalogEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(22);
		}
	...
	public EClass getCatalogs() {
		if (catalogsEClass == null) {
			catalogsEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(23);
		}
	...
	public EClass getCatalogsType() {
		if (catalogsTypeEClass == null) {
			catalogsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							24);
		}
	...
	public EClass getComplexDataType() {
		if (complexDataTypeEClass == null) {
			complexDataTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							25);
		}
	...
	public EAttribute getComplexDataType_Documentation() {
		return (EAttribute) getComplexDataType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getComplexDataType_Attribute() {
		return (EReference) getComplexDataType().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getComplexDataTypeInstance() {
		if (complexDataTypeInstanceEClass == null) {
			complexDataTypeInstanceEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							26);
		}
	...
	public EAttribute getComplexDataTypeInstance_Documentation() {
		return (EAttribute) getComplexDataTypeInstance()
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getComplexDataTypeInstance_AttributeValue() {
		return (EReference) getComplexDataTypeInstance()
				.getEStructuralFeatures().get(1);
	}
	...
	public EClass getConnection() {
		if (connectionEClass == null) {
			connectionEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(27);
		}
	...
	public EClass getConstantTimeType() {
		if (constantTimeTypeEClass == null) {
			constantTimeTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							28);
		}
	...
	public EAttribute getConstantTimeType_Time() {
		return (EAttribute) getConstantTimeType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getControlActionOutputRef() {
		if (controlActionOutputRefEClass == null) {
			controlActionOutputRefEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							29);
		}
	...
	public EReference getControlActionOutputRef_RepositoryValue() {
		return (EReference) getControlActionOutputRef()
				.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getControlActionOutputRef_Name() {
		return (EAttribute) getControlActionOutputRef()
				.getEStructuralFeatures().get(1);
	}
	...
	public EClass getCorrelationType() {
		if (correlationTypeEClass == null) {
			correlationTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							30);
		}
	...
	public EReference getCorrelationType_Predicate() {
		return (EReference) getCorrelationType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getCorrelationType_MultipleInstancesSatisfyCondition() {
		return (EAttribute) getCorrelationType().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getCostPerQuantity() {
		if (costPerQuantityEClass == null) {
			costPerQuantityEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							31);
		}
	...
	public EAttribute getCostPerQuantity_Unit() {
		return (EAttribute) getCostPerQuantity().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getCostPerQuantityAndTimeUnit() {
		if (costPerQuantityAndTimeUnitEClass == null) {
			costPerQuantityAndTimeUnitEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							32);
		}
	...
	public EAttribute getCostPerQuantityAndTimeUnit_TimeUnit() {
		return (EAttribute) getCostPerQuantityAndTimeUnit()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getCostPerTimeUnit() {
		if (costPerTimeUnitEClass == null) {
			costPerTimeUnitEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							33);
		}
	...
	public EAttribute getCostPerTimeUnit_TimeUnit() {
		return (EAttribute) getCostPerTimeUnit().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getCostPerTimeUnitValue() {
		if (costPerTimeUnitValueEClass == null) {
			costPerTimeUnitValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							34);
		}
	...
	public EAttribute getCostPerTimeUnitValue_TimeUnit() {
		return (EAttribute) getCostPerTimeUnitValue().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getCostType() {
		if (costTypeEClass == null) {
			costTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(35);
		}
	...
	public EClass getCostValue() {
		if (costValueEClass == null) {
			costValueEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(36);
		}
	...
	public EClass getCriteriaTemplate() {
		if (criteriaTemplateEClass == null) {
			criteriaTemplateEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							37);
		}
	...
	public EReference getCriteriaTemplate_ManagerOfEmployee() {
		return (EReference) getCriteriaTemplate().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getDataModel() {
		if (dataModelEClass == null) {
			dataModelEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(40);
		}
	...
	public EClass getDecision() {
		if (decisionEClass == null) {
			decisionEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(43);
		}
	...
	public EClass getDefaultValue() {
		if (defaultValueEClass == null) {
			defaultValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							44);
		}
	...
	public EClass getDistributionType() {
		if (distributionTypeEClass == null) {
			distributionTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							45);
		}
	...
	public EReference getDistributionType_Exponential() {
		return (EReference) getDistributionType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getDistributionType1() {
		if (distributionType1EClass == null) {
			distributionType1EClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							46);
		}
	...
	public EAttribute getDistributionType1_TimeUnit() {
		return (EAttribute) getDistributionType1().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getEndNodeType() {
		if (endNodeTypeEClass == null) {
			endNodeTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							49);
		}
	...
	public EClass getEntryPointType() {
		if (entryPointTypeEClass == null) {
			entryPointTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							50);
		}
	...
	public EClass getExemptionPeriodType() {
		if (exemptionPeriodTypeEClass == null) {
			exemptionPeriodTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							51);
		}
	...
	public EAttribute getExemptionPeriodType_Timetable() {
		return (EAttribute) getExemptionPeriodType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getExponentialType() {
		if (exponentialTypeEClass == null) {
			exponentialTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							52);
		}
	...
	public EAttribute getExponentialType_Mean() {
		return (EAttribute) getExponentialType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getExpression() {
		if (expressionEClass == null) {
			expressionEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(53);
		}
	...
	public EClass getExtendedAttributes() {
		if (extendedAttributesEClass == null) {
			extendedAttributesEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							54);
		}
	...
	public EReference getExtendedAttributes_ExtendedAttribute() {
		return (EReference) getExtendedAttributes().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getExtendedAttributeType() {
		if (extendedAttributeTypeEClass == null) {
			extendedAttributeTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							55);
		}
	...
	public EAttribute getExtendedAttributeType_Mixed() {
		return (EAttribute) getExtendedAttributeType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getFlowContentType() {
		if (flowContentTypeEClass == null) {
			flowContentTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							56);
		}
	...
	public EAttribute getFlowContentType_Group() {
		return (EAttribute) getFlowContentType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getFlowContentType_StartNode() {
		return (EReference) getFlowContentType().getEStructuralFeatures()
				.get(1);
	}
	...
	public EReference getFlowContentType_NotificationReceiver() {
		return (EReference) getFlowContentType().getEStructuralFeatures().get(
				10);
	}
	...
	public EClass getFork() {
		if (forkEClass == null) {
			forkEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(57);
		}
		return forkEClass;
	}
	...
	public EClass getForLoop() {
		if (forLoopEClass == null) {
			forLoopEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(58);
		}
	...
	public EClass getGammaType() {
		if (gammaTypeEClass == null) {
			gammaTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(59);
		}
	...
	public EClass getGlobalRepositoryRef() {
		if (globalRepositoryRefEClass == null) {
			globalRepositoryRefEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							60);
		}
	...
	public EAttribute getGlobalRepositoryRef_Name() {
		return (EAttribute) getGlobalRepositoryRef().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getGroupMembersType() {
		if (groupMembersTypeEClass == null) {
			groupMembersTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							61);
		}
	...
	public EAttribute getGroupMembersType_Group() {
		return (EAttribute) getGroupMembersType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getGroupSearchType() {
		if (groupSearchTypeEClass == null) {
			groupSearchTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							62);
		}
	...
	public EAttribute getGroupSearchType_GroupId() {
		return (EAttribute) getGroupSearchType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getGroupSearchType_BusinessCategory() {
		return (EAttribute) getGroupSearchType().getEStructuralFeatures().get(
				10);
	}
	...
	public EClass getIndividualResource() {
		if (individualResourceEClass == null) {
			individualResourceEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							63);
		}
	...
	public EAttribute getIndividualResource_IndividualResourceCostType() {
		return (EAttribute) getIndividualResource().getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getIndividualResource_OneTimeCost() {
		return (EReference) getIndividualResource().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getIndividualResourceDefinitionsType() {
		if (individualResourceDefinitionsTypeEClass == null) {
			individualResourceDefinitionsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							64);
		}
	...
	public EReference getIndividualResourceDefinitionsType_IndividualResourceDefinition() {
		return (EReference) getIndividualResourceDefinitionsType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getIndividualResourceDefinitionTemplatesType() {
		if (individualResourceDefinitionTemplatesTypeEClass == null) {
			individualResourceDefinitionTemplatesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							65);
		}
	...
	public EReference getIndividualResourceDefinitionTemplatesType_IndividualResourceDefinitionTemplate() {
		return (EReference) getIndividualResourceDefinitionTemplatesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getIndividualResourceRequirement() {
		if (individualResourceRequirementEClass == null) {
			individualResourceRequirementEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							66);
		}
	...
	public EAttribute getIndividualResourceRequirement_IndividualResource() {
		return (EAttribute) getIndividualResourceRequirement()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getIndividualResourcesType() {
		if (individualResourcesTypeEClass == null) {
			individualResourcesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							67);
		}
	...
	public EReference getIndividualResourcesType_IndividualResource() {
		return (EReference) getIndividualResourcesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getInput() {
		if (inputEClass == null) {
			inputEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(68);
		}
		return inputEClass;
	}
	...
	public EClass getInputBranch() {
		if (inputBranchEClass == null) {
			inputBranchEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							69);
		}
	...
	public EClass getInputConstantValue() {
		if (inputConstantValueEClass == null) {
			inputConstantValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							70);
		}
	...
	public EAttribute getInputConstantValue_LiteralValue() {
		return (EAttribute) getInputConstantValue().getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getInputConstantValue_PublicInstance() {
		return (EReference) getInputConstantValue().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getInputConstantValueType() {
		if (inputConstantValueTypeEClass == null) {
			inputConstantValueTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							71);
		}
	...
	public EAttribute getInputConstantValueType_Input() {
		return (EAttribute) getInputConstantValueType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getInputCriterion() {
		if (inputCriterionEClass == null) {
			inputCriterionEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							72);
		}
	...
	public EClass getInputCriterionRef() {
		if (inputCriterionRefEClass == null) {
			inputCriterionRefEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							73);
		}
	...
	public EAttribute getInputCriterionRef_Name() {
		return (EAttribute) getInputCriterionRef().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getInputRepositoryValue() {
		if (inputRepositoryValueEClass == null) {
			inputRepositoryValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							74);
		}
	...
	public EReference getInputRepositoryValue_LocalRepository() {
		return (EReference) getInputRepositoryValue().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getInputRepositoryValue_AtBeginning() {
		return (EAttribute) getInputRepositoryValue().getEStructuralFeatures()
				.get(2);
	}
	...
	public EClass getInputRepositoryValueType() {
		if (inputRepositoryValueTypeEClass == null) {
			inputRepositoryValueTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							75);
		}
	...
	public EAttribute getInputRepositoryValueType_Input() {
		return (EAttribute) getInputRepositoryValueType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getInputs() {
		if (inputsEClass == null) {
			inputsEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(76);
		}
		return inputsEClass;
	}
	...
	public EClass getInputType() {
		if (inputTypeEClass == null) {
			inputTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(77);
		}
	...
	public EClass getInvocation() {
		if (invocationEClass == null) {
			invocationEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(79);
		}
	...
	public EClass getJoin() {
		if (joinEClass == null) {
			joinEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(80);
		}
		return joinEClass;
	}
	...
	public EClass getLastActivationTimePlusType() {
		if (lastActivationTimePlusTypeEClass == null) {
			lastActivationTimePlusTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							81);
		}
	...
	public EAttribute getLastActivationTimePlusType_Duration() {
		return (EAttribute) getLastActivationTimePlusType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getLocalRepository() {
		if (localRepositoryEClass == null) {
			localRepositoryEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							82);
		}
	...
	public EAttribute getLocalRepository_Description() {
		return (EAttribute) getLocalRepository().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getLocalRepositoryRef() {
		if (localRepositoryRefEClass == null) {
			localRepositoryRefEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							83);
		}
	...
	public EAttribute getLocalRepositoryRef_Name() {
		return (EAttribute) getLocalRepositoryRef().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getLocationDefinitionsType() {
		if (locationDefinitionsTypeEClass == null) {
			locationDefinitionsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							84);
		}
	...
	public EReference getLocationDefinitionsType_LocationDefinition() {
		return (EReference) getLocationDefinitionsType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getLocationDefinitionTemplatesType() {
		if (locationDefinitionTemplatesTypeEClass == null) {
			locationDefinitionTemplatesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							85);
		}
	...
	public EReference getLocationDefinitionTemplatesType_LocationDefinitionTemplate() {
		return (EReference) getLocationDefinitionTemplatesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getLocationsType() {
		if (locationsTypeEClass == null) {
			locationsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							86);
		}
	...
	public EClass getLocationType() {
		if (locationTypeEClass == null) {
			locationTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							87);
		}
	...
	public EClass getLognormalType() {
		if (lognormalTypeEClass == null) {
			lognormalTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							88);
		}
	...
	public EClass getLoop() {
		if (loopEClass == null) {
			loopEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(89);
		}
		return loopEClass;
	}
	...
	public EClass getLoopConditionType() {
		if (loopConditionTypeEClass == null) {
			loopConditionTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							90);
		}
	...
	public EAttribute getLoopConditionType_CounterIncrement() {
		return (EAttribute) getLoopConditionType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getManagerOfEmployeeByIDType() {
		if (managerOfEmployeeByIDTypeEClass == null) {
			managerOfEmployeeByIDTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							91);
		}
	...
	public EAttribute getManagerOfEmployeeByIDType_Staff() {
		return (EAttribute) getManagerOfEmployeeByIDType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getManagerOfEmployeeType() {
		if (managerOfEmployeeTypeEClass == null) {
			managerOfEmployeeTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							92);
		}
	...
	public EAttribute getManagerOfEmployeeType_Name() {
		return (EAttribute) getManagerOfEmployeeType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getMap() {
		if (mapEClass == null) {
			mapEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(93);
		}
		return mapEClass;
	}
	...
	public EClass getMerge() {
		if (mergeEClass == null) {
			mergeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(94);
		}
		return mergeEClass;
	}
	...
	public EClass getModelType() {
		if (modelTypeEClass == null) {
			modelTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(95);
		}
	...
	public EClass getMonetaryValue() {
		if (monetaryValueEClass == null) {
			monetaryValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							96);
		}
	...
	public EClass getNormalType() {
		if (normalTypeEClass == null) {
			normalTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(103);
		}
	...
	public EClass getNotificationBroadcaster() {
		if (notificationBroadcasterEClass == null) {
			notificationBroadcasterEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							104);
		}
	...
	public EAttribute getNotificationBroadcaster_Notification() {
		return (EAttribute) getNotificationBroadcaster()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getNotificationReceiver() {
		if (notificationReceiverEClass == null) {
			notificationReceiverEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							105);
		}
	...
	public EReference getNotificationReceiver_NotificationFilter() {
		return (EReference) getNotificationReceiver().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getNotificationReceiver_Notification() {
		return (EAttribute) getNotificationReceiver().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getNotificationsType() {
		if (notificationsTypeEClass == null) {
			notificationsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							106);
		}
	...
	public EReference getNotificationsType_Notification() {
		return (EReference) getNotificationsType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getNotificationTemplatesType() {
		if (notificationTemplatesTypeEClass == null) {
			notificationTemplatesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							107);
		}
	...
	public EReference getNotificationTemplatesType_NotificationTemplate() {
		return (EReference) getNotificationTemplatesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getObserver() {
		if (observerEClass == null) {
			observerEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(108);
		}
	...
	public EClass getOneTimeCost() {
		if (oneTimeCostEClass == null) {
			oneTimeCostEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							109);
		}
	...
	public EClass getOperationalData() {
		if (operationalDataEClass == null) {
			operationalDataEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							110);
		}
	...
	public EReference getOperationalData_TimeEstimation() {
		return (EReference) getOperationalData().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getOrganizationDefinitionsType() {
		if (organizationDefinitionsTypeEClass == null) {
			organizationDefinitionsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							111);
		}
	...
	public EReference getOrganizationDefinitionsType_OrganizationDefinition() {
		return (EReference) getOrganizationDefinitionsType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getOrganizationDefinitionTemplatesType() {
		if (organizationDefinitionTemplatesTypeEClass == null) {
			organizationDefinitionTemplatesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							112);
		}
	...
	public EReference getOrganizationDefinitionTemplatesType_OrganizationDefinitionTemplate() {
		return (EReference) getOrganizationDefinitionTemplatesType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getOrganizationManagerType() {
		if (organizationManagerTypeEClass == null) {
			organizationManagerTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							113);
		}
	...
	public EAttribute getOrganizationManagerType_Organization() {
		return (EAttribute) getOrganizationManagerType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getOrganizationModel() {
		if (organizationModelEClass == null) {
			organizationModelEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							114);
		}
	...
	public EReference getOrganizationModel_OrganizationDefinitionTemplates() {
		return (EReference) getOrganizationModel().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getOrganizations() {
		if (organizationsEClass == null) {
			organizationsEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							115);
		}
	...
	public EClass getOrganizationUnitsType() {
		if (organizationUnitsTypeEClass == null) {
			organizationUnitsTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							116);
		}
	...
	public EReference getOrganizationUnitsType_OrganizationUnit() {
		return (EReference) getOrganizationUnitsType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getOrganizationUnitType() {
		if (organizationUnitTypeEClass == null) {
			organizationUnitTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							117);
		}
	...
	public EAttribute getOrganizationUnitType_Name() {
		return (EAttribute) getOrganizationUnitType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getOutput() {
		if (outputEClass == null) {
			outputEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(118);
		}
		return outputEClass;
	}
	...
	public EClass getOutputBranch() {
		if (outputBranchEClass == null) {
			outputBranchEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							119);
		}
	...
	public EClass getOutputBranchType() {
		if (outputBranchTypeEClass == null) {
			outputBranchTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							120);
		}
	...
	public EReference getOutputBranchType_Condition() {
		return (EReference) getOutputBranchType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getOutputCriterion() {
		if (outputCriterionEClass == null) {
			outputCriterionEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							121);
		}
	...
	public EReference getOutputCriterion_Output() {
		return (EReference) getOutputCriterion().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getOutputCriterion_Name() {
		return (EAttribute) getOutputCriterion().getEStructuralFeatures()
				.get(2);
	}
	...
	public EClass getOutputCriterionRef() {
		if (outputCriterionRefEClass == null) {
			outputCriterionRefEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							122);
		}
	...
	public EAttribute getOutputCriterionRef_Name() {
		return (EAttribute) getOutputCriterionRef().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getOutputPathOperationalData() {
		if (outputPathOperationalDataEClass == null) {
			outputPathOperationalDataEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							123);
		}
	...
	public EReference getOutputPathOperationalData_Probability() {
		return (EReference) getOutputPathOperationalData()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getOutputPathProbabilityValue() {
		if (outputPathProbabilityValueEClass == null) {
			outputPathProbabilityValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							124);
		}
	...
	public EAttribute getOutputPathProbabilityValue_LiteralValue() {
		return (EAttribute) getOutputPathProbabilityValue()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getOutputRef() {
		if (outputRefEClass == null) {
			outputRefEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(125);
		}
	...
	public EClass getOutputRepositoryValue() {
		if (outputRepositoryValueEClass == null) {
			outputRepositoryValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							126);
		}
	...
	public EReference getOutputRepositoryValue_LocalRepository() {
		return (EReference) getOutputRepositoryValue().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getOutputRepositoryValue_AtBeginning() {
		return (EAttribute) getOutputRepositoryValue().getEStructuralFeatures()
				.get(2);
	}
	...
	public EClass getOutputRepositoryValueType() {
		if (outputRepositoryValueTypeEClass == null) {
			outputRepositoryValueTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							127);
		}
	...
	public EAttribute getOutputRepositoryValueType_Output() {
		return (EAttribute) getOutputRepositoryValueType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getOutputs() {
		if (outputsEClass == null) {
			outputsEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(128);
		}
	...
	public EClass getPersonNameType() {
		if (personNameTypeEClass == null) {
			personNameTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							132);
		}
	...
	public EClass getPersonSearchType() {
		if (personSearchTypeEClass == null) {
			personSearchTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							133);
		}
	...
	public EAttribute getPersonSearchType_UserId() {
		return (EAttribute) getPersonSearchType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getPoissonType() {
		if (poissonTypeEClass == null) {
			poissonTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							134);
		}
	...
	public EClass getPrivateInstance() {
		if (privateInstanceEClass == null) {
			privateInstanceEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							139);
		}
	...
	public EReference getPrivateInstance_AttributeValue() {
		return (EReference) getPrivateInstance().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getPrivateInstance_Name() {
		return (EAttribute) getPrivateInstance().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getProcess() {
		if (processEClass == null) {
			processEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(140);
		}
	...
	public EClass getProcessesType() {
		if (processesTypeEClass == null) {
			processesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							141);
		}
	...
	public EClass getProcessModel() {
		if (processModelEClass == null) {
			processModelEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							142);
		}
	...
	public EClass getPublicInstance() {
		if (publicInstanceEClass == null) {
			publicInstanceEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							143);
		}
	...
	public EClass getQualification() {
		if (qualificationEClass == null) {
			qualificationEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							144);
		}
	...
	public EClass getQuantity() {
		if (quantityEClass == null) {
			quantityEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(145);
		}
	...
	public EClass getRandomListType() {
		if (randomListTypeEClass == null) {
			randomListTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							146);
		}
	...
	public EClass getRecurringTimeIntervalType() {
		if (recurringTimeIntervalTypeEClass == null) {
			recurringTimeIntervalTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							147);
		}
	...
	public EAttribute getRecurringTimeIntervalType_StartTime() {
		return (EAttribute) getRecurringTimeIntervalType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EReference getRecurringTimeIntervalType_StartDayOfWeek() {
		return (EReference) getRecurringTimeIntervalType()
				.getEStructuralFeatures().get(1);
	}
	...
	public EClass getRelatedInputCriteriaType() {
		if (relatedInputCriteriaTypeEClass == null) {
			relatedInputCriteriaTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							148);
		}
	...
	public EReference getRelatedInputCriteriaType_InputCriterion() {
		return (EReference) getRelatedInputCriteriaType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getRepositoriesType() {
		if (repositoriesTypeEClass == null) {
			repositoriesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							149);
		}
	...
	public EReference getRepositoriesType_Repository() {
		return (EReference) getRepositoriesType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getRepository() {
		if (repositoryEClass == null) {
			repositoryEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(150);
		}
	...
	public EClass getRepositoryDataValue() {
		if (repositoryDataValueEClass == null) {
			repositoryDataValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							151);
		}
	...
	public EAttribute getRepositoryDataValue_Group() {
		return (EAttribute) getRepositoryDataValue().getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getRepositoryDataValue_ExpressionValue() {
		return (EReference) getRepositoryDataValue().getEStructuralFeatures()
				.get(2);
	}
	...
	public EClass getResourceModel() {
		if (resourceModelEClass == null) {
			resourceModelEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							152);
		}
	...
	public EClass getResources() {
		if (resourcesEClass == null) {
			resourcesEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(153);
		}
	...
	public EClass getRole() {
		if (roleEClass == null) {
			roleEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(154);
		}
		return roleEClass;
	}
	...
	public EClass getRoleRequirement() {
		if (roleRequirementEClass == null) {
			roleRequirementEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							155);
		}
	...
	public EReference getRoleRequirement_ResourceQuantity() {
		return (EReference) getRoleRequirement().getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getRoleRequirement_Name() {
		return (EAttribute) getRoleRequirement().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getRolesType() {
		if (rolesTypeEClass == null) {
			rolesTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(156);
		}
	...
	public EClass getScopeDimensionType() {
		if (scopeDimensionTypeEClass == null) {
			scopeDimensionTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							157);
		}
	...
	public EAttribute getScopeDimensionType_Name() {
		return (EAttribute) getScopeDimensionType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getScopeDimensionValue() {
		if (scopeDimensionValueEClass == null) {
			scopeDimensionValueEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							158);
		}
	...
	public EAttribute getScopeDimensionValue_Value() {
		return (EAttribute) getScopeDimensionValue().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getService() {
		if (serviceEClass == null) {
			serviceEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(159);
		}
	...
	public EClass getServicesType() {
		if (servicesTypeEClass == null) {
			servicesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							160);
		}
	...
	public EClass getSourceType() {
		if (sourceTypeEClass == null) {
			sourceTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(161);
		}
	...
	public EClass getStartDayOfWeekType() {
		if (startDayOfWeekTypeEClass == null) {
			startDayOfWeekTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							162);
		}
	...
	public EAttribute getStartDayOfWeekType_DayOfWeek() {
		return (EAttribute) getStartDayOfWeekType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getStartNodeType() {
		if (startNodeTypeEClass == null) {
			startNodeTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							163);
		}
	...
	public EClass getStopNodeType() {
		if (stopNodeTypeEClass == null) {
			stopNodeTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							164);
		}
	...
	public EClass getTargetType() {
		if (targetTypeEClass == null) {
			targetTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(165);
		}
	...
	public EClass getTask() {
		if (taskEClass == null) {
			taskEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(166);
		}
		return taskEClass;
	}
	...
	public EClass getTaskIndividualResourceRequirement() {
		if (taskIndividualResourceRequirementEClass == null) {
			taskIndividualResourceRequirementEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							167);
		}
	...
	public EReference getTaskIndividualResourceRequirement_Criteria() {
		return (EReference) getTaskIndividualResourceRequirement()
				.getEStructuralFeatures().get(0);
	}
	...
	public EClass getTasksType() {
		if (tasksTypeEClass == null) {
			tasksTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(168);
		}
	...
	public EClass getTimeEstimationType() {
		if (timeEstimationTypeEClass == null) {
			timeEstimationTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							169);
		}
	...
	public EReference getTimeEstimationType_ProcessingTime() {
		return (EReference) getTimeEstimationType().getEStructuralFeatures()
				.get(0);
	}
	...
	public EClass getTimer() {
		if (timerEClass == null) {
			timerEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(170);
		}
		return timerEClass;
	}
	...
	public EClass getTimerSettingType() {
		if (timerSettingTypeEClass == null) {
			timerSettingTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							171);
		}
	...
	public EReference getTimerSettingType_BasedOnTimetable() {
		return (EReference) getTimerSettingType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getTimetable() {
		if (timetableEClass == null) {
			timetableEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(172);
		}
	...
	public EClass getTimetablesType() {
		if (timetablesTypeEClass == null) {
			timetablesTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							173);
		}
	...
	public EClass getTimeValue() {
		if (timeValueEClass == null) {
			timeValueEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(176);
		}
	...
	public EAttribute getTypeDeclaration_Name() {
		return (EAttribute) getTypeDeclaration().getEStructuralFeatures()
				.get(1);
	}
	...
	public EClass getUniformType() {
		if (uniformTypeEClass == null) {
			uniformTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							182);
		}
	...
	public EClass getValueType() {
		if (valueTypeEClass == null) {
			valueTypeEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(185);
		}
	...
	public EClass getWeightedListType() {
		if (weightedListTypeEClass == null) {
			weightedListTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							186);
		}
	...
	public EReference getWeightedListType_Value() {
		return (EReference) getWeightedListType().getEStructuralFeatures().get(
				0);
	}
	...
	public EClass getWhenCostApplicableType() {
		if (whenCostApplicableTypeEClass == null) {
			whenCostApplicableTypeEClass = (EClass) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							187);
		}
	...
	public EAttribute getWhenCostApplicableType_Timetable() {
		return (EAttribute) getWhenCostApplicableType()
				.getEStructuralFeatures().get(0);
	}
	...
	public EEnum getBasicDataType() {
		if (basicDataTypeEEnum == null) {
			basicDataTypeEEnum = (EEnum) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							9);
		}
	...
	public EEnum getCurrency() {
		if (currencyEEnum == null) {
			currencyEEnum = (EEnum) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(38);
		}
	...
	public EEnum getDayOfWeek() {
		if (dayOfWeekEEnum == null) {
			dayOfWeekEEnum = (EEnum) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(41);
		}
	...
	public EEnum getMultipleInstancesMatch() {
		if (multipleInstancesMatchEEnum == null) {
			multipleInstancesMatchEEnum = (EEnum) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							97);
		}
	...
	public EEnum getNoInstancesMatch() {
		if (noInstancesMatchEEnum == null) {
			noInstancesMatchEEnum = (EEnum) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							99);
		}
	...
	public EEnum getTimeUnit() {
		if (timeUnitEEnum == null) {
			timeUnitEEnum = (EEnum) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(174);
		}
	...
	public EEnum getTypeType1() {
		if (typeType1EEnum == null) {
			typeType1EEnum = (EEnum) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(179);
		}
	...
	public EDataType getAssociatedDataType() {
		if (associatedDataTypeEDataType == null) {
			associatedDataTypeEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							4);
		}
	...
	public EDataType getBasicDataTypeObject() {
		if (basicDataTypeObjectEDataType == null) {
			basicDataTypeObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							10);
		}
	...
	public EDataType getCurrencyObject() {
		if (currencyObjectEDataType == null) {
			currencyObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							39);
		}
	...
	public EDataType getDayOfWeekObject() {
		if (dayOfWeekObjectEDataType == null) {
			dayOfWeekObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							42);
		}
	...
	public EDataType getElementName() {
		if (elementNameEDataType == null) {
			elementNameEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							48);
		}
	...
	public EDataType getInstanceOfType() {
		if (instanceOfTypeEDataType == null) {
			instanceOfTypeEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							78);
		}
	...
	public EDataType getMultipleInstancesMatchObject() {
		if (multipleInstancesMatchObjectEDataType == null) {
			multipleInstancesMatchObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							98);
		}
	...
	public EDataType getNoInstancesMatchObject() {
		if (noInstancesMatchObjectEDataType == null) {
			noInstancesMatchObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							100);
		}
	...
	public EDataType getNonNegativeDouble() {
		if (nonNegativeDoubleEDataType == null) {
			nonNegativeDoubleEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							101);
		}
	...
	public EDataType getNonNegativeDoubleObject() {
		if (nonNegativeDoubleObjectEDataType == null) {
			nonNegativeDoubleObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							102);
		}
	...
	public EDataType getParentTemplateType() {
		if (parentTemplateTypeEDataType == null) {
			parentTemplateTypeEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							129);
		}
	...
	public EDataType getPercentageValue() {
		if (percentageValueEDataType == null) {
			percentageValueEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							130);
		}
	...
	public EDataType getPercentageValueObject() {
		if (percentageValueObjectEDataType == null) {
			percentageValueObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							131);
		}
	...
	public EDataType getPredefinedOrganizationTypeObject() {
		if (predefinedOrganizationTypeObjectEDataType == null) {
			predefinedOrganizationTypeObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							136);
		}
		return predefinedOrganizationTypeObjectEDataType;
	}
	...
	public EDataType getPredefinedResourceTypeObject() {
		if (predefinedResourceTypeObjectEDataType == null) {
			predefinedResourceTypeObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							138);
		}
		return predefinedResourceTypeObjectEDataType;
	}
	...
	public EEnum getPredefinedOrganizationType() {
		if (predefinedOrganizationTypeEEnum == null) {
			predefinedOrganizationTypeEEnum = (EEnum) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							135);
		}
		return predefinedOrganizationTypeEEnum;
	}
	...
	public EEnum getPredefinedResourceType() {
		if (predefinedResourceTypeEEnum == null) {
			predefinedResourceTypeEEnum = (EEnum) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							137);
		}
		return predefinedResourceTypeEEnum;
	}
	...
	public EDataType getTimeUnitObject() {
		if (timeUnitObjectEDataType == null) {
			timeUnitObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							175);
		}
	...
	public EDataType getTypeType() {
		if (typeTypeEDataType == null) {
			typeTypeEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							178);
		}
	...
	public EDataType getTypeType2() {
		if (typeType2EDataType == null) {
			typeType2EDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							180);
		}
	...
	public EDataType getTypeTypeObject() {
		if (typeTypeObjectEDataType == null) {
			typeTypeObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							181);
		}
	...
	public EDataType getUnitObject() {
		if (unitObjectEDataType == null) {
			unitObjectEDataType = (EDataType) EPackage.Registry.INSTANCE
					.getEPackage(Schema1Package.eNS_URI).getEClassifiers().get(
							184);
		}
		return unitObjectEDataType;
	}
	...
	public EEnum getUnit() {
		if (unitEEnum == null) {
			unitEEnum = (EEnum) EPackage.Registry.INSTANCE.getEPackage(
					Schema1Package.eNS_URI).getEClassifiers().get(183);
		}
		return unitEEnum;
	}
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("com.ibm.wbim.bom.schema1."
					+ eClassifier.getName());
