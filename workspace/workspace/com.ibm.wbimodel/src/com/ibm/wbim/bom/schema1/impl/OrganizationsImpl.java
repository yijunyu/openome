...
public class OrganizationsImpl extends EObjectImpl implements Organizations {
	 ...
	 * @ordered
	 */
	protected EList<OrganizationUnitType> organizationUnit;
	 ...
	 * @generated
	 */
	public EList<OrganizationUnitType> getOrganizationUnit() {
		if (organizationUnit == null) {
			organizationUnit = new EObjectContainmentEList<OrganizationUnitType>(
					OrganizationUnitType.class, this,
					Schema1Package.ORGANIZATIONS__ORGANIZATION_UNIT);
		}
	...
	public EList<LocationType> getLocation() {
		if (location == null) {
			location = new EObjectContainmentEList<LocationType>(
					LocationType.class, this,
					Schema1Package.ORGANIZATIONS__LOCATION);
		}
		return location;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.ORGANIZATIONS__ORGANIZATION_UNIT:
			...
			getOrganizationUnit().addAll(
					(Collection<? extends OrganizationUnitType>) newValue);
			return;
		case Schema1Package.ORGANIZATIONS__LOCATION:
			getLocation().clear();
