...
public class DefaultValueImpl extends EObjectImpl implements DefaultValue {
	...
	public void setLiteralValue(String newLiteralValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DEFAULT_VALUE__LITERAL_VALUE,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExpressionValue(
			Expression newExpressionValue, NotificationChain msgs) {
		Expression oldExpressionValue = expressionValue;
		expressionValue = newExpressionValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.DEFAULT_VALUE__EXPRESSION_VALUE,
					oldExpressionValue, newExpressionValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setExpressionValue(Expression newExpressionValue) {
		if (newExpressionValue != expressionValue) {
			...
			if (expressionValue != null)
				msgs = ((InternalEObject) expressionValue)
						.eInverseRemove(
								this,
			...
			if (newExpressionValue != null)
				msgs = ((InternalEObject) newExpressionValue)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.DEFAULT_VALUE__EXPRESSION_VALUE,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DEFAULT_VALUE__EXPRESSION_VALUE,
					newExpressionValue, newExpressionValue));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.DEFAULT_VALUE__LITERAL_VALUE:
			return LITERAL_VALUE_EDEFAULT == null ? literalValue != null
					: !LITERAL_VALUE_EDEFAULT.equals(literalValue);
		case Schema1Package.DEFAULT_VALUE__EXPRESSION_VALUE:
