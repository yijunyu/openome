...
public class TimetableImpl extends EObjectImpl implements Timetable {
	 ...
	 * @ordered
	 */
	protected EList<RecurringTimeIntervalType> recurringTimeInterval;
	 ...
	 * @ordered
	 */
	protected EList<ExemptionPeriodType> exemptionPeriod;
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMETABLE__DOCUMENTATION, oldDocumentation,
					documentation));
	}
	 ...
	 * @generated
	 */
	public EList<RecurringTimeIntervalType> getRecurringTimeInterval() {
		if (recurringTimeInterval == null) {
			recurringTimeInterval = new EObjectContainmentEList<RecurringTimeIntervalType>(
					RecurringTimeIntervalType.class, this,
					Schema1Package.TIMETABLE__RECURRING_TIME_INTERVAL);
		}
	 ...
	 * @generated
	 */
	public EList<ExemptionPeriodType> getExemptionPeriod() {
		if (exemptionPeriod == null) {
			exemptionPeriod = new EObjectContainmentEList<ExemptionPeriodType>(
					ExemptionPeriodType.class, this,
					Schema1Package.TIMETABLE__EXEMPTION_PERIOD);
		}
	...
	public NotificationChain basicSetExtendedAttributes(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.TIMETABLE__EXTENDED_ATTRIBUTES,
	...
	public void setExtendedAttributes(ExtendedAttributes newExtendedAttributes) {
		if (newExtendedAttributes != extendedAttributes) {
			...
			if (extendedAttributes != null)
				msgs = ((InternalEObject) extendedAttributes)
						.eInverseRemove(
								this,
			...
			if (newExtendedAttributes != null)
				msgs = ((InternalEObject) newExtendedAttributes)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIMETABLE__EXTENDED_ATTRIBUTES,
	...
	public void setBeginingOn(XMLGregorianCalendar newBeginingOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMETABLE__BEGINING_ON, oldBeginingOn,
					beginingOn));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMETABLE__NAME, oldName, name));
	}
	...
	public void setNumberOfTimesToRepeat(BigInteger newNumberOfTimesToRepeat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMETABLE__NUMBER_OF_TIMES_TO_REPEAT,
					oldNumberOfTimesToRepeat, numberOfTimesToRepeat));
	}
	...
	public void setRepetitionPeriod(Duration newRepetitionPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMETABLE__REPETITION_PERIOD,
					oldRepetitionPeriod, repetitionPeriod));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.TIMETABLE__RECURRING_TIME_INTERVAL:
			return ((InternalEList<?>) getRecurringTimeInterval()).basicRemove(
					otherEnd, msgs);
		case Schema1Package.TIMETABLE__EXEMPTION_PERIOD:
			return ((InternalEList<?>) getExemptionPeriod()).basicRemove(
					otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.TIMETABLE__RECURRING_TIME_INTERVAL:
			...
			getRecurringTimeInterval().addAll(
					(Collection<? extends RecurringTimeIntervalType>) newValue);
			return;
		case Schema1Package.TIMETABLE__EXEMPTION_PERIOD:
			getExemptionPeriod().clear();
			getExemptionPeriod().addAll(
					(Collection<? extends ExemptionPeriodType>) newValue);
			return;
		case Schema1Package.TIMETABLE__EXTENDED_ATTRIBUTES:
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.TIMETABLE__RECURRING_TIME_INTERVAL:
			return recurringTimeInterval != null
					&& !recurringTimeInterval.isEmpty();
		case Schema1Package.TIMETABLE__EXEMPTION_PERIOD:
			return exemptionPeriod != null && !exemptionPeriod.isEmpty();
		case Schema1Package.TIMETABLE__EXTENDED_ATTRIBUTES:
			return extendedAttributes != null;
		case Schema1Package.TIMETABLE__BEGINING_ON:
			return BEGINING_ON_EDEFAULT == null ? beginingOn != null
					: !BEGINING_ON_EDEFAULT.equals(beginingOn);
		case Schema1Package.TIMETABLE__NAME:
			return NAME_EDEFAULT == null ? name != null : !NAME_EDEFAULT
					.equals(name);
		case Schema1Package.TIMETABLE__NUMBER_OF_TIMES_TO_REPEAT:
			return NUMBER_OF_TIMES_TO_REPEAT_EDEFAULT == null ? numberOfTimesToRepeat != null
					: !NUMBER_OF_TIMES_TO_REPEAT_EDEFAULT
							.equals(numberOfTimesToRepeat);
		case Schema1Package.TIMETABLE__REPETITION_PERIOD:
			return REPETITION_PERIOD_EDEFAULT == null ? repetitionPeriod != null
					: !REPETITION_PERIOD_EDEFAULT.equals(repetitionPeriod);
		}
