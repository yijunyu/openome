 ...
 * @generated
 */
public class IndividualResourceDefinitionsTypeImpl extends EObjectImpl
		implements IndividualResourceDefinitionsType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<TypeDeclaration> individualResourceDefinition;
	 ...
	 * @generated
	 */
	public EList<TypeDeclaration> getIndividualResourceDefinition() {
		if (individualResourceDefinition == null) {
			individualResourceDefinition = new EObjectContainmentEList<TypeDeclaration>(
					TypeDeclaration.class,
					this,
					Schema1Package.INDIVIDUAL_RESOURCE_DEFINITIONS_TYPE__INDIVIDUAL_RESOURCE_DEFINITION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.INDIVIDUAL_RESOURCE_DEFINITIONS_TYPE__INDIVIDUAL_RESOURCE_DEFINITION:
			return ((InternalEList<?>) getIndividualResourceDefinition())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.INDIVIDUAL_RESOURCE_DEFINITIONS_TYPE__INDIVIDUAL_RESOURCE_DEFINITION:
			...
			getIndividualResourceDefinition().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.INDIVIDUAL_RESOURCE_DEFINITIONS_TYPE__INDIVIDUAL_RESOURCE_DEFINITION:
			return individualResourceDefinition != null
					&& !individualResourceDefinition.isEmpty();
		}
