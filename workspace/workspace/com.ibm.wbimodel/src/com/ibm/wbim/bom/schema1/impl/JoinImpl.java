...
public class JoinImpl extends EObjectImpl implements Join {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.JOIN__DESCRIPTION, oldDescription,
					description));
	}
	...
	public EList<InputBranch> getInputBranch() {
		if (inputBranch == null) {
			inputBranch = new EObjectContainmentEList<InputBranch>(
					InputBranch.class, this, Schema1Package.JOIN__INPUT_BRANCH);
		}
		return inputBranch;
	}
	...
	public NotificationChain basicSetOutputBranch(OutputBranch newOutputBranch,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.JOIN__OUTPUT_BRANCH,
	...
	public void setOutputBranch(OutputBranch newOutputBranch) {
		if (newOutputBranch != outputBranch) {
			...
			if (outputBranch != null)
				msgs = ((InternalEObject) outputBranch).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.JOIN__OUTPUT_BRANCH, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.JOIN__OUTPUT_BRANCH, newOutputBranch,
					newOutputBranch));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.JOIN__NAME, oldName, name));
	}
