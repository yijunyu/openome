...
public class CostTypeImpl extends EObjectImpl implements CostType {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExecutionCost(CostValue newExecutionCost,
			NotificationChain msgs) {
		CostValue oldExecutionCost = executionCost;
		executionCost = newExecutionCost;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.COST_TYPE__EXECUTION_COST,
	...
	public void setExecutionCost(CostValue newExecutionCost) {
		if (newExecutionCost != executionCost) {
			...
			if (executionCost != null)
				msgs = ((InternalEObject) executionCost).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.COST_TYPE__EXECUTION_COST,
						null, msgs);
			if (newExecutionCost != null)
				msgs = ((InternalEObject) newExecutionCost).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.COST_TYPE__EXECUTION_COST,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_TYPE__EXECUTION_COST, newExecutionCost,
					newExecutionCost));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStartupCost(CostValue newStartupCost,
			NotificationChain msgs) {
		CostValue oldStartupCost = startupCost;
		startupCost = newStartupCost;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.COST_TYPE__STARTUP_COST,
					oldStartupCost, newStartupCost);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setStartupCost(CostValue newStartupCost) {
		if (newStartupCost != startupCost) {
			NotificationChain msgs = null;
			if (startupCost != null)
				msgs = ((InternalEObject) startupCost).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.COST_TYPE__STARTUP_COST, null,
						msgs);
			if (newStartupCost != null)
				msgs = ((InternalEObject) newStartupCost).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.COST_TYPE__STARTUP_COST, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_TYPE__STARTUP_COST, newStartupCost,
					newStartupCost));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetResourceWaitingCost(
			CostPerTimeUnitValue newResourceWaitingCost, NotificationChain msgs) {
		CostPerTimeUnitValue oldResourceWaitingCost = resourceWaitingCost;
		resourceWaitingCost = newResourceWaitingCost;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.COST_TYPE__RESOURCE_WAITING_COST,
					oldResourceWaitingCost, newResourceWaitingCost);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setResourceWaitingCost(
			CostPerTimeUnitValue newResourceWaitingCost) {
		if (newResourceWaitingCost != resourceWaitingCost) {
			NotificationChain msgs = null;
			if (resourceWaitingCost != null)
				msgs = ((InternalEObject) resourceWaitingCost)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.COST_TYPE__RESOURCE_WAITING_COST,
			...
			if (newResourceWaitingCost != null)
				msgs = ((InternalEObject) newResourceWaitingCost)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.COST_TYPE__RESOURCE_WAITING_COST,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_TYPE__RESOURCE_WAITING_COST,
					newResourceWaitingCost, newResourceWaitingCost));
	}
