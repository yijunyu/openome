...
public class TimeValueImpl extends EObjectImpl implements TimeValue {
	...
	public void setLiteralValue(Duration newLiteralValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIME_VALUE__LITERAL_VALUE, oldLiteralValue,
					literalValue));
	}
	...
	public NotificationChain basicSetDistribution(
			DistributionType1 newDistribution, NotificationChain msgs) {
		DistributionType1 oldDistribution = distribution;
		distribution = newDistribution;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TIME_VALUE__DISTRIBUTION,
	...
	public void setDistribution(DistributionType1 newDistribution) {
		if (newDistribution != distribution) {
			...
			if (distribution != null)
				msgs = ((InternalEObject) distribution).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.TIME_VALUE__DISTRIBUTION,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIME_VALUE__DISTRIBUTION, newDistribution,
					newDistribution));
	}
