 ...
 * @generated
 */
public class OutputRepositoryValueImpl extends EObjectImpl implements
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLocalRepository(
			LocalRepositoryRef newLocalRepository, NotificationChain msgs) {
		LocalRepositoryRef oldLocalRepository = localRepository;
		localRepository = newLocalRepository;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__LOCAL_REPOSITORY,
					oldLocalRepository, newLocalRepository);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setLocalRepository(LocalRepositoryRef newLocalRepository) {
		if (newLocalRepository != localRepository) {
			...
			if (localRepository != null)
				msgs = ((InternalEObject) localRepository)
						.eInverseRemove(
								this,
			...
			if (newLocalRepository != null)
				msgs = ((InternalEObject) newLocalRepository)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OUTPUT_REPOSITORY_VALUE__LOCAL_REPOSITORY,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__LOCAL_REPOSITORY,
					newLocalRepository, newLocalRepository));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGlobalRepository(
			GlobalRepositoryRef newGlobalRepository, NotificationChain msgs) {
		GlobalRepositoryRef oldGlobalRepository = globalRepository;
		globalRepository = newGlobalRepository;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__GLOBAL_REPOSITORY,
					oldGlobalRepository, newGlobalRepository);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setGlobalRepository(GlobalRepositoryRef newGlobalRepository) {
		if (newGlobalRepository != globalRepository) {
			...
			if (globalRepository != null)
				msgs = ((InternalEObject) globalRepository)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OUTPUT_REPOSITORY_VALUE__GLOBAL_REPOSITORY,
			...
			if (newGlobalRepository != null)
				msgs = ((InternalEObject) newGlobalRepository)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OUTPUT_REPOSITORY_VALUE__GLOBAL_REPOSITORY,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__GLOBAL_REPOSITORY,
					newGlobalRepository, newGlobalRepository));
	}
	...
	public void setAtBeginning(boolean newAtBeginning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__AT_BEGINNING,
					oldAtBeginning, atBeginning, !oldAtBeginningESet));
	}
	...
	public void unsetAtBeginning() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__AT_BEGINNING,
					oldAtBeginning, AT_BEGINNING_EDEFAULT, oldAtBeginningESet));
	}
	...
	public void setIsInsert(boolean newIsInsert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__IS_INSERT,
					oldIsInsert, isInsert, !oldIsInsertESet));
	}
	...
	public void unsetIsInsert() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE__IS_INSERT,
					oldIsInsert, IS_INSERT_EDEFAULT, oldIsInsertESet));
	}
