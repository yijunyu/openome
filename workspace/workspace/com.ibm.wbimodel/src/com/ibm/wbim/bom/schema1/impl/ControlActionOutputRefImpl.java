 ...
 * @generated
 */
public class ControlActionOutputRefImpl extends EObjectImpl implements
	...
	public NotificationChain basicSetRepositoryValue(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CONTROL_ACTION_OUTPUT_REF__REPOSITORY_VALUE,
	...
	public void setRepositoryValue(OutputRepositoryValue newRepositoryValue) {
		if (newRepositoryValue != repositoryValue) {
			...
			if (repositoryValue != null)
				msgs = ((InternalEObject) repositoryValue)
						.eInverseRemove(
								this,
			...
			if (newRepositoryValue != null)
				msgs = ((InternalEObject) newRepositoryValue)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CONTROL_ACTION_OUTPUT_REF__REPOSITORY_VALUE,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CONTROL_ACTION_OUTPUT_REF__NAME, oldName,
					name));
	}
