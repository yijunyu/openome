 ...
 * @generated
 */
public class NotificationBroadcasterImpl extends TaskImpl implements
	...
	public void setNotification(String newNotification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.NOTIFICATION_BROADCASTER__NOTIFICATION,
	...
	public void setScope(String newScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.NOTIFICATION_BROADCASTER__SCOPE, oldScope,
					scope));
	}
