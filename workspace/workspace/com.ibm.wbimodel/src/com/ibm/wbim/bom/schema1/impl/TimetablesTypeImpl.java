...
public class TimetablesTypeImpl extends EObjectImpl implements TimetablesType {
	 ...
	 * @ordered
	 */
	protected EList<Timetable> timetable;
	 ...
	 * @generated
	 */
	public EList<Timetable> getTimetable() {
		if (timetable == null) {
			timetable = new EObjectContainmentEList<Timetable>(Timetable.class,
					this, Schema1Package.TIMETABLES_TYPE__TIMETABLE);
		}
		return timetable;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.TIMETABLES_TYPE__TIMETABLE:
			return ((InternalEList<?>) getTimetable()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.TIMETABLES_TYPE__TIMETABLE:
			getTimetable().clear();
			getTimetable().addAll((Collection<? extends Timetable>) newValue);
			return;
		}
