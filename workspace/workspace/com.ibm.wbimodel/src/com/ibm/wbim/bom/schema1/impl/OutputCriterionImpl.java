...
public class OutputCriterionImpl extends EObjectImpl implements OutputCriterion {
	 ...
	 * @ordered
	 */
	protected EList<OutputRef> output;
	 ...
	 * @ordered
	 */
	protected static final TypeType1 TYPE_EDEFAULT = TypeType1.REGULAR;
	 ...
	 * @generated
	 */
	public EList<OutputRef> getOutput() {
		if (output == null) {
			output = new EObjectContainmentEList<OutputRef>(OutputRef.class,
					this, Schema1Package.OUTPUT_CRITERION__OUTPUT);
		}
		return output;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRelatedInputCriteria(
			RelatedInputCriteriaType newRelatedInputCriteria,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.OUTPUT_CRITERION__RELATED_INPUT_CRITERIA,
					oldRelatedInputCriteria, newRelatedInputCriteria);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRelatedInputCriteria(
		...
		if (newRelatedInputCriteria != relatedInputCriteria) {
			...
			if (newRelatedInputCriteria != null)
				msgs = ((InternalEObject) newRelatedInputCriteria)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OUTPUT_CRITERION__RELATED_INPUT_CRITERIA,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_CRITERION__RELATED_INPUT_CRITERIA,
					newRelatedInputCriteria, newRelatedInputCriteria));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_CRITERION__NAME, oldName, name));
	}
	...
	public void setType(TypeType1 newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_CRITERION__TYPE, oldType, type,
					!oldTypeESet));
	}
	...
	public void unsetType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.OUTPUT_CRITERION__TYPE, oldType,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.OUTPUT_CRITERION__OUTPUT:
			getOutput().clear();
			getOutput().addAll((Collection<? extends OutputRef>) newValue);
			return;
		case Schema1Package.OUTPUT_CRITERION__RELATED_INPUT_CRITERIA:
