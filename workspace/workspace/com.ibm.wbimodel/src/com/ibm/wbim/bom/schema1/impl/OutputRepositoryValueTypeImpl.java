 ...
 * @generated
 */
public class OutputRepositoryValueTypeImpl extends OutputRepositoryValueImpl
		implements OutputRepositoryValueType {
	/**
	...
	public void setOutput(String newOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_REPOSITORY_VALUE_TYPE__OUTPUT,
					oldOutput, output));
	}
