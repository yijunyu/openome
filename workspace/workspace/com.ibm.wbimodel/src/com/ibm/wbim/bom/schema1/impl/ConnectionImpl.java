...
public class ConnectionImpl extends EObjectImpl implements Connection {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CONNECTION__DESCRIPTION, oldDescription,
					description));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSource(SourceType newSource,
			NotificationChain msgs) {
		SourceType oldSource = source;
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.CONNECTION__SOURCE,
					oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSource(SourceType newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.CONNECTION__SOURCE, null, msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CONNECTION__SOURCE, newSource, newSource));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTarget(TargetType newTarget,
			NotificationChain msgs) {
		TargetType oldTarget = target;
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.CONNECTION__TARGET,
					oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.CONNECTION__TARGET, null, msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CONNECTION__TARGET, newTarget, newTarget));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CONNECTION__NAME, oldName, name));
	}
