 ...
 * @generated
 */
public class TimeEstimationTypeImpl extends EObjectImpl implements
		TimeEstimationType {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProcessingTime(
			TimeValue newProcessingTime, NotificationChain msgs) {
		TimeValue oldProcessingTime = processingTime;
		processingTime = newProcessingTime;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.TIME_ESTIMATION_TYPE__PROCESSING_TIME,
					oldProcessingTime, newProcessingTime);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setProcessingTime(TimeValue newProcessingTime) {
		if (newProcessingTime != processingTime) {
			...
			if (processingTime != null)
				msgs = ((InternalEObject) processingTime)
						.eInverseRemove(
								this,
			...
			if (newProcessingTime != null)
				msgs = ((InternalEObject) newProcessingTime)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIME_ESTIMATION_TYPE__PROCESSING_TIME,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIME_ESTIMATION_TYPE__PROCESSING_TIME,
					newProcessingTime, newProcessingTime));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMaxResourceWaitingTime(
			TimeValue newMaxResourceWaitingTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.TIME_ESTIMATION_TYPE__MAX_RESOURCE_WAITING_TIME,
					oldMaxResourceWaitingTime, newMaxResourceWaitingTime);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setMaxResourceWaitingTime(TimeValue newMaxResourceWaitingTime) {
		if (newMaxResourceWaitingTime != maxResourceWaitingTime) {
			...
			if (maxResourceWaitingTime != null)
				msgs = ((InternalEObject) maxResourceWaitingTime)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIME_ESTIMATION_TYPE__MAX_RESOURCE_WAITING_TIME,
			...
			if (newMaxResourceWaitingTime != null)
				msgs = ((InternalEObject) newMaxResourceWaitingTime)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIME_ESTIMATION_TYPE__MAX_RESOURCE_WAITING_TIME,
								null, msgs);
			msgs = basicSetMaxResourceWaitingTime(newMaxResourceWaitingTime,
					msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					Schema1Package.TIME_ESTIMATION_TYPE__MAX_RESOURCE_WAITING_TIME,
					newMaxResourceWaitingTime, newMaxResourceWaitingTime));
	}
