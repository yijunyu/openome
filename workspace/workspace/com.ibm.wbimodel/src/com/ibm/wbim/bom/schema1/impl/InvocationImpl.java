...
public class InvocationImpl extends EObjectImpl implements Invocation {
	...
	public EList<InputConstantValueType> getInputConstantValue() {
		if (inputConstantValue == null) {
			inputConstantValue = new EObjectContainmentEList<InputConstantValueType>(
					InputConstantValueType.class, this,
					Schema1Package.INVOCATION__INPUT_CONSTANT_VALUE);
		}
	...
	public EList<InputRepositoryValueType> getInputRepositoryValue() {
		if (inputRepositoryValue == null) {
			inputRepositoryValue = new EObjectContainmentEList<InputRepositoryValueType>(
					InputRepositoryValueType.class, this,
					Schema1Package.INVOCATION__INPUT_REPOSITORY_VALUE);
		}
	...
	public EList<OutputRepositoryValueType> getOutputRepositoryValue() {
		if (outputRepositoryValue == null) {
			outputRepositoryValue = new EObjectContainmentEList<OutputRepositoryValueType>(
					OutputRepositoryValueType.class, this,
					Schema1Package.INVOCATION__OUTPUT_REPOSITORY_VALUE);
		}
	...
	public EList<AdditionalInputType> getAdditionalInput() {
		if (additionalInput == null) {
			additionalInput = new EObjectContainmentEList<AdditionalInputType>(
					AdditionalInputType.class, this,
					Schema1Package.INVOCATION__ADDITIONAL_INPUT);
		}
	...
	public EList<AdditionalOutputType> getAdditionalOutput() {
		if (additionalOutput == null) {
			additionalOutput = new EObjectContainmentEList<AdditionalOutputType>(
					AdditionalOutputType.class, this,
					Schema1Package.INVOCATION__ADDITIONAL_OUTPUT);
		}
	...
	public void setCallSynchronously(boolean newCallSynchronously) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INVOCATION__CALL_SYNCHRONOUSLY,
					oldCallSynchronously, callSynchronously,
					!oldCallSynchronouslyESet));
	}
	...
	public void unsetCallSynchronously() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.INVOCATION__CALL_SYNCHRONOUSLY,
					oldCallSynchronously, CALL_SYNCHRONOUSLY_EDEFAULT,
					oldCallSynchronouslyESet));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INVOCATION__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.INVOCATION__INPUT_CONSTANT_VALUE:
			return ((InternalEList<?>) getInputConstantValue()).basicRemove(
					otherEnd, msgs);
		case Schema1Package.INVOCATION__INPUT_REPOSITORY_VALUE:
			return ((InternalEList<?>) getInputRepositoryValue()).basicRemove(
					otherEnd, msgs);
		case Schema1Package.INVOCATION__OUTPUT_REPOSITORY_VALUE:
			return ((InternalEList<?>) getOutputRepositoryValue()).basicRemove(
					otherEnd, msgs);
		case Schema1Package.INVOCATION__ADDITIONAL_INPUT:
			return ((InternalEList<?>) getAdditionalInput()).basicRemove(
					otherEnd, msgs);
		case Schema1Package.INVOCATION__ADDITIONAL_OUTPUT:
			return ((InternalEList<?>) getAdditionalOutput()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.INVOCATION__INPUT_CONSTANT_VALUE:
			...
			getInputConstantValue().addAll(
					(Collection<? extends InputConstantValueType>) newValue);
			return;
		case Schema1Package.INVOCATION__INPUT_REPOSITORY_VALUE:
			getInputRepositoryValue().clear();
			getInputRepositoryValue().addAll(
					(Collection<? extends InputRepositoryValueType>) newValue);
			return;
		case Schema1Package.INVOCATION__OUTPUT_REPOSITORY_VALUE:
			getOutputRepositoryValue().clear();
			getOutputRepositoryValue().addAll(
					(Collection<? extends OutputRepositoryValueType>) newValue);
			return;
		case Schema1Package.INVOCATION__ADDITIONAL_INPUT:
			getAdditionalInput().clear();
			getAdditionalInput().addAll(
					(Collection<? extends AdditionalInputType>) newValue);
			return;
		case Schema1Package.INVOCATION__ADDITIONAL_OUTPUT:
			getAdditionalOutput().clear();
			getAdditionalOutput().addAll(
					(Collection<? extends AdditionalOutputType>) newValue);
			return;
		case Schema1Package.INVOCATION__CALL_SYNCHRONOUSLY:
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.INVOCATION__INPUT_REPOSITORY_VALUE:
			return inputRepositoryValue != null
					&& !inputRepositoryValue.isEmpty();
		case Schema1Package.INVOCATION__OUTPUT_REPOSITORY_VALUE:
			return outputRepositoryValue != null
					&& !outputRepositoryValue.isEmpty();
		case Schema1Package.INVOCATION__ADDITIONAL_INPUT:
