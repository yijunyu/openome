 ...
 * @generated
 */
public class RepositoriesTypeImpl extends EObjectImpl implements
		RepositoriesType {
	/**
	...
	public EList<Repository> getRepository() {
		if (repository == null) {
			repository = new EObjectContainmentEList<Repository>(
					...
					Schema1Package.REPOSITORIES_TYPE__REPOSITORY);
		}
		return repository;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.REPOSITORIES_TYPE__REPOSITORY:
			return ((InternalEList<?>) getRepository()).basicRemove(otherEnd,
					msgs);
		}
