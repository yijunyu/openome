...
public class OutputImpl extends EObjectImpl implements Output {
	...
	public NotificationChain basicSetRepositoryValue(
			OutputRepositoryValue newRepositoryValue, NotificationChain msgs) {
		OutputRepositoryValue oldRepositoryValue = repositoryValue;
		repositoryValue = newRepositoryValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.OUTPUT__REPOSITORY_VALUE,
	...
	public void setRepositoryValue(OutputRepositoryValue newRepositoryValue) {
		if (newRepositoryValue != repositoryValue) {
			...
			if (repositoryValue != null)
				msgs = ((InternalEObject) repositoryValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.OUTPUT__REPOSITORY_VALUE,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT__REPOSITORY_VALUE,
					newRepositoryValue, newRepositoryValue));
	}
	...
	public void setAssociatedData(String newAssociatedData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT__ASSOCIATED_DATA, oldAssociatedData,
					associatedData));
	}
	...
	public void setIsOrdered(boolean newIsOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT__IS_ORDERED, oldIsOrdered, isOrdered,
					!oldIsOrderedESet));
	}
	...
	public void unsetIsOrdered() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.OUTPUT__IS_ORDERED, oldIsOrdered,
	...
	public void setIsUnique(boolean newIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT__IS_UNIQUE, oldIsUnique, isUnique,
					!oldIsUniqueESet));
	}
	...
	public void unsetIsUnique() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.OUTPUT__IS_UNIQUE, oldIsUnique,
	...
	public void setMaximum(BigInteger newMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT__MAXIMUM, oldMaximum, maximum,
					!oldMaximumESet));
	}
	...
	public void unsetMaximum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.OUTPUT__MAXIMUM, oldMaximum,
	...
	public void setMinimum(BigInteger newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT__MINIMUM, oldMinimum, minimum,
					!oldMinimumESet));
	}
	...
	public void unsetMinimum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.OUTPUT__MINIMUM, oldMinimum,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT__NAME, oldName, name));
	}
