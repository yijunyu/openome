 ...
 * @generated
 */
public class InputRepositoryValueTypeImpl extends InputRepositoryValueImpl
		implements InputRepositoryValueType {
	/**
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.INPUT_REPOSITORY_VALUE_TYPE;
	}
	...
	public void setInput(String newInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT_REPOSITORY_VALUE_TYPE__INPUT,
					oldInput, input));
	}
