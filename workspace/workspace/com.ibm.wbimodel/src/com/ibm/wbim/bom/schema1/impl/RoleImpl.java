...
public class RoleImpl extends EObjectImpl implements Role {
	 ...
	 * @ordered
	 */
	protected EList<ScopeDimensionType> scopeDimension;
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ROLE__DOCUMENTATION, oldDocumentation,
					documentation));
	}
	 ...
	 * @generated
	 */
	public EList<ScopeDimensionType> getScopeDimension() {
		if (scopeDimension == null) {
			scopeDimension = new EObjectContainmentEList<ScopeDimensionType>(
					ScopeDimensionType.class, this,
					Schema1Package.ROLE__SCOPE_DIMENSION);
		}
	...
	public FeatureMap getIndividualResourceCostType() {
		if (individualResourceCostType == null) {
			individualResourceCostType = new BasicFeatureMap(this,
					Schema1Package.ROLE__INDIVIDUAL_RESOURCE_COST_TYPE);
		}
	...
	public EList<Availability> getAvailability() {
		if (availability == null) {
			availability = new EObjectContainmentEList<Availability>(
					Availability.class, this, Schema1Package.ROLE__AVAILABILITY);
		}
		return availability;
	}
	...
	public NotificationChain basicSetExtendedAttributes(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.ROLE__EXTENDED_ATTRIBUTES,
			...
			if (extendedAttributes != null)
				msgs = ((InternalEObject) extendedAttributes).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.ROLE__EXTENDED_ATTRIBUTES,
						null, msgs);
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ROLE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.ROLE__SCOPE_DIMENSION:
			return ((InternalEList<?>) getScopeDimension()).basicRemove(
					otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.ROLE__SCOPE_DIMENSION:
			...
			getScopeDimension().addAll(
					(Collection<? extends ScopeDimensionType>) newValue);
			return;
		case Schema1Package.ROLE__INDIVIDUAL_RESOURCE_COST_TYPE:
