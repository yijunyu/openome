 ...
 * @generated
 */
public class CostPerTimeUnitValueImpl extends CostValueImpl implements
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.COST_PER_TIME_UNIT_VALUE;
	}
	...
	public void setTimeUnit(TimeUnit newTimeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_PER_TIME_UNIT_VALUE__TIME_UNIT,
