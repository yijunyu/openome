...
public class CatalogsTypeImpl extends EObjectImpl implements CatalogsType {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDataCatalogs(Catalogs newDataCatalogs,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CATALOGS_TYPE__DATA_CATALOGS,
					oldDataCatalogs, newDataCatalogs);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDataCatalogs(Catalogs newDataCatalogs) {
		if (newDataCatalogs != dataCatalogs) {
			...
			if (dataCatalogs != null)
				msgs = ((InternalEObject) dataCatalogs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.CATALOGS_TYPE__DATA_CATALOGS,
						null, msgs);
			if (newDataCatalogs != null)
				msgs = ((InternalEObject) newDataCatalogs).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.CATALOGS_TYPE__DATA_CATALOGS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CATALOGS_TYPE__DATA_CATALOGS,
					newDataCatalogs, newDataCatalogs));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetResourceCatalogs(
			Catalogs newResourceCatalogs, NotificationChain msgs) {
		Catalogs oldResourceCatalogs = resourceCatalogs;
		resourceCatalogs = newResourceCatalogs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CATALOGS_TYPE__RESOURCE_CATALOGS,
					oldResourceCatalogs, newResourceCatalogs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setResourceCatalogs(Catalogs newResourceCatalogs) {
		if (newResourceCatalogs != resourceCatalogs) {
			...
			if (resourceCatalogs != null)
				msgs = ((InternalEObject) resourceCatalogs)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CATALOGS_TYPE__RESOURCE_CATALOGS,
			...
			if (newResourceCatalogs != null)
				msgs = ((InternalEObject) newResourceCatalogs)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CATALOGS_TYPE__RESOURCE_CATALOGS,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CATALOGS_TYPE__RESOURCE_CATALOGS,
					newResourceCatalogs, newResourceCatalogs));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrganizationCatalogs(
			Catalogs newOrganizationCatalogs, NotificationChain msgs) {
		Catalogs oldOrganizationCatalogs = organizationCatalogs;
		organizationCatalogs = newOrganizationCatalogs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CATALOGS_TYPE__ORGANIZATION_CATALOGS,
					oldOrganizationCatalogs, newOrganizationCatalogs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOrganizationCatalogs(Catalogs newOrganizationCatalogs) {
		if (newOrganizationCatalogs != organizationCatalogs) {
			...
			if (organizationCatalogs != null)
				msgs = ((InternalEObject) organizationCatalogs)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CATALOGS_TYPE__ORGANIZATION_CATALOGS,
			...
			if (newOrganizationCatalogs != null)
				msgs = ((InternalEObject) newOrganizationCatalogs)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CATALOGS_TYPE__ORGANIZATION_CATALOGS,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CATALOGS_TYPE__ORGANIZATION_CATALOGS,
					newOrganizationCatalogs, newOrganizationCatalogs));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProcessCatalogs(
			Catalogs newProcessCatalogs, NotificationChain msgs) {
		Catalogs oldProcessCatalogs = processCatalogs;
		processCatalogs = newProcessCatalogs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CATALOGS_TYPE__PROCESS_CATALOGS,
					oldProcessCatalogs, newProcessCatalogs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setProcessCatalogs(Catalogs newProcessCatalogs) {
		if (newProcessCatalogs != processCatalogs) {
			...
			if (processCatalogs != null)
				msgs = ((InternalEObject) processCatalogs)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CATALOGS_TYPE__PROCESS_CATALOGS,
			...
			if (newProcessCatalogs != null)
				msgs = ((InternalEObject) newProcessCatalogs)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CATALOGS_TYPE__PROCESS_CATALOGS,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CATALOGS_TYPE__PROCESS_CATALOGS,
					newProcessCatalogs, newProcessCatalogs));
	}
