 ...
 * @generated
 */
public class ExtendedAttributeTypeImpl extends EObjectImpl implements
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this,
					Schema1Package.EXTENDED_ATTRIBUTE_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap) getMixed().<FeatureMap.Entry> list(
				Schema1Package.Literals.EXTENDED_ATTRIBUTE_TYPE__GROUP);
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap) getGroup().<FeatureMap.Entry> list(
				Schema1Package.Literals.EXTENDED_ATTRIBUTE_TYPE__ANY);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.EXTENDED_ATTRIBUTE_TYPE__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.EXTENDED_ATTRIBUTE_TYPE__VALUE, oldValue,
					value));
	}
