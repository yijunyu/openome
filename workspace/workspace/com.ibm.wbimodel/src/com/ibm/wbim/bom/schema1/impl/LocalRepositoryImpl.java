...
public class LocalRepositoryImpl extends EObjectImpl implements LocalRepository {
	...
	protected static final Object TYPE_EDEFAULT = Schema1Factory.eINSTANCE
			.createFromString(Schema1Package.eINSTANCE.getTypeType(), "String");
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOCAL_REPOSITORY__DESCRIPTION,
	...
	public void setCapacity(BigInteger newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOCAL_REPOSITORY__CAPACITY, oldCapacity,
	...
	public void setIsOrdered(boolean newIsOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOCAL_REPOSITORY__IS_ORDERED, oldIsOrdered,
	...
	public void setIsUnique(boolean newIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOCAL_REPOSITORY__IS_UNIQUE, oldIsUnique,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOCAL_REPOSITORY__NAME, oldName, name));
	}
	...
	public void setType(Object newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOCAL_REPOSITORY__TYPE, oldType, type,
					!oldTypeESet));
	}
	...
	public void unsetType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.LOCAL_REPOSITORY__TYPE, oldType,
