 ...
 * @generated
 */
public class ExtendedAttributesImpl extends EObjectImpl implements
		ExtendedAttributes {
	/**
	...
	public EList<ExtendedAttributeType> getExtendedAttribute() {
		if (extendedAttribute == null) {
			extendedAttribute = new EObjectContainmentEList<ExtendedAttributeType>(
					ExtendedAttributeType.class, this,
					Schema1Package.EXTENDED_ATTRIBUTES__EXTENDED_ATTRIBUTE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.EXTENDED_ATTRIBUTES__EXTENDED_ATTRIBUTE:
			return ((InternalEList<?>) getExtendedAttribute()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.EXTENDED_ATTRIBUTES__EXTENDED_ATTRIBUTE:
			...
			getExtendedAttribute().addAll(
					(Collection<? extends ExtendedAttributeType>) newValue);
			return;
		}
