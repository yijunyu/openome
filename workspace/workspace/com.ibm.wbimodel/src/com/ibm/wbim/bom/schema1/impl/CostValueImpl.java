...
public class CostValueImpl extends EObjectImpl implements CostValue {
	...
	public void setLiteralValue(double newLiteralValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_VALUE__LITERAL_VALUE, oldLiteralValue,
					literalValue, !oldLiteralValueESet));
	}
	...
	public void unsetLiteralValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.COST_VALUE__LITERAL_VALUE, oldLiteralValue,
					LITERAL_VALUE_EDEFAULT, oldLiteralValueESet));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDistribution(
			DistributionType newDistribution, NotificationChain msgs) {
		DistributionType oldDistribution = distribution;
		distribution = newDistribution;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.COST_VALUE__DISTRIBUTION,
	...
	public void setDistribution(DistributionType newDistribution) {
		if (newDistribution != distribution) {
			...
			if (distribution != null)
				msgs = ((InternalEObject) distribution).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.COST_VALUE__DISTRIBUTION,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_VALUE__DISTRIBUTION, newDistribution,
					newDistribution));
	}
	...
	public void setCurrency(Currency newCurrency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_VALUE__CURRENCY, oldCurrency, currency,
					!oldCurrencyESet));
	}
	...
	public void unsetCurrency() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.COST_VALUE__CURRENCY, oldCurrency,
