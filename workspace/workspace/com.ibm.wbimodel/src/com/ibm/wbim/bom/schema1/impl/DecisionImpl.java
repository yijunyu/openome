...
public class DecisionImpl extends EObjectImpl implements Decision {
	 ...
	 * @ordered
	 */
	protected EList<OutputBranchType> outputBranch;
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DECISION__DESCRIPTION, oldDescription,
					description));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInputBranch(InputBranch newInputBranch,
			NotificationChain msgs) {
		InputBranch oldInputBranch = inputBranch;
		inputBranch = newInputBranch;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.DECISION__INPUT_BRANCH,
					oldInputBranch, newInputBranch);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInputBranch(InputBranch newInputBranch) {
		if (newInputBranch != inputBranch) {
			...
			if (inputBranch != null)
				msgs = ((InternalEObject) inputBranch).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.DECISION__INPUT_BRANCH, null,
						msgs);
			if (newInputBranch != null)
				msgs = ((InternalEObject) newInputBranch).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.DECISION__INPUT_BRANCH, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DECISION__INPUT_BRANCH, newInputBranch,
					newInputBranch));
	}
	 ...
	 * @generated
	 */
	public EList<OutputBranchType> getOutputBranch() {
		if (outputBranch == null) {
			outputBranch = new EObjectContainmentEList<OutputBranchType>(
					OutputBranchType.class, this,
					Schema1Package.DECISION__OUTPUT_BRANCH);
		}
		return outputBranch;
	}
	...
	public void setIsInclusive(boolean newIsInclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DECISION__IS_INCLUSIVE, oldIsInclusive,
					isInclusive, !oldIsInclusiveESet));
	}
	...
	public void unsetIsInclusive() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.DECISION__IS_INCLUSIVE, oldIsInclusive,
					IS_INCLUSIVE_EDEFAULT, oldIsInclusiveESet));
	}
	...
	public void setIsSimpleDecision(boolean newIsSimpleDecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DECISION__IS_SIMPLE_DECISION,
					oldIsSimpleDecision, isSimpleDecision,
					!oldIsSimpleDecisionESet));
	}
	...
	public void unsetIsSimpleDecision() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.DECISION__IS_SIMPLE_DECISION,
					oldIsSimpleDecision, IS_SIMPLE_DECISION_EDEFAULT,
					oldIsSimpleDecisionESet));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DECISION__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.DECISION__OUTPUT_BRANCH:
			return ((InternalEList<?>) getOutputBranch()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.DECISION__OUTPUT_BRANCH:
			...
			getOutputBranch().addAll(
					(Collection<? extends OutputBranchType>) newValue);
			return;
		case Schema1Package.DECISION__IS_INCLUSIVE:
