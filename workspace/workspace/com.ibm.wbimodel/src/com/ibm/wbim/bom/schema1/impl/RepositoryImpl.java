...
public class RepositoryImpl extends EObjectImpl implements Repository {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__DESCRIPTION, oldDescription,
					description));
	}
	...
	public NotificationChain basicSetDefaultValues(
			RepositoryDataValue newDefaultValues, NotificationChain msgs) {
		RepositoryDataValue oldDefaultValues = defaultValues;
		defaultValues = newDefaultValues;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.REPOSITORY__DEFAULT_VALUES,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetComputedValues(
			RepositoryDataValue newComputedValues, NotificationChain msgs) {
		RepositoryDataValue oldComputedValues = computedValues;
		computedValues = newComputedValues;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.REPOSITORY__COMPUTED_VALUES,
					oldComputedValues, newComputedValues);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setComputedValues(RepositoryDataValue newComputedValues) {
		if (newComputedValues != computedValues) {
			...
			if (computedValues != null)
				msgs = ((InternalEObject) computedValues).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.REPOSITORY__COMPUTED_VALUES,
						null, msgs);
			if (newComputedValues != null)
				msgs = ((InternalEObject) newComputedValues).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.REPOSITORY__COMPUTED_VALUES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__COMPUTED_VALUES,
					newComputedValues, newComputedValues));
	}
	...
	public void setCapacity(BigInteger newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__CAPACITY, oldCapacity, capacity,
					!oldCapacityESet));
	}
	...
	public void unsetCapacity() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.REPOSITORY__CAPACITY, oldCapacity,
	...
	public void setIsOrdered(boolean newIsOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__IS_ORDERED, oldIsOrdered,
	...
	public void setIsReadOnly(boolean newIsReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__IS_READ_ONLY, oldIsReadOnly,
	...
	public void setIsUnique(boolean newIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__IS_UNIQUE, oldIsUnique,
					isUnique, !oldIsUniqueESet));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.REPOSITORY__TYPE, oldType, type,
					!oldTypeESet));
	}
	...
	public void unsetType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.REPOSITORY__TYPE, oldType, TYPE_EDEFAULT,
					oldTypeESet));
	}
