 ...
 * @generated
 */
public class CallToTaskTypeImpl extends InvocationImpl implements
		CallToTaskType {
	/**
	...
	public void setTask(String newTask) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CALL_TO_TASK_TYPE__TASK, oldTask, task));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.CALL_TO_TASK_TYPE__TASK:
			return TASK_EDEFAULT == null ? task != null : !TASK_EDEFAULT
					.equals(task);
		}
