...
public class ForkImpl extends EObjectImpl implements Fork {
	 ...
	 * @ordered
	 */
	protected EList<OutputBranch> outputBranch;
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.FORK__DESCRIPTION, oldDescription,
					description));
	}
	...
	public NotificationChain basicSetInputBranch(InputBranch newInputBranch,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.FORK__INPUT_BRANCH,
	...
	public void setInputBranch(InputBranch newInputBranch) {
		if (newInputBranch != inputBranch) {
			...
			if (inputBranch != null)
				msgs = ((InternalEObject) inputBranch)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.FORK__INPUT_BRANCH, null, msgs);
			if (newInputBranch != null)
				msgs = ((InternalEObject) newInputBranch)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.FORK__INPUT_BRANCH, newInputBranch,
					newInputBranch));
	}
	 ...
	 * @generated
	 */
	public EList<OutputBranch> getOutputBranch() {
		if (outputBranch == null) {
			outputBranch = new EObjectContainmentEList<OutputBranch>(
					OutputBranch.class, this,
					Schema1Package.FORK__OUTPUT_BRANCH);
		}
		return outputBranch;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.FORK__NAME, oldName, name));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.FORK__OUTPUT_BRANCH:
			...
			getOutputBranch().addAll(
					(Collection<? extends OutputBranch>) newValue);
			return;
		case Schema1Package.FORK__NAME:
