...
public class OperationalDataImpl extends EObjectImpl implements OperationalData {
	...
	public NotificationChain basicSetTimeEstimation(
			TimeEstimationType newTimeEstimation, NotificationChain msgs) {
		TimeEstimationType oldTimeEstimation = timeEstimation;
		timeEstimation = newTimeEstimation;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.OPERATIONAL_DATA__TIME_ESTIMATION,
	...
	public void setTimeEstimation(TimeEstimationType newTimeEstimation) {
		if (newTimeEstimation != timeEstimation) {
			...
			if (timeEstimation != null)
				msgs = ((InternalEObject) timeEstimation)
						.eInverseRemove(
								this,
			...
			if (newTimeEstimation != null)
				msgs = ((InternalEObject) newTimeEstimation)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OPERATIONAL_DATA__TIME_ESTIMATION,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCost(CostType newCost,
			NotificationChain msgs) {
		CostType oldCost = cost;
		cost = newCost;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.OPERATIONAL_DATA__COST,
					oldCost, newCost);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCost != cost) {
			...
			if (cost != null)
				msgs = ((InternalEObject) cost).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.OPERATIONAL_DATA__COST, null,
						msgs);
			if (newCost != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OPERATIONAL_DATA__COST, newCost, newCost));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRevenue(CostValue newRevenue,
			NotificationChain msgs) {
		CostValue oldRevenue = revenue;
		revenue = newRevenue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.OPERATIONAL_DATA__REVENUE,
		...
		if (newRevenue != revenue) {
			...
			if (revenue != null)
				msgs = ((InternalEObject) revenue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.OPERATIONAL_DATA__REVENUE,
						null, msgs);
			if (newRevenue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OPERATIONAL_DATA__REVENUE, newRevenue,
					newRevenue));
	}
