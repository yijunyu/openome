...
public class InputCriterionImpl extends EObjectImpl implements InputCriterion {
	...
	public EList<InputType> getInput() {
		if (input == null) {
			input = new EObjectContainmentEList<InputType>(InputType.class,
					this, Schema1Package.INPUT_CRITERION__INPUT);
		}
		return input;
	}
	...
	public EList<Expression> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<Expression>(
					Expression.class, this,
					Schema1Package.INPUT_CRITERION__CONSTRAINT);
		}
		return constraint;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCorrelation(
			CorrelationType newCorrelation, NotificationChain msgs) {
		CorrelationType oldCorrelation = correlation;
		correlation = newCorrelation;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.INPUT_CRITERION__CORRELATION,
					oldCorrelation, newCorrelation);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT_CRITERION__NAME, oldName, name));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.INPUT_CRITERION__CONSTRAINT:
			getConstraint().clear();
			getConstraint().addAll((Collection<? extends Expression>) newValue);
			return;
		case Schema1Package.INPUT_CRITERION__CORRELATION:
