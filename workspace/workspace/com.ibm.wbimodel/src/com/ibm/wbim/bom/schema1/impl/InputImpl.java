...
public class InputImpl extends EObjectImpl implements Input {
	...
	public NotificationChain basicSetConstantValue(
			InputConstantValue newConstantValue, NotificationChain msgs) {
		InputConstantValue oldConstantValue = constantValue;
		constantValue = newConstantValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.INPUT__CONSTANT_VALUE,
	...
	public void setConstantValue(InputConstantValue newConstantValue) {
		if (newConstantValue != constantValue) {
			...
			if (constantValue != null)
				msgs = ((InternalEObject) constantValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.INPUT__CONSTANT_VALUE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__CONSTANT_VALUE, newConstantValue,
					newConstantValue));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRepositoryValue(
			InputRepositoryValue newRepositoryValue, NotificationChain msgs) {
		InputRepositoryValue oldRepositoryValue = repositoryValue;
		repositoryValue = newRepositoryValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.INPUT__REPOSITORY_VALUE,
					oldRepositoryValue, newRepositoryValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setRepositoryValue(InputRepositoryValue newRepositoryValue) {
		if (newRepositoryValue != repositoryValue) {
			...
			if (repositoryValue != null)
				msgs = ((InternalEObject) repositoryValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.INPUT__REPOSITORY_VALUE, null,
						msgs);
			if (newRepositoryValue != null)
				msgs = ((InternalEObject) newRepositoryValue).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.INPUT__REPOSITORY_VALUE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__REPOSITORY_VALUE, newRepositoryValue,
					newRepositoryValue));
	}
	...
	public void setAssociatedData(Object newAssociatedData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__ASSOCIATED_DATA, oldAssociatedData,
					associatedData));
	}
	...
	public void setIsOrdered(boolean newIsOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__IS_ORDERED, oldIsOrdered, isOrdered,
					!oldIsOrderedESet));
	}
	...
	public void unsetIsOrdered() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.INPUT__IS_ORDERED, oldIsOrdered,
	...
	public void setIsUnique(boolean newIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__IS_UNIQUE, oldIsUnique, isUnique,
					!oldIsUniqueESet));
	}
	...
	public void unsetIsUnique() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.INPUT__IS_UNIQUE, oldIsUnique,
	...
	public void setMaximum(BigInteger newMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__MAXIMUM, oldMaximum, maximum,
					!oldMaximumESet));
	}
	...
	public void unsetMaximum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.INPUT__MAXIMUM, oldMaximum,
	...
	public void setMinimum(BigInteger newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__MINIMUM, oldMinimum, minimum,
					!oldMinimumESet));
	}
	...
	public void unsetMinimum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.INPUT__MINIMUM, oldMinimum,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT__NAME, oldName, name));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.INPUT__ASSOCIATED_DATA:
			return ASSOCIATED_DATA_EDEFAULT == null ? associatedData != null
					: !ASSOCIATED_DATA_EDEFAULT.equals(associatedData);
		case Schema1Package.INPUT__IS_ORDERED:
