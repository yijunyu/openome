...
public class ComplexDataTypeImpl extends EObjectImpl implements ComplexDataType {
	 ...
	 * @ordered
	 */
	protected EList<Expression> rule;
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.COMPLEX_DATA_TYPE;
	}
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COMPLEX_DATA_TYPE__DOCUMENTATION,
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class,
					this, Schema1Package.COMPLEX_DATA_TYPE__ATTRIBUTE);
		}
		return attribute;
	}
	 ...
	 * @generated
	 */
	public EList<Expression> getRule() {
		if (rule == null) {
			rule = new EObjectContainmentEList<Expression>(Expression.class,
					this, Schema1Package.COMPLEX_DATA_TYPE__RULE);
		}
		return rule;
	}
	...
	public NotificationChain basicSetExtendedAttributes(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.COMPLEX_DATA_TYPE__EXTENDED_ATTRIBUTES,
	 ...
	 * @generated
	 */
	public void setParentTemplate(Object newParentTemplate) {
		Object oldParentTemplate = parentTemplate;
		parentTemplate = newParentTemplate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COMPLEX_DATA_TYPE__PARENT_TEMPLATE,
					oldParentTemplate, parentTemplate));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.COMPLEX_DATA_TYPE__RULE:
			getRule().clear();
			getRule().addAll((Collection<? extends Expression>) newValue);
			return;
		case Schema1Package.COMPLEX_DATA_TYPE__EXTENDED_ATTRIBUTES:
			setExtendedAttributes((ExtendedAttributes) newValue);
			return;
		case Schema1Package.COMPLEX_DATA_TYPE__PARENT_TEMPLATE:
			setParentTemplate(newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.COMPLEX_DATA_TYPE__PARENT_TEMPLATE:
			return PARENT_TEMPLATE_EDEFAULT == null ? parentTemplate != null
					: !PARENT_TEMPLATE_EDEFAULT.equals(parentTemplate);
		}
