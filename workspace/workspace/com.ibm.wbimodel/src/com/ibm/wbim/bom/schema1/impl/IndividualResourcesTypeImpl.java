 ...
 * @generated
 */
public class IndividualResourcesTypeImpl extends EObjectImpl implements
	 ...
	 * @ordered
	 */
	protected EList<IndividualResource> individualResource;
	 ...
	 * @generated
	 */
	public EList<IndividualResource> getIndividualResource() {
		if (individualResource == null) {
			individualResource = new EObjectContainmentEList<IndividualResource>(
					IndividualResource.class,
					this,
					Schema1Package.INDIVIDUAL_RESOURCES_TYPE__INDIVIDUAL_RESOURCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.INDIVIDUAL_RESOURCES_TYPE__INDIVIDUAL_RESOURCE:
			return ((InternalEList<?>) getIndividualResource()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.INDIVIDUAL_RESOURCES_TYPE__INDIVIDUAL_RESOURCE:
			...
			getIndividualResource().addAll(
					(Collection<? extends IndividualResource>) newValue);
			return;
		}
