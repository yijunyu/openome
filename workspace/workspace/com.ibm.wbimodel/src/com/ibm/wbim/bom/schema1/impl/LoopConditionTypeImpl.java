 ...
 * @generated
 */
public class LoopConditionTypeImpl extends ExpressionImpl implements
		LoopConditionType {
	/**
	 ...
	 * @ordered
	 */
	protected static final BigInteger COUNTER_INCREMENT_EDEFAULT = new BigInteger(
			"1");
	 ...
	 * @ordered
	 */
	protected static final BigInteger FINAL_COUNTER_EDEFAULT = new BigInteger(
			"1");
	 ...
	 * @ordered
	 */
	protected static final BigInteger INITIAL_COUNTER_EDEFAULT = new BigInteger(
			"1");
	...
	public void setCounterIncrement(BigInteger newCounterIncrement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOOP_CONDITION_TYPE__COUNTER_INCREMENT,
					oldCounterIncrement, counterIncrement,
					!oldCounterIncrementESet));
	}
	...
	public void unsetCounterIncrement() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.LOOP_CONDITION_TYPE__COUNTER_INCREMENT,
					oldCounterIncrement, COUNTER_INCREMENT_EDEFAULT,
					oldCounterIncrementESet));
	}
	...
	public void setFinalCounter(BigInteger newFinalCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOOP_CONDITION_TYPE__FINAL_COUNTER,
					oldFinalCounter, finalCounter, !oldFinalCounterESet));
	}
	...
	public void unsetFinalCounter() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.LOOP_CONDITION_TYPE__FINAL_COUNTER,
					oldFinalCounter, FINAL_COUNTER_EDEFAULT,
					oldFinalCounterESet));
	}
	...
	public void setInitialCounter(BigInteger newInitialCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.LOOP_CONDITION_TYPE__INITIAL_COUNTER,
					oldInitialCounter, initialCounter, !oldInitialCounterESet));
	}
	...
	public void unsetInitialCounter() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.LOOP_CONDITION_TYPE__INITIAL_COUNTER,
					oldInitialCounter, INITIAL_COUNTER_EDEFAULT,
					oldInitialCounterESet));
	}
