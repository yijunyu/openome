 ...
 * @generated
 */
public class ProcessImpl extends EObjectImpl implements
		com.ibm.wbim.bom.schema1.Process {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Expression> precondition;
	 ...
	 * @ordered
	 */
	protected EList<Expression> postcondition;
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS__DESCRIPTION, oldDescription,
					description));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInputs(Inputs newInputs,
			NotificationChain msgs) {
		Inputs oldInputs = inputs;
		inputs = newInputs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS__INPUTS,
					oldInputs, newInputs);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInputs(Inputs newInputs) {
		if (newInputs != inputs) {
			...
			if (inputs != null)
				msgs = ((InternalEObject) inputs)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__INPUTS, null, msgs);
			if (newInputs != null)
				msgs = ((InternalEObject) newInputs)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS__INPUTS, newInputs, newInputs));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOutputs(Outputs newOutputs,
			NotificationChain msgs) {
		Outputs oldOutputs = outputs;
		outputs = newOutputs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS__OUTPUTS,
	...
	public void setOutputs(Outputs newOutputs) {
		if (newOutputs != outputs) {
			...
			if (outputs != null)
				msgs = ((InternalEObject) outputs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__OUTPUTS, null, msgs);
			if (newOutputs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS__OUTPUTS, newOutputs, newOutputs));
	}
	 ...
	 * @generated
	 */
	public EList<Expression> getPrecondition() {
		if (precondition == null) {
			precondition = new EObjectContainmentEList<Expression>(
					Expression.class, this,
					Schema1Package.PROCESS__PRECONDITION);
		}
		return precondition;
	}
	 ...
	 * @generated
	 */
	public EList<Expression> getPostcondition() {
		if (postcondition == null) {
			postcondition = new EObjectContainmentEList<Expression>(
					Expression.class, this,
					Schema1Package.PROCESS__POSTCONDITION);
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrganizations(
			Organizations newOrganizations, NotificationChain msgs) {
		Organizations oldOrganizations = organizations;
		organizations = newOrganizations;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS__ORGANIZATIONS,
					oldOrganizations, newOrganizations);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOrganizations(Organizations newOrganizations) {
		if (newOrganizations != organizations) {
			...
			if (organizations != null)
				msgs = ((InternalEObject) organizations).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__ORGANIZATIONS, null,
						msgs);
			if (newOrganizations != null)
				msgs = ((InternalEObject) newOrganizations).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__ORGANIZATIONS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS__ORGANIZATIONS, newOrganizations,
					newOrganizations));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOperationalData(
			OperationalData newOperationalData, NotificationChain msgs) {
		OperationalData oldOperationalData = operationalData;
		operationalData = newOperationalData;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS__OPERATIONAL_DATA,
					oldOperationalData, newOperationalData);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOperationalData(OperationalData newOperationalData) {
		if (newOperationalData != operationalData) {
			...
			if (operationalData != null)
				msgs = ((InternalEObject) operationalData).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__OPERATIONAL_DATA,
						null, msgs);
			if (newOperationalData != null)
				msgs = ((InternalEObject) newOperationalData).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__OPERATIONAL_DATA,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS__OPERATIONAL_DATA,
					newOperationalData, newOperationalData));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetFlowContent(
			FlowContentType newFlowContent, NotificationChain msgs) {
		FlowContentType oldFlowContent = flowContent;
		flowContent = newFlowContent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS__FLOW_CONTENT,
					oldFlowContent, newFlowContent);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setFlowContent(FlowContentType newFlowContent) {
		if (newFlowContent != flowContent) {
			NotificationChain msgs = null;
			if (flowContent != null)
				msgs = ((InternalEObject) flowContent).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__FLOW_CONTENT, null,
						msgs);
			if (newFlowContent != null)
				msgs = ((InternalEObject) newFlowContent).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__FLOW_CONTENT, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS__FLOW_CONTENT, newFlowContent,
					newFlowContent));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetExtendedAttributes(
			ExtendedAttributes newExtendedAttributes, NotificationChain msgs) {
		ExtendedAttributes oldExtendedAttributes = extendedAttributes;
		extendedAttributes = newExtendedAttributes;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.PROCESS__EXTENDED_ATTRIBUTES,
	...
	public void setExtendedAttributes(ExtendedAttributes newExtendedAttributes) {
		if (newExtendedAttributes != extendedAttributes) {
			...
			if (extendedAttributes != null)
				msgs = ((InternalEObject) extendedAttributes).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__EXTENDED_ATTRIBUTES,
						null, msgs);
			if (newExtendedAttributes != null)
				msgs = ((InternalEObject) newExtendedAttributes).eInverseAdd(
						this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS__EXTENDED_ATTRIBUTES,
						null, msgs);
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.PROCESS__PRECONDITION:
			return ((InternalEList<?>) getPrecondition()).basicRemove(otherEnd,
					msgs);
		case Schema1Package.PROCESS__POSTCONDITION:
			return ((InternalEList<?>) getPostcondition()).basicRemove(
					otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.PROCESS__PRECONDITION:
			...
			getPrecondition().addAll(
					(Collection<? extends Expression>) newValue);
			return;
		case Schema1Package.PROCESS__POSTCONDITION:
			getPostcondition().clear();
			getPostcondition().addAll(
					(Collection<? extends Expression>) newValue);
			return;
		case Schema1Package.PROCESS__ORGANIZATIONS:
