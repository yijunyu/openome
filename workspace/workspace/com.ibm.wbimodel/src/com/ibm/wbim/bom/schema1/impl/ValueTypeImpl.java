...
public class ValueTypeImpl extends EObjectImpl implements ValueType {
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.VALUE_TYPE__VALUE, oldValue, value,
					!oldValueESet));
	}
	...
	public void unsetValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.VALUE_TYPE__VALUE, oldValue, VALUE_EDEFAULT,
					oldValueESet));
	}
	...
	public void setProbability(double newProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.VALUE_TYPE__PROBABILITY, oldProbability,
					probability, !oldProbabilityESet));
	}
	...
	public void unsetProbability() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.VALUE_TYPE__PROBABILITY, oldProbability,
					PROBABILITY_EDEFAULT, oldProbabilityESet));
	}
