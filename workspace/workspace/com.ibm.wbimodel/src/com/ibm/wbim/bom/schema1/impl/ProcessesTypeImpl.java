 ...
 * <ul>
 *   <li>{@link com.ibm.wbim.bom.schema1.impl.ProcessesTypeImpl#getProcess <em>Process</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessesTypeImpl extends EObjectImpl implements ProcessesType {
	 ...
	 * @ordered
	 */
	protected EList<com.ibm.wbim.bom.schema1.Process> process;
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.PROCESSES_TYPE;
	}
	...
	public EList<com.ibm.wbim.bom.schema1.Process> getProcess() {
		if (process == null) {
			process = new EObjectContainmentEList<com.ibm.wbim.bom.schema1.Process>(
					com.ibm.wbim.bom.schema1.Process.class, this,
					Schema1Package.PROCESSES_TYPE__PROCESS);
		}
		return process;
	}
