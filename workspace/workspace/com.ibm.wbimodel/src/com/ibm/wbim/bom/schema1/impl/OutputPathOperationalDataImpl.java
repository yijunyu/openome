 ...
 * @generated
 */
public class OutputPathOperationalDataImpl extends EObjectImpl implements
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProbability(
			OutputPathProbabilityValue newProbability, NotificationChain msgs) {
		OutputPathProbabilityValue oldProbability = probability;
		probability = newProbability;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.OUTPUT_PATH_OPERATIONAL_DATA__PROBABILITY,
	...
	public void setProbability(OutputPathProbabilityValue newProbability) {
		if (newProbability != probability) {
			...
			if (probability != null)
				msgs = ((InternalEObject) probability)
						.eInverseRemove(
								this,
			...
			if (newProbability != null)
				msgs = ((InternalEObject) newProbability)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OUTPUT_PATH_OPERATIONAL_DATA__PROBABILITY,
