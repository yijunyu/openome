 ...
 * @generated
 */
public class CriteriaTemplateImpl extends EObjectImpl implements
		CriteriaTemplate {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetManagerOfEmployee(
			ManagerOfEmployeeType newManagerOfEmployee, NotificationChain msgs) {
		ManagerOfEmployeeType oldManagerOfEmployee = managerOfEmployee;
		managerOfEmployee = newManagerOfEmployee;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE,
					oldManagerOfEmployee, newManagerOfEmployee);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setManagerOfEmployee(ManagerOfEmployeeType newManagerOfEmployee) {
		if (newManagerOfEmployee != managerOfEmployee) {
			...
			if (managerOfEmployee != null)
				msgs = ((InternalEObject) managerOfEmployee)
						.eInverseRemove(
								this,
			...
			if (newManagerOfEmployee != null)
				msgs = ((InternalEObject) newManagerOfEmployee)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE,
					newManagerOfEmployee, newManagerOfEmployee));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetManagerOfEmployeeByID(
			ManagerOfEmployeeByIDType newManagerOfEmployeeByID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE_BY_ID,
					oldManagerOfEmployeeByID, newManagerOfEmployeeByID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setManagerOfEmployeeByID(
			ManagerOfEmployeeByIDType newManagerOfEmployeeByID) {
		if (newManagerOfEmployeeByID != managerOfEmployeeByID) {
			NotificationChain msgs = null;
			if (managerOfEmployeeByID != null)
				msgs = ((InternalEObject) managerOfEmployeeByID)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE_BY_ID,
			...
			if (newManagerOfEmployeeByID != null)
				msgs = ((InternalEObject) newManagerOfEmployeeByID)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE_BY_ID,
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE_BY_ID,
					newManagerOfEmployeeByID, newManagerOfEmployeeByID));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPersonSearch(
			PersonSearchType newPersonSearch, NotificationChain msgs) {
		PersonSearchType oldPersonSearch = personSearch;
		personSearch = newPersonSearch;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__PERSON_SEARCH,
					oldPersonSearch, newPersonSearch);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPersonSearch(PersonSearchType newPersonSearch) {
		if (newPersonSearch != personSearch) {
			...
			if (personSearch != null)
				msgs = ((InternalEObject) personSearch)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__PERSON_SEARCH,
			...
			if (newPersonSearch != null)
				msgs = ((InternalEObject) newPersonSearch)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__PERSON_SEARCH,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__PERSON_SEARCH,
					newPersonSearch, newPersonSearch));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPersonName(PersonNameType newPersonName,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__PERSON_NAME,
	...
	public void setPersonName(PersonNameType newPersonName) {
		if (newPersonName != personName) {
			NotificationChain msgs = null;
			if (personName != null)
				msgs = ((InternalEObject) personName)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__PERSON_NAME,
			...
			if (newPersonName != null)
				msgs = ((InternalEObject) newPersonName)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__PERSON_NAME,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGroupMembers(
			GroupMembersType newGroupMembers, NotificationChain msgs) {
		GroupMembersType oldGroupMembers = groupMembers;
		groupMembers = newGroupMembers;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__GROUP_MEMBERS,
					oldGroupMembers, newGroupMembers);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setGroupMembers(GroupMembersType newGroupMembers) {
		if (newGroupMembers != groupMembers) {
			...
			if (groupMembers != null)
				msgs = ((InternalEObject) groupMembers)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__GROUP_MEMBERS,
			...
			if (newGroupMembers != null)
				msgs = ((InternalEObject) newGroupMembers)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__GROUP_MEMBERS,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetGroupSearch(
			GroupSearchType newGroupSearch, NotificationChain msgs) {
		GroupSearchType oldGroupSearch = groupSearch;
		groupSearch = newGroupSearch;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__GROUP_SEARCH,
					oldGroupSearch, newGroupSearch);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setGroupSearch(GroupSearchType newGroupSearch) {
		if (newGroupSearch != groupSearch) {
			NotificationChain msgs = null;
			if (groupSearch != null)
				msgs = ((InternalEObject) groupSearch)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__GROUP_SEARCH,
			...
			if (newGroupSearch != null)
				msgs = ((InternalEObject) newGroupSearch)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__GROUP_SEARCH,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOrganizationManager(
			OrganizationManagerType newOrganizationManager,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__ORGANIZATION_MANAGER,
					oldOrganizationManager, newOrganizationManager);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOrganizationManager(
		...
		if (newOrganizationManager != organizationManager) {
			...
			if (organizationManager != null)
				msgs = ((InternalEObject) organizationManager)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__ORGANIZATION_MANAGER,
			...
			if (newOrganizationManager != null)
				msgs = ((InternalEObject) newOrganizationManager)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.CRITERIA_TEMPLATE__ORGANIZATION_MANAGER,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CRITERIA_TEMPLATE__ORGANIZATION_MANAGER,
					newOrganizationManager, newOrganizationManager));
	}
