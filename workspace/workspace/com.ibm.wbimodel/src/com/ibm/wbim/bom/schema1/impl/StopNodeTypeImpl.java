...
public class StopNodeTypeImpl extends EObjectImpl implements StopNodeType {
	...
	public void setAssociatedOutputCriterion(String newAssociatedOutputCriterion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.STOP_NODE_TYPE__ASSOCIATED_OUTPUT_CRITERION,
					oldAssociatedOutputCriterion, associatedOutputCriterion));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.STOP_NODE_TYPE__NAME, oldName, name));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.STOP_NODE_TYPE__ASSOCIATED_OUTPUT_CRITERION:
			return ASSOCIATED_OUTPUT_CRITERION_EDEFAULT == null ? associatedOutputCriterion != null
					: !ASSOCIATED_OUTPUT_CRITERION_EDEFAULT
							.equals(associatedOutputCriterion);
		case Schema1Package.STOP_NODE_TYPE__NAME:
