 ...
 * @generated
 */
public class CriteriaTemplateItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE);
			childrenFeatures
					.add(Schema1Package.Literals.CRITERIA_TEMPLATE__MANAGER_OF_EMPLOYEE_BY_ID);
			childrenFeatures
					.add(Schema1Package.Literals.CRITERIA_TEMPLATE__PERSON_SEARCH);
			childrenFeatures
					.add(Schema1Package.Literals.CRITERIA_TEMPLATE__PERSON_NAME);
			childrenFeatures
					.add(Schema1Package.Literals.CRITERIA_TEMPLATE__GROUP_MEMBERS);
			childrenFeatures
					.add(Schema1Package.Literals.CRITERIA_TEMPLATE__GROUP_SEARCH);
			childrenFeatures
					.add(Schema1Package.Literals.CRITERIA_TEMPLATE__ORGANIZATION_MANAGER);
		}
		...
		newChildDescriptors
				.add(createChildParameter(
						...
						Schema1Factory.eINSTANCE
								.createManagerOfEmployeeByIDType()));
