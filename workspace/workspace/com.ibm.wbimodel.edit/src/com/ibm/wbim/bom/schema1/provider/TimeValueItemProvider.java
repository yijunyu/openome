...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.TimeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeValueItemProvider extends ItemProviderAdapter implements
	...
	protected void addLiteralValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_TimeValue_literalValue_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_TimeValue_literalValue_feature",
						"_UI_TimeValue_type"),
				Schema1Package.Literals.TIME_VALUE__LITERAL_VALUE, true, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.TIME_VALUE__DISTRIBUTION);
		}
	...
	public String getText(Object object) {
		Duration labelValue = ((TimeValue) object).getLiteralValue();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_TimeValue_type")
