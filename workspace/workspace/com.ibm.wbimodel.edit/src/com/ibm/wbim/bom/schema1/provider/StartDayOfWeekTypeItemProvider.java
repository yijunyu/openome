 ...
 * @generated
 */
public class StartDayOfWeekTypeItemProvider extends ItemProviderAdapter
	...
	protected void addDayOfWeekPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_StartDayOfWeekType_dayOfWeek_feature",
						"_UI_StartDayOfWeekType_type"),
	...
	protected void addStartTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_StartDayOfWeekType_startTime_feature",
						"_UI_StartDayOfWeekType_type"),
	...
	protected void addWeekNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_StartDayOfWeekType_weekNumber_feature",
						"_UI_StartDayOfWeekType_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_StartDayOfWeekType_type")
