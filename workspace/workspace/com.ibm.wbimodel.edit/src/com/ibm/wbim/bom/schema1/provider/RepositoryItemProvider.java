...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider extends ItemProviderAdapter implements
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Repository_description_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Repository_description_feature",
						"_UI_Repository_type"),
				Schema1Package.Literals.REPOSITORY__DESCRIPTION, true, false,
	...
	protected void addCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Repository_capacity_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Repository_capacity_feature",
						"_UI_Repository_type"),
				Schema1Package.Literals.REPOSITORY__CAPACITY, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIsOrderedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Repository_isOrdered_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Repository_isOrdered_feature",
						"_UI_Repository_type"),
				Schema1Package.Literals.REPOSITORY__IS_ORDERED, true, false,
	...
	protected void addIsReadOnlyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Repository_isReadOnly_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Repository_isReadOnly_feature",
						"_UI_Repository_type"),
				Schema1Package.Literals.REPOSITORY__IS_READ_ONLY, true, false,
				false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addIsUniquePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Repository_isUnique_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Repository_isUnique_feature",
						"_UI_Repository_type"),
				Schema1Package.Literals.REPOSITORY__IS_UNIQUE, true, false,
				false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Schema1Package.Literals.REPOSITORY__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Repository_type_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Repository_type_feature", "_UI_Repository_type"),
				Schema1Package.Literals.REPOSITORY__TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.REPOSITORY__DEFAULT_VALUES);
			childrenFeatures
					.add(Schema1Package.Literals.REPOSITORY__COMPUTED_VALUES);
		}
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == Schema1Package.Literals.REPOSITORY__DEFAULT_VALUES
