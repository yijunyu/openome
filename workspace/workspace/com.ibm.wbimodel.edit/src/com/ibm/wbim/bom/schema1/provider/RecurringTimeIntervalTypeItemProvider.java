...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.RecurringTimeIntervalType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecurringTimeIntervalTypeItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public RecurringTimeIntervalTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_RecurringTimeIntervalType_startTime_feature",
								"_UI_RecurringTimeIntervalType_type"),
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RecurringTimeIntervalType_duration_feature",
						"_UI_RecurringTimeIntervalType_type"),
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RecurringTimeIntervalType_name_feature",
						"_UI_RecurringTimeIntervalType_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.RECURRING_TIME_INTERVAL_TYPE__START_DAY_OF_WEEK);
		}
	...
	/**
	 * This returns RecurringTimeIntervalType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/RecurringTimeIntervalType"));
	}
	...
	public String getText(Object object) {
		String label = ((RecurringTimeIntervalType) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_RecurringTimeIntervalType_type")
				: getString("_UI_RecurringTimeIntervalType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RecurringTimeIntervalType.class)) {
