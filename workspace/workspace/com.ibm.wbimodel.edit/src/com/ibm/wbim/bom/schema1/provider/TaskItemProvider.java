...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends ItemProviderAdapter implements
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Task_description_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Task_description_feature", "_UI_Task_type"),
				Schema1Package.Literals.TASK__DESCRIPTION, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Task_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Task_name_feature", "_UI_Task_type"),
				Schema1Package.Literals.TASK__NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.TASK__OPERATIONAL_DATA);
			childrenFeatures
					.add(Schema1Package.Literals.TASK__EXTENDED_ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				Schema1Package.Literals.TASK__INPUTS, Schema1Factory.eINSTANCE
						.createInputs()));

		newChildDescriptors.add(createChildParameter(
				Schema1Package.Literals.TASK__OUTPUTS, Schema1Factory.eINSTANCE
						.createOutputs()));
