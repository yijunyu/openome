...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends ItemProviderAdapter implements
	...
	protected void addAssociatedDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Input_associatedData_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Input_associatedData_feature", "_UI_Input_type"),
				Schema1Package.Literals.INPUT__ASSOCIATED_DATA, true, false,
	...
	protected void addIsOrderedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Input_isOrdered_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Input_isOrdered_feature", "_UI_Input_type"),
				Schema1Package.Literals.INPUT__IS_ORDERED, true, false, false,
	...
	protected void addIsUniquePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Input_isUnique_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Input_isUnique_feature", "_UI_Input_type"),
				Schema1Package.Literals.INPUT__IS_UNIQUE, true, false, false,
				ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addMaximumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Input_maximum_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Input_maximum_feature", "_UI_Input_type"),
				Schema1Package.Literals.INPUT__MAXIMUM, true, false, false,
	...
	protected void addMinimumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Input_minimum_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Input_minimum_feature", "_UI_Input_type"),
				Schema1Package.Literals.INPUT__MINIMUM, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Input_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Input_name_feature", "_UI_Input_type"),
				Schema1Package.Literals.INPUT__NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.INPUT__REPOSITORY_VALUE);
		}
