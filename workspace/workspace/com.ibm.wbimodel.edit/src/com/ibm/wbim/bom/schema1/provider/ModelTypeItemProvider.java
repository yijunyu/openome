 ...
 * @generated
 */
public class ModelTypeItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ModelType_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ModelType_name_feature", "_UI_ModelType_type"),
				Schema1Package.Literals.MODEL_TYPE__NAME, true, false, false,
	...
	protected void addSchemaVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ModelType_schemaVersion_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ModelType_schemaVersion_feature",
						"_UI_ModelType_type"),
				Schema1Package.Literals.MODEL_TYPE__SCHEMA_VERSION, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.MODEL_TYPE__DATA_MODEL);
			childrenFeatures
					.add(Schema1Package.Literals.MODEL_TYPE__RESOURCE_MODEL);
			childrenFeatures
					.add(Schema1Package.Literals.MODEL_TYPE__ORGANIZATION_MODEL);
			childrenFeatures
					.add(Schema1Package.Literals.MODEL_TYPE__PROCESS_MODEL);
		}
