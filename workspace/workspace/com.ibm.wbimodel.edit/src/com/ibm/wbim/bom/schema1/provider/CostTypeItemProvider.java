...
/**
 * This is the item provider adapter for a {@link com.ibm.wbim.bom.schema1.CostType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CostTypeItemProvider extends ItemProviderAdapter implements
	 ...
	 * @generated
	 */
	public CostTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.COST_TYPE__EXECUTION_COST);
			childrenFeatures
					.add(Schema1Package.Literals.COST_TYPE__STARTUP_COST);
			childrenFeatures
					.add(Schema1Package.Literals.COST_TYPE__RESOURCE_WAITING_COST);
		}
	...
	public String getText(Object object) {
		return getString("_UI_CostType_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CostType.class)) {
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == Schema1Package.Literals.COST_TYPE__EXECUTION_COST
