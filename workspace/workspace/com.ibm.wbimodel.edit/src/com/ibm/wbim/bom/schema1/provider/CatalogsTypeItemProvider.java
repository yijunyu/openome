 ...
 * @generated
 */
public class CatalogsTypeItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.CATALOGS_TYPE__DATA_CATALOGS);
			childrenFeatures
					.add(Schema1Package.Literals.CATALOGS_TYPE__RESOURCE_CATALOGS);
			childrenFeatures
					.add(Schema1Package.Literals.CATALOGS_TYPE__ORGANIZATION_CATALOGS);
			childrenFeatures
					.add(Schema1Package.Literals.CATALOGS_TYPE__PROCESS_CATALOGS);
		}
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == Schema1Package.Literals.CATALOGS_TYPE__DATA_CATALOGS
