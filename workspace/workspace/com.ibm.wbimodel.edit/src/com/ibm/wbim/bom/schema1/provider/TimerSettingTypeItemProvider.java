 ...
 * @generated
 */
public class TimerSettingTypeItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.TIMER_SETTING_TYPE__BASED_ON_TIMETABLE);
			childrenFeatures
					.add(Schema1Package.Literals.TIMER_SETTING_TYPE__CONSTANT_TIME);
			childrenFeatures
					.add(Schema1Package.Literals.TIMER_SETTING_TYPE__LAST_ACTIVATION_TIME_PLUS);
			childrenFeatures
					.add(Schema1Package.Literals.TIMER_SETTING_TYPE__TIMER_EXPRESSION);
		}
		...
		newChildDescriptors
				.add(createChildParameter(
						...
						Schema1Factory.eINSTANCE
								.createLastActivationTimePlusType()));
