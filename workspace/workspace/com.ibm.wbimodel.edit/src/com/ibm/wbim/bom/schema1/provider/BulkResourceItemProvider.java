 ...
 * @generated
 */
public class BulkResourceItemProvider extends
		ComplexDataTypeInstanceItemProvider implements
	...
	protected void addIsConsumablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_BulkResource_isConsumable_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_BulkResource_isConsumable_feature",
						"_UI_BulkResource_type"),
				Schema1Package.Literals.BULK_RESOURCE__IS_CONSUMABLE, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.BULK_RESOURCE__BULK_RESOURCE_COST_TYPE);
			childrenFeatures
					.add(Schema1Package.Literals.BULK_RESOURCE__AVAILABLE_QUANTITY);
			childrenFeatures
					.add(Schema1Package.Literals.BULK_RESOURCE__AVAILABILITY);
			childrenFeatures
					.add(Schema1Package.Literals.BULK_RESOURCE__QUALIFICATION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_BulkResource_type")
		...
		newChildDescriptors.add(createChildParameter(
				...
				FeatureMapUtil.createEntry(
						...
						Schema1Factory.eINSTANCE
								.createCostPerQuantityAndTimeUnit())));
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == Schema1Package.Literals.BULK_RESOURCE__ONE_TIME_COST
