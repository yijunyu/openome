 ...
 * @generated
 */
public class PersonSearchTypeItemProvider extends ItemProviderAdapter implements
	...
	protected void addUserIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PersonSearchType_userId_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_userId_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__USER_ID, true,
	...
	protected void addProfilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_profile_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_profile_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__PROFILE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addLastNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_lastName_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_lastName_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__LAST_NAME, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addFirstNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_firstName_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_firstName_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__FIRST_NAME, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addMiddleNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_middleName_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__MIDDLE_NAME, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addEMailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_eMail_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_eMail_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__EMAIL, true, false,
	...
	protected void addCompanyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_company_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_company_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__COMPANY, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addDisplayNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_displayName_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__DISPLAY_NAME, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addSecretaryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_secretary_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_secretary_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__SECRETARY, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addAssistantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_assistant_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_assistant_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__ASSISTANT, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addManagerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_manager_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_manager_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__MANAGER, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addDepartmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_department_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__DEPARTMENT, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addEmployeeIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_employeeId_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__EMPLOYEE_ID, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addTaxPayerIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_taxPayerId_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__TAX_PAYER_ID, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addPhonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_phone_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_phone_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__PHONE, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addFaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_fax_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_fax_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__FAX, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGenderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_gender_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_gender_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__GENDER, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addTimeZonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PersonSearchType_timeZone_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_timeZone_feature",
						"_UI_PersonSearchType_type"),
				Schema1Package.Literals.PERSON_SEARCH_TYPE__TIME_ZONE, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addPreferredLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PersonSearchType_preferredLanguage_feature",
						"_UI_PersonSearchType_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_PersonSearchType_type")
