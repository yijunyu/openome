 ...
 * @generated
 */
public class IndividualResourceItemProvider extends
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.INDIVIDUAL_RESOURCE__INDIVIDUAL_RESOURCE_COST_TYPE);
			childrenFeatures
					.add(Schema1Package.Literals.INDIVIDUAL_RESOURCE__AVAILABILITY);
			childrenFeatures
					.add(Schema1Package.Literals.INDIVIDUAL_RESOURCE__QUALIFICATION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_IndividualResource_type")
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == Schema1Package.Literals.INDIVIDUAL_RESOURCE__ONE_TIME_COST
