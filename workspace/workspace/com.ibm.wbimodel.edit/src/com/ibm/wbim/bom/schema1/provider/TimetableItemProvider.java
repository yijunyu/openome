 ...
 * @generated
 */
public class TimetableItemProvider extends ItemProviderAdapter implements
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Timetable_documentation_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Timetable_documentation_feature",
						"_UI_Timetable_type"),
				Schema1Package.Literals.TIMETABLE__DOCUMENTATION, true, false,
	...
	protected void addBeginingOnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Timetable_beginingOn_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Timetable_beginingOn_feature",
						"_UI_Timetable_type"),
				Schema1Package.Literals.TIMETABLE__BEGINING_ON, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Timetable_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Timetable_name_feature", "_UI_Timetable_type"),
				Schema1Package.Literals.TIMETABLE__NAME, true, false, false,
	...
	protected void addNumberOfTimesToRepeatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Timetable_numberOfTimesToRepeat_feature",
						"_UI_Timetable_type"),
	...
	protected void addRepetitionPeriodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_Timetable_repetitionPeriod_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Timetable_repetitionPeriod_feature",
						"_UI_Timetable_type"),
				Schema1Package.Literals.TIMETABLE__REPETITION_PERIOD, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(Schema1Package.Literals.TIMETABLE__RECURRING_TIME_INTERVAL);
			childrenFeatures
					.add(Schema1Package.Literals.TIMETABLE__EXEMPTION_PERIOD);
			childrenFeatures
					.add(Schema1Package.Literals.TIMETABLE__EXTENDED_ATTRIBUTES);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Timetable_type")
