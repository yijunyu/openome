...
public class Q7 implements Q7Constants {
	...
	public static java.util.ArrayList<Advice> a = null;
	...
	public static void main(String args[]) {
		...
		try {
			...
			System.out
					.println("Q7 Parser Version 0.1:  Encountered errors during parse.");
			e.printStackTrace();
		}
	}
	 ...
	 */
	public static final java.util.ArrayList getAdviceList()
			throws ParseException {
		Advice t;
		java.util.ArrayList<Advice> adviceList = new java.util.ArrayList<Advice>();
		label_1: while (true) {
	...
	public static final Advice Advice() throws ParseException {
		String op = null;
		String when = null;
		String who = null;
		String why = null;
		...
		Advice advice = new Advice(op != null ? op + ":" + when : when, who, why,
				what, alias, where, how, how_much, Q7.comment == null ? null
						: ("" + Q7.comment), label);
		Q7.comment = null;
		{
			if (true)
	...
	public static final String When() throws ParseException {
	...
	public static final String Who() throws ParseException {
		Token agent = null;
		String who = null;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case ID:
	...
	public static final String Why() throws ParseException {
		Token goal = null;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case ID:
	...
	public static final String Alias() throws ParseException {
		Token alias = null;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case ID:
	...
	public static final String LabelList() throws ParseException {
	...
	public static final String What() throws ParseException {
		Token topic = null;
		String what = null;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case ID:
	...
	public static final java.util.ArrayList<Pointcut> Where()
			throws ParseException {
		java.util.ArrayList<Pointcut> where = null;
		java.util.ArrayList<Pointcut> pointcuts;
		...
		if (where == null)
			pointcuts = new java.util.ArrayList<Pointcut>();
		else
			pointcuts = where;
	...
	public static final java.util.ArrayList<Effect> HowMuch()
			throws ParseException {
		java.util.ArrayList<Effect> effects;
		java.util.ArrayList<Effect> howmuch = null;
		Effect effect = null;
		effect = Effect();
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case COMMA:
		...
		if (howmuch == null)
			effects = new java.util.ArrayList<Effect>();
		else
			effects = howmuch;
		effects.add(effect);
		{
	...
	public static final java.util.ArrayList<Effect> Agents()
			throws ParseException {
		java.util.ArrayList<Effect> effects;
		java.util.ArrayList<Effect> howmuch = null;
		Effect effect = null;
	...
	public static final String Op() throws ParseException {
		Token op = null;
		Token degree = null;
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case HELP:
		...
		}
		{
			if (true)
				return op.toString()
						+ (degree != null ? " " + degree.toString() : "");
		}
		throw new Error("Missing return statement in function");
	}

	public static final Effect Effect() throws ParseException {
		String op = null;
		String who = null;
		String why = null;
		String what = null;
	...
	public static final Effect DepEffect() throws ParseException {
		String who = null;
		jj_consume_token(LEFT_BR);
		who = Who();
		jj_consume_token(RIGHT_BR);
	...
	/* currently, Pointcut are the same as Effect,
	 ...
	 wildcards */
	public static final Pointcut Pointcut() throws ParseException {
		String op1 = null;
		Token op = null;
		String who = null;
		String why = null;
		...
		{
			if (true)
				return new Pointcut(op1 == null ? "~" : (op != null ? (op
						.toString().equals("AND") ? "&" : (op.toString()
						.equals("OR") ? "|" : op1)) : op1), who == null ? "*"
						: who.toString(), why == null ? "*" : why.toString(),
	...
	public static final How How() throws ParseException {
		Token rule = null;
		Token enrich = null;
		...
		advices = getAdviceList();
		{
			if (true)
				return new How(rule.toString().equals("AND") ? "&" : (rule
						.toString().equals("OR") ? "|" : rule.toString()),
	...
	static final private boolean jj_3_1() {
		if (jj_scan_token(LEFT_BR))
			return true;
		if (jj_3R_2())
			return true;
		if (jj_scan_token(RIGHT_BR))
			return true;
		return false;
	}
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x44800000, 0x40000000, 0x1000000, 0x0, 0x0,
				0x0, 0x4800000, 0x10000000, 0x0, 0x0, 0x0, 0x806000, 0x800000,
				0x800000, 0x800000, 0x800000, 0x88000, 0x88000, 0x0, 0x800000,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x88000, 0x88000, 0x4000000,
				0x1000000, 0x0, 0x0, 0x0, 0x800000, 0x4000000, 0x800000,
				0x800000, 0x1000000, 0x0, 0x0, 0x0, 0x0, 0x0, };
	}

	private static void jj_la1_1() {
		jj_la1_1 = new int[] { 0x8000000, 0x0, 0x0, 0x180000, 0x180000, 0x1,
				0x8000000, 0x0, 0x2, 0xc, 0xc, 0x8000000, 0x8000000, 0x8000000,
				0x8000000, 0x8000000, 0x7e00000, 0x0, 0x2000, 0x8000000,
				0x2000, 0x2000, 0x2000, 0x2000, 0x400f0, 0x0, 0x0, 0x0, 0x0,
				0x180000, 0x180000, 0x40ff0, 0x8010000, 0x0, 0x8010000,
				0x8010000, 0x0, 0x180000, 0x180000, 0xf00, 0x2c800, 0x2c800, };
	}
	...
	static public void ReInit(java.io.InputStream stream, String encoding) {
		...
		Q7TokenManager.ReInit(jj_input_stream);
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
		for (int i = 0; i < 42; i++)
