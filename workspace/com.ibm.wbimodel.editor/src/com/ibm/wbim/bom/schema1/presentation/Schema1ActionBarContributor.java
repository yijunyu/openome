 ...
 * @generated
 */
public class Schema1ActionBarContributor extends
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				WbimodelEditorPlugin.INSTANCE
						.getString("_UI_Schema1Editor_menu"),
				"com.ibm.wbim.bom.schema1MenuID");
		...
		//
		createChildMenuManager = new MenuManager(WbimodelEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(WbimodelEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
