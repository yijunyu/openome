...
public class Q7dslPackageImpl extends EPackageImpl implements Q7dslPackage {
	...
	public EReference getAdvice_What() {
		return (EReference)adviceEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getWhere_Op() {
		return (EAttribute)whereEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getHow_Advices() {
		return (EReference)howEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getHowMuch_Who() {
		return (EReference)howMuchEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getHowMuch_Op() {
		return (EAttribute)howMuchEClass.getEStructuralFeatures().get(5);
	}
