...
package edu.toronto.cs.goalmodel.ocl.interpreter.internal.l10n;
...
public class OCLInterpreterMessages extends NLS {
	...
	private static final String BUNDLE_NAME = "edu.toronto.cs.goalmodel.ocl.interpreter.internal.l10n.OCLInterpreterMessages"; //$NON-NLS-1$
