...
package edu.toronto.cs.goalmodel.ocl.interpreter.console;
...
import edu.toronto.cs.goalmodel.ocl.interpreter.console.text.ColorManager;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.DelegatingPackageRegistry;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.IOCLFactory;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.ModelingLevel;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.OCLConsole;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.OCLConsolePage;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.text.OCLDocument;
import edu.toronto.cs.goalmodel.ocl.interpreter.internal.l10n.OCLInterpreterMessages;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.OCLResource;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.text.OCLSourceViewer;
import edu.toronto.cs.goalmodel.ocl.interpreter.console.TargetMetamodel;
...
import edu.toronto.cs.goalmodel.ocl.interpreter.OCLExamplePlugin;
...
public class OCLConsolePage
    ...
    public void createControl(Composite parent) {
		...
		IMenuManager metamodelMenu = new MenuManager(
		    ...
		    "edu.toronto.cs.goalmodel.ocl.interpreter.metamodel"); //$NON-NLS-1$
