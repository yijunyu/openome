 ...
 * <ul>
 *   <li>{@link com.ibm.wbim.bom.schema1.impl.CatalogsImpl#getCatalog <em>Catalog</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CatalogsImpl extends EObjectImpl implements Catalogs {
	/**
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.CATALOGS;
	}
	...
	public EList<Catalog> getCatalog() {
		if (catalog == null) {
			catalog = new EObjectContainmentEList<Catalog>(Catalog.class, this,
					Schema1Package.CATALOGS__CATALOG);
		}
		return catalog;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case Schema1Package.CATALOGS__CATALOG:
