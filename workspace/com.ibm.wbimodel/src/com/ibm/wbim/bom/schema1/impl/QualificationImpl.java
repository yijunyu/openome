...
public class QualificationImpl extends EObjectImpl implements Qualification {
	 ...
	 * @ordered
	 */
	protected EList<ScopeDimensionValue> scopeDimensionValue;
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.QUALIFICATION;
	}
	 ...
	 * @generated
	 */
	public EList<ScopeDimensionValue> getScopeDimensionValue() {
		if (scopeDimensionValue == null) {
			scopeDimensionValue = new EObjectContainmentEList<ScopeDimensionValue>(
					ScopeDimensionValue.class, this,
					Schema1Package.QUALIFICATION__SCOPE_DIMENSION_VALUE);
		}
	...
	public void setRole(String newRole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.QUALIFICATION__ROLE, oldRole, role));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.QUALIFICATION__SCOPE_DIMENSION_VALUE:
			return ((InternalEList<?>) getScopeDimensionValue()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.QUALIFICATION__SCOPE_DIMENSION_VALUE:
			...
			getScopeDimensionValue().addAll(
					(Collection<? extends ScopeDimensionValue>) newValue);
			return;
		case Schema1Package.QUALIFICATION__ROLE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.QUALIFICATION__SCOPE_DIMENSION_VALUE:
			return scopeDimensionValue != null
					&& !scopeDimensionValue.isEmpty();
		case Schema1Package.QUALIFICATION__ROLE:
