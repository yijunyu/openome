 ...
 * @generated
 */
public class ScopeDimensionTypeImpl extends EObjectImpl implements
		ScopeDimensionType {
	/**
	 ...
	 * @ordered
	 */
	protected static final BasicDataType VALUE_TYPE_EDEFAULT = BasicDataType.BOOLEAN;
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.SCOPE_DIMENSION_TYPE__NAME, oldName, name));
	}
	...
	public void setValueType(BasicDataType newValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.SCOPE_DIMENSION_TYPE__VALUE_TYPE,
					oldValueType, valueType, !oldValueTypeESet));
	}
	...
	public void unsetValueType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.SCOPE_DIMENSION_TYPE__VALUE_TYPE,
					oldValueType, VALUE_TYPE_EDEFAULT, oldValueTypeESet));
	}
