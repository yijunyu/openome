...
public interface Timetable extends EObject {
	 ...
	 * @model type="com.ibm.wbim.bom.schema1.RecurringTimeIntervalType" containment="true"
	 ...
	 * @model type="com.ibm.wbim.bom.schema1.ExemptionPeriodType" containment="true"
