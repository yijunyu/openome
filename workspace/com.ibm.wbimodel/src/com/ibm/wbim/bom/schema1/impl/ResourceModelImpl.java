...
public class ResourceModelImpl extends EObjectImpl implements ResourceModel {
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.RESOURCE_MODEL;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIndividualResourceDefinitionTemplates(
			IndividualResourceDefinitionTemplatesType newIndividualResourceDefinitionTemplates,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCE_DEFINITION_TEMPLATES,
					oldIndividualResourceDefinitionTemplates,
					newIndividualResourceDefinitionTemplates);
			if (msgs == null)
				msgs = notification;
			else
	 ...
	 * @generated
	 */
	public void setIndividualResourceDefinitionTemplates(
			IndividualResourceDefinitionTemplatesType newIndividualResourceDefinitionTemplates) {
		if (newIndividualResourceDefinitionTemplates != individualResourceDefinitionTemplates) {
			...
			if (individualResourceDefinitionTemplates != null)
				msgs = ((InternalEObject) individualResourceDefinitionTemplates)
						.eInverseRemove(
								this,
			...
			if (newIndividualResourceDefinitionTemplates != null)
				msgs = ((InternalEObject) newIndividualResourceDefinitionTemplates)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCE_DEFINITION_TEMPLATES,
								null, msgs);
			msgs = basicSetIndividualResourceDefinitionTemplates(
					newIndividualResourceDefinitionTemplates, msgs);
			if (msgs != null)
				msgs.dispatch();
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIndividualResourceDefinitions(
			IndividualResourceDefinitionsType newIndividualResourceDefinitions,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCE_DEFINITIONS,
					oldIndividualResourceDefinitions,
					newIndividualResourceDefinitions);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setIndividualResourceDefinitions(
		...
		if (newIndividualResourceDefinitions != individualResourceDefinitions) {
			...
			if (newIndividualResourceDefinitions != null)
				msgs = ((InternalEObject) newIndividualResourceDefinitions)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCE_DEFINITIONS,
								null, msgs);
			msgs = basicSetIndividualResourceDefinitions(
					newIndividualResourceDefinitions, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBulkResourceDefinitionTemplates(
			BulkResourceDefinitionTemplatesType newBulkResourceDefinitionTemplates,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.RESOURCE_MODEL__BULK_RESOURCE_DEFINITION_TEMPLATES,
					oldBulkResourceDefinitionTemplates,
					newBulkResourceDefinitionTemplates);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBulkResourceDefinitionTemplates(
		...
		if (newBulkResourceDefinitionTemplates != bulkResourceDefinitionTemplates) {
			...
			if (newBulkResourceDefinitionTemplates != null)
				msgs = ((InternalEObject) newBulkResourceDefinitionTemplates)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__BULK_RESOURCE_DEFINITION_TEMPLATES,
								null, msgs);
			msgs = basicSetBulkResourceDefinitionTemplates(
					newBulkResourceDefinitionTemplates, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBulkResourceDefinitions(
			BulkResourceDefinitionsType newBulkResourceDefinitions,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.RESOURCE_MODEL__BULK_RESOURCE_DEFINITIONS,
					oldBulkResourceDefinitions, newBulkResourceDefinitions);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBulkResourceDefinitions(
		...
		if (newBulkResourceDefinitions != bulkResourceDefinitions) {
			...
			if (newBulkResourceDefinitions != null)
				msgs = ((InternalEObject) newBulkResourceDefinitions)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__BULK_RESOURCE_DEFINITIONS,
								null, msgs);
			msgs = basicSetBulkResourceDefinitions(newBulkResourceDefinitions,
					msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RESOURCE_MODEL__BULK_RESOURCE_DEFINITIONS,
					newBulkResourceDefinitions, newBulkResourceDefinitions));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIndividualResources(
			IndividualResourcesType newIndividualResources,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCES,
					oldIndividualResources, newIndividualResources);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setIndividualResources(
			IndividualResourcesType newIndividualResources) {
		if (newIndividualResources != individualResources) {
			NotificationChain msgs = null;
			if (individualResources != null)
				msgs = ((InternalEObject) individualResources)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCES,
			...
			if (newIndividualResources != null)
				msgs = ((InternalEObject) newIndividualResources)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCES,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RESOURCE_MODEL__INDIVIDUAL_RESOURCES,
					newIndividualResources, newIndividualResources));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBulkResources(
			BulkResourcesType newBulkResources, NotificationChain msgs) {
		BulkResourcesType oldBulkResources = bulkResources;
		bulkResources = newBulkResources;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.RESOURCE_MODEL__BULK_RESOURCES,
					oldBulkResources, newBulkResources);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBulkResources(BulkResourcesType newBulkResources) {
		if (newBulkResources != bulkResources) {
			...
			if (bulkResources != null)
				msgs = ((InternalEObject) bulkResources)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__BULK_RESOURCES,
			...
			if (newBulkResources != null)
				msgs = ((InternalEObject) newBulkResources)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RESOURCE_MODEL__BULK_RESOURCES,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RESOURCE_MODEL__BULK_RESOURCES,
					newBulkResources, newBulkResources));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRoles(RolesType newRoles,
			NotificationChain msgs) {
		RolesType oldRoles = roles;
		roles = newRoles;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.RESOURCE_MODEL__ROLES,
					oldRoles, newRoles);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRoles != roles) {
			...
			if (roles != null)
				msgs = ((InternalEObject) roles).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.RESOURCE_MODEL__ROLES, null,
						msgs);
			if (newRoles != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RESOURCE_MODEL__ROLES, newRoles, newRoles));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTimetables(TimetablesType newTimetables,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.RESOURCE_MODEL__TIMETABLES, oldTimetables,
					newTimetables);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTimetables(TimetablesType newTimetables) {
		if (newTimetables != timetables) {
			NotificationChain msgs = null;
			if (timetables != null)
				msgs = ((InternalEObject) timetables).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.RESOURCE_MODEL__TIMETABLES,
						null, msgs);
			if (newTimetables != null)
				msgs = ((InternalEObject) newTimetables).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.RESOURCE_MODEL__TIMETABLES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RESOURCE_MODEL__TIMETABLES, newTimetables,
					newTimetables));
	}
