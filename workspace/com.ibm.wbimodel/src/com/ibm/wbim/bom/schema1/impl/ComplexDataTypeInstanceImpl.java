 ...
 * @generated
 */
public class ComplexDataTypeInstanceImpl extends EObjectImpl implements
	 ...
	 * @ordered
	 */
	protected static final Object INSTANCE_OF_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Object instanceOf = INSTANCE_OF_EDEFAULT;
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__DOCUMENTATION,
	...
	public EList<AttributeValue> getAttributeValue() {
		if (attributeValue == null) {
			attributeValue = new EObjectContainmentEList<AttributeValue>(
					AttributeValue.class, this,
					Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__ATTRIBUTE_VALUE);
		}
	...
	public NotificationChain basicSetExtendedAttributes(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__EXTENDED_ATTRIBUTES,
	 ...
	 * @generated
	 */
	public void setInstanceOf(Object newInstanceOf) {
		Object oldInstanceOf = instanceOf;
		instanceOf = newInstanceOf;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__INSTANCE_OF,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__NAME, oldName,
					name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__ATTRIBUTE_VALUE:
			return ((InternalEList<?>) getAttributeValue()).basicRemove(
					otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__ATTRIBUTE_VALUE:
			...
			getAttributeValue().addAll(
					(Collection<? extends AttributeValue>) newValue);
			return;
		case Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__EXTENDED_ATTRIBUTES:
			setExtendedAttributes((ExtendedAttributes) newValue);
			return;
		case Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__INSTANCE_OF:
			setInstanceOf(newValue);
			return;
		case Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__NAME:
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__INSTANCE_OF:
			return INSTANCE_OF_EDEFAULT == null ? instanceOf != null
					: !INSTANCE_OF_EDEFAULT.equals(instanceOf);
		case Schema1Package.COMPLEX_DATA_TYPE_INSTANCE__NAME:
