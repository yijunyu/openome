...
public class DataModelImpl extends EObjectImpl implements DataModel {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBusinessItemTemplates(
			BusinessItemTemplatesType newBusinessItemTemplates,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.DATA_MODEL__BUSINESS_ITEM_TEMPLATES,
					oldBusinessItemTemplates, newBusinessItemTemplates);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setBusinessItemTemplates(
		...
		if (newBusinessItemTemplates != businessItemTemplates) {
			...
			if (newBusinessItemTemplates != null)
				msgs = ((InternalEObject) newBusinessItemTemplates)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.DATA_MODEL__BUSINESS_ITEM_TEMPLATES,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DATA_MODEL__BUSINESS_ITEM_TEMPLATES,
					newBusinessItemTemplates, newBusinessItemTemplates));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBusinessItems(
			BusinessItemsType newBusinessItems, NotificationChain msgs) {
		BusinessItemsType oldBusinessItems = businessItems;
		businessItems = newBusinessItems;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.DATA_MODEL__BUSINESS_ITEMS,
					oldBusinessItems, newBusinessItems);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBusinessItems(BusinessItemsType newBusinessItems) {
		if (newBusinessItems != businessItems) {
			...
			if (businessItems != null)
				msgs = ((InternalEObject) businessItems).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.DATA_MODEL__BUSINESS_ITEMS,
						null, msgs);
			if (newBusinessItems != null)
				msgs = ((InternalEObject) newBusinessItems).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.DATA_MODEL__BUSINESS_ITEMS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DATA_MODEL__BUSINESS_ITEMS,
					newBusinessItems, newBusinessItems));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBusinessItemInstances(
			BusinessItemInstancesType newBusinessItemInstances,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.DATA_MODEL__BUSINESS_ITEM_INSTANCES,
					oldBusinessItemInstances, newBusinessItemInstances);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setBusinessItemInstances(
			BusinessItemInstancesType newBusinessItemInstances) {
		if (newBusinessItemInstances != businessItemInstances) {
			NotificationChain msgs = null;
			if (businessItemInstances != null)
				msgs = ((InternalEObject) businessItemInstances)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.DATA_MODEL__BUSINESS_ITEM_INSTANCES,
			...
			if (newBusinessItemInstances != null)
				msgs = ((InternalEObject) newBusinessItemInstances)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.DATA_MODEL__BUSINESS_ITEM_INSTANCES,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DATA_MODEL__BUSINESS_ITEM_INSTANCES,
					newBusinessItemInstances, newBusinessItemInstances));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNotificationTemplates(
			NotificationTemplatesType newNotificationTemplates,
			NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.DATA_MODEL__NOTIFICATION_TEMPLATES,
					oldNotificationTemplates, newNotificationTemplates);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setNotificationTemplates(
		...
		if (newNotificationTemplates != notificationTemplates) {
			...
			if (notificationTemplates != null)
				msgs = ((InternalEObject) notificationTemplates)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.DATA_MODEL__NOTIFICATION_TEMPLATES,
			...
			if (newNotificationTemplates != null)
				msgs = ((InternalEObject) newNotificationTemplates)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.DATA_MODEL__NOTIFICATION_TEMPLATES,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DATA_MODEL__NOTIFICATION_TEMPLATES,
					newNotificationTemplates, newNotificationTemplates));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNotifications(
			NotificationsType newNotifications, NotificationChain msgs) {
		NotificationsType oldNotifications = notifications;
		notifications = newNotifications;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.DATA_MODEL__NOTIFICATIONS,
	...
	public void setNotifications(NotificationsType newNotifications) {
		if (newNotifications != notifications) {
			...
			if (notifications != null)
				msgs = ((InternalEObject) notifications).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.DATA_MODEL__NOTIFICATIONS,
						null, msgs);
			if (newNotifications != null)
				msgs = ((InternalEObject) newNotifications).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.DATA_MODEL__NOTIFICATIONS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DATA_MODEL__NOTIFICATIONS, newNotifications,
					newNotifications));
	}
