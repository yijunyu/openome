 ...
 * @generated
 */
public class InputRepositoryValueImpl extends EObjectImpl implements
	...
	public NotificationChain basicSetLocalRepository(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.INPUT_REPOSITORY_VALUE__LOCAL_REPOSITORY,
	...
	public NotificationChain basicSetGlobalRepository(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.INPUT_REPOSITORY_VALUE__GLOBAL_REPOSITORY,
	...
	public void setAtBeginning(boolean newAtBeginning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT_REPOSITORY_VALUE__AT_BEGINNING,
	...
	public void setIsRemove(boolean newIsRemove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT_REPOSITORY_VALUE__IS_REMOVE,
					oldIsRemove, isRemove, !oldIsRemoveESet));
	}
	...
	public void unsetIsRemove() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.INPUT_REPOSITORY_VALUE__IS_REMOVE,
					oldIsRemove, IS_REMOVE_EDEFAULT, oldIsRemoveESet));
	}
