...
public class EntryPointTypeImpl extends EObjectImpl implements EntryPointType {
	...
	public void setInputCriterion(String newInputCriterion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ENTRY_POINT_TYPE__INPUT_CRITERION,
					oldInputCriterion, inputCriterion));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.ENTRY_POINT_TYPE__INPUT_CRITERION:
			return INPUT_CRITERION_EDEFAULT == null ? inputCriterion != null
					: !INPUT_CRITERION_EDEFAULT.equals(inputCriterion);
		}
