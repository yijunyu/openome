 ...
 * @generated
 */
public class TaskIndividualResourceRequirementImpl extends
		IndividualResourceRequirementImpl implements
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.TASK_INDIVIDUAL_RESOURCE_REQUIREMENT;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCriteria(CriteriaTemplate newCriteria,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.TASK_INDIVIDUAL_RESOURCE_REQUIREMENT__CRITERIA,
