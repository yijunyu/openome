...
public class ProcessModelImpl extends EObjectImpl implements ProcessModel {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProcesses(ProcessesType newProcesses,
			NotificationChain msgs) {
		ProcessesType oldProcesses = processes;
		processes = newProcesses;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS_MODEL__PROCESSES,
	...
	public void setProcesses(ProcessesType newProcesses) {
		if (newProcesses != processes) {
			...
			if (processes != null)
				msgs = ((InternalEObject) processes).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS_MODEL__PROCESSES,
						null, msgs);
			if (newProcesses != null)
				msgs = ((InternalEObject) newProcesses).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS_MODEL__PROCESSES,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS_MODEL__PROCESSES, newProcesses,
					newProcesses));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTasks(TasksType newTasks,
			NotificationChain msgs) {
		TasksType oldTasks = tasks;
		tasks = newTasks;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS_MODEL__TASKS,
					oldTasks, newTasks);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTasks(TasksType newTasks) {
		if (newTasks != tasks) {
			NotificationChain msgs = null;
			if (tasks != null)
				msgs = ((InternalEObject) tasks).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS_MODEL__TASKS, null,
						msgs);
			if (newTasks != null)
				msgs = ((InternalEObject) newTasks).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS_MODEL__TASKS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS_MODEL__TASKS, newTasks, newTasks));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRepositories(
			RepositoriesType newRepositories, NotificationChain msgs) {
		RepositoriesType oldRepositories = repositories;
		repositories = newRepositories;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.PROCESS_MODEL__REPOSITORIES,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetServices(ServicesType newServices,
			NotificationChain msgs) {
		ServicesType oldServices = services;
		services = newServices;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.PROCESS_MODEL__SERVICES,
		...
		if (newServices != services) {
			...
			if (services != null)
				msgs = ((InternalEObject) services).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.PROCESS_MODEL__SERVICES, null,
						msgs);
			if (newServices != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PROCESS_MODEL__SERVICES, newServices,
					newServices));
	}
