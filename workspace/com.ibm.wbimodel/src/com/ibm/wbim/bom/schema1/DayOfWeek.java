...
public final class DayOfWeek extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final DayOfWeek MONDAY_LITERAL = new DayOfWeek(MONDAY, "Monday", "Monday");
	 ...
	 * @ordered
	 */
	public static final DayOfWeek TUESDAY_LITERAL = new DayOfWeek(TUESDAY, "Tuesday", "Tuesday");
	 ...
	 * @ordered
	 */
	public static final DayOfWeek WEDNESDAY_LITERAL = new DayOfWeek(WEDNESDAY, "Wednesday", "Wednesday");
	 ...
	 * @ordered
	 */
	public static final DayOfWeek THURSDAY_LITERAL = new DayOfWeek(THURSDAY, "Thursday", "Thursday");
	 ...
	 * @ordered
	 */
	public static final DayOfWeek FRIDAY_LITERAL = new DayOfWeek(FRIDAY, "Friday", "Friday");
	 ...
	 * @ordered
	 */
	public static final DayOfWeek SATURDAY_LITERAL = new DayOfWeek(SATURDAY, "Saturday", "Saturday");
	 ...
	 * @ordered
	 */
	public static final DayOfWeek SUNDAY_LITERAL = new DayOfWeek(SUNDAY, "Sunday", "Sunday");
