 ...
 * @generated
 */
public class RepositoryDataValueImpl extends EObjectImpl implements
		RepositoryDataValue {
	/**
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this,
					Schema1Package.REPOSITORY_DATA_VALUE__GROUP);
		}
		return group;
	}
	 ...
	 * @generated
	 */
	public EList<Expression> getExpressionValue() {
		return getGroup()
				.list(
	 ...
	 * @generated
	 */
	public EList<PublicInstance> getPublicInstance() {
		return getGroup().list(
	 ...
	 * @generated
	 */
	public EList<PrivateInstance> getPrivateInstance() {
		return getGroup()
				.list(
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.REPOSITORY_DATA_VALUE__EXPRESSION_VALUE:
			return ((InternalEList<?>) getExpressionValue()).basicRemove(
					otherEnd, msgs);
		case Schema1Package.REPOSITORY_DATA_VALUE__PUBLIC_INSTANCE:
			return ((InternalEList<?>) getPublicInstance()).basicRemove(
					otherEnd, msgs);
		case Schema1Package.REPOSITORY_DATA_VALUE__PRIVATE_INSTANCE:
			return ((InternalEList<?>) getPrivateInstance()).basicRemove(
					otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.REPOSITORY_DATA_VALUE__EXPRESSION_VALUE:
			...
			getExpressionValue().addAll(
					(Collection<? extends Expression>) newValue);
			return;
		case Schema1Package.REPOSITORY_DATA_VALUE__PUBLIC_INSTANCE:
			getPublicInstance().clear();
			getPublicInstance().addAll(
					(Collection<? extends PublicInstance>) newValue);
			return;
		case Schema1Package.REPOSITORY_DATA_VALUE__PRIVATE_INSTANCE:
			getPrivateInstance().clear();
			getPrivateInstance().addAll(
					(Collection<? extends PrivateInstance>) newValue);
			return;
		}
