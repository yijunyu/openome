 ...
 * @generated
 */
public class OrganizationDefinitionTemplatesTypeImpl extends EObjectImpl
		implements OrganizationDefinitionTemplatesType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<TypeDeclaration> organizationDefinitionTemplate;
	 ...
	 * @generated
	 */
	public EList<TypeDeclaration> getOrganizationDefinitionTemplate() {
		if (organizationDefinitionTemplate == null) {
			organizationDefinitionTemplate = new EObjectContainmentEList<TypeDeclaration>(
					TypeDeclaration.class,
					this,
					Schema1Package.ORGANIZATION_DEFINITION_TEMPLATES_TYPE__ORGANIZATION_DEFINITION_TEMPLATE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.ORGANIZATION_DEFINITION_TEMPLATES_TYPE__ORGANIZATION_DEFINITION_TEMPLATE:
			return ((InternalEList<?>) getOrganizationDefinitionTemplate())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.ORGANIZATION_DEFINITION_TEMPLATES_TYPE__ORGANIZATION_DEFINITION_TEMPLATE:
			...
			getOrganizationDefinitionTemplate().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.ORGANIZATION_DEFINITION_TEMPLATES_TYPE__ORGANIZATION_DEFINITION_TEMPLATE:
			return organizationDefinitionTemplate != null
					&& !organizationDefinitionTemplate.isEmpty();
		}
