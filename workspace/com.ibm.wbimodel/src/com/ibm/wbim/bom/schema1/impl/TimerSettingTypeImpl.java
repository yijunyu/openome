 ...
 * @generated
 */
public class TimerSettingTypeImpl extends EObjectImpl implements
		TimerSettingType {
	/**
	 ...
	 * @generated
	 */
	public NotificationChain basicSetBasedOnTimetable(
			BasedOnTimetableType newBasedOnTimetable, NotificationChain msgs) {
		BasedOnTimetableType oldBasedOnTimetable = basedOnTimetable;
		basedOnTimetable = newBasedOnTimetable;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__BASED_ON_TIMETABLE,
					oldBasedOnTimetable, newBasedOnTimetable);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setBasedOnTimetable(BasedOnTimetableType newBasedOnTimetable) {
		if (newBasedOnTimetable != basedOnTimetable) {
			...
			if (basedOnTimetable != null)
				msgs = ((InternalEObject) basedOnTimetable)
						.eInverseRemove(
								this,
			...
			if (newBasedOnTimetable != null)
				msgs = ((InternalEObject) newBasedOnTimetable)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIMER_SETTING_TYPE__BASED_ON_TIMETABLE,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__BASED_ON_TIMETABLE,
					newBasedOnTimetable, newBasedOnTimetable));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetConstantTime(
			ConstantTimeType newConstantTime, NotificationChain msgs) {
		ConstantTimeType oldConstantTime = constantTime;
		constantTime = newConstantTime;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__CONSTANT_TIME,
					oldConstantTime, newConstantTime);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setConstantTime(ConstantTimeType newConstantTime) {
		if (newConstantTime != constantTime) {
			...
			if (constantTime != null)
				msgs = ((InternalEObject) constantTime)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIMER_SETTING_TYPE__CONSTANT_TIME,
			...
			if (newConstantTime != null)
				msgs = ((InternalEObject) newConstantTime)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIMER_SETTING_TYPE__CONSTANT_TIME,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__CONSTANT_TIME,
					newConstantTime, newConstantTime));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLastActivationTimePlus(
			LastActivationTimePlusType newLastActivationTimePlus,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__LAST_ACTIVATION_TIME_PLUS,
					oldLastActivationTimePlus, newLastActivationTimePlus);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setLastActivationTimePlus(
		...
		if (newLastActivationTimePlus != lastActivationTimePlus) {
			...
			if (newLastActivationTimePlus != null)
				msgs = ((InternalEObject) newLastActivationTimePlus)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIMER_SETTING_TYPE__LAST_ACTIVATION_TIME_PLUS,
								null, msgs);
			msgs = basicSetLastActivationTimePlus(newLastActivationTimePlus,
					msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__LAST_ACTIVATION_TIME_PLUS,
					newLastActivationTimePlus, newLastActivationTimePlus));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTimerExpression(
			Expression newTimerExpression, NotificationChain msgs) {
		Expression oldTimerExpression = timerExpression;
		timerExpression = newTimerExpression;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__TIMER_EXPRESSION,
					oldTimerExpression, newTimerExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTimerExpression(Expression newTimerExpression) {
		if (newTimerExpression != timerExpression) {
			...
			if (timerExpression != null)
				msgs = ((InternalEObject) timerExpression)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIMER_SETTING_TYPE__TIMER_EXPRESSION,
			...
			if (newTimerExpression != null)
				msgs = ((InternalEObject) newTimerExpression)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.TIMER_SETTING_TYPE__TIMER_EXPRESSION,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMER_SETTING_TYPE__TIMER_EXPRESSION,
					newTimerExpression, newTimerExpression));
	}
