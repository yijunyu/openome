...
public class TimerImpl extends TaskImpl implements Timer {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTimerSetting(
			TimerSettingType newTimerSetting, NotificationChain msgs) {
		TimerSettingType oldTimerSetting = timerSetting;
		timerSetting = newTimerSetting;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TIMER__TIMER_SETTING,
					oldTimerSetting, newTimerSetting);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTimerSetting(TimerSettingType newTimerSetting) {
		if (newTimerSetting != timerSetting) {
			...
			if (timerSetting != null)
				msgs = ((InternalEObject) timerSetting).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.TIMER__TIMER_SETTING, null,
						msgs);
			if (newTimerSetting != null)
				msgs = ((InternalEObject) newTimerSetting).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.TIMER__TIMER_SETTING, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TIMER__TIMER_SETTING, newTimerSetting,
					newTimerSetting));
	}
