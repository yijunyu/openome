 ...
 * @generated
 */
public class StartDayOfWeekTypeImpl extends EObjectImpl implements
		StartDayOfWeekType {
	/**
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.START_DAY_OF_WEEK_TYPE;
	}
	...
	public void setDayOfWeek(DayOfWeek newDayOfWeek) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.START_DAY_OF_WEEK_TYPE__DAY_OF_WEEK,
					oldDayOfWeek, dayOfWeek, !oldDayOfWeekESet));
	}
	...
	public void unsetDayOfWeek() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.START_DAY_OF_WEEK_TYPE__DAY_OF_WEEK,
					oldDayOfWeek, DAY_OF_WEEK_EDEFAULT, oldDayOfWeekESet));
	}
	...
	public void setStartTime(XMLGregorianCalendar newStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.START_DAY_OF_WEEK_TYPE__START_TIME,
	...
	public void setWeekNumber(BigInteger newWeekNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.START_DAY_OF_WEEK_TYPE__WEEK_NUMBER,
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.START_DAY_OF_WEEK_TYPE__WEEK_NUMBER:
			return WEEK_NUMBER_EDEFAULT == null ? weekNumber != null
					: !WEEK_NUMBER_EDEFAULT.equals(weekNumber);
		}
