...
public class UniformTypeImpl extends EObjectImpl implements UniformType {
	...
	public void setMaximum(double newMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.UNIFORM_TYPE__MAXIMUM, oldMaximum, maximum,
					!oldMaximumESet));
	}
	...
	public void unsetMaximum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.UNIFORM_TYPE__MAXIMUM, oldMaximum,
	...
	public void setMinimum(double newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.UNIFORM_TYPE__MINIMUM, oldMinimum, minimum,
					!oldMinimumESet));
	}
	...
	public void unsetMinimum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.UNIFORM_TYPE__MINIMUM, oldMinimum,
