 ...
 * @generated
 */
public class NotificationReceiverImpl extends TaskImpl implements
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNotificationFilter(
			Expression newNotificationFilter, NotificationChain msgs) {
		Expression oldNotificationFilter = notificationFilter;
		notificationFilter = newNotificationFilter;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.NOTIFICATION_RECEIVER__NOTIFICATION_FILTER,
					oldNotificationFilter, newNotificationFilter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setNotificationFilter(Expression newNotificationFilter) {
		if (newNotificationFilter != notificationFilter) {
			...
			if (notificationFilter != null)
				msgs = ((InternalEObject) notificationFilter)
						.eInverseRemove(
								this,
			...
			if (newNotificationFilter != null)
				msgs = ((InternalEObject) newNotificationFilter)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.NOTIFICATION_RECEIVER__NOTIFICATION_FILTER,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.NOTIFICATION_RECEIVER__NOTIFICATION_FILTER,
					newNotificationFilter, newNotificationFilter));
	}
	...
	public void setNotification(String newNotification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.NOTIFICATION_RECEIVER__NOTIFICATION,
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.NOTIFICATION_RECEIVER__NOTIFICATION:
			return NOTIFICATION_EDEFAULT == null ? notification != null
					: !NOTIFICATION_EDEFAULT.equals(notification);
		}
