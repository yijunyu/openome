 ...
 * @generated
 */
public class NotificationsTypeImpl extends EObjectImpl implements
		NotificationsType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<TypeDeclaration> notification;
	 ...
	 * @generated
	 */
	public EList<TypeDeclaration> getNotification() {
		if (notification == null) {
			notification = new EObjectContainmentEList<TypeDeclaration>(
					TypeDeclaration.class, this,
					Schema1Package.NOTIFICATIONS_TYPE__NOTIFICATION);
		}
		return notification;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.NOTIFICATIONS_TYPE__NOTIFICATION:
			return ((InternalEList<?>) getNotification()).basicRemove(otherEnd,
					msgs);
		}
