 ...
 * @generated
 */
public class CostPerTimeUnitImpl extends OneTimeCostImpl implements
		CostPerTimeUnit {
	/**
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.COST_PER_TIME_UNIT;
	}
	...
	public void setTimeUnit(Duration newTimeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.COST_PER_TIME_UNIT__TIME_UNIT, oldTimeUnit,
					timeUnit));
	}
