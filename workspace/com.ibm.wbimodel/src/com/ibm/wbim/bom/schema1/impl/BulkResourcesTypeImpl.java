 ...
 * @generated
 */
public class BulkResourcesTypeImpl extends EObjectImpl implements
		BulkResourcesType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<BulkResource> bulkResource;
	 ...
	 * @generated
	 */
	public EList<BulkResource> getBulkResource() {
		if (bulkResource == null) {
			bulkResource = new EObjectContainmentEList<BulkResource>(
					BulkResource.class, this,
					Schema1Package.BULK_RESOURCES_TYPE__BULK_RESOURCE);
		}
		return bulkResource;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.BULK_RESOURCES_TYPE__BULK_RESOURCE:
			return ((InternalEList<?>) getBulkResource()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.BULK_RESOURCES_TYPE__BULK_RESOURCE:
			...
			getBulkResource().addAll(
					(Collection<? extends BulkResource>) newValue);
			return;
		}
