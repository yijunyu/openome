...
public class AttributeImpl extends EObjectImpl implements Attribute {
	 ...
	 * @ordered
	 */
	protected static final Object TYPE_EDEFAULT = Schema1Factory.eINSTANCE
			.createFromString(Schema1Package.eINSTANCE.getTypeType2(), "String");
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__DESCRIPTION, oldDescription,
					description));
	}
	...
	public NotificationChain basicSetRule(Expression newRule,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.ATTRIBUTE__RULE, oldRule,
					newRule);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setRule(Expression newRule) {
		if (newRule != rule) {
			...
			if (rule != null)
				msgs = ((InternalEObject) rule)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.ATTRIBUTE__RULE, null, msgs);
			if (newRule != null)
				msgs = ((InternalEObject) newRule)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__RULE, newRule, newRule));
	}
	...
	public NotificationChain basicSetDefaultValue(DefaultValue newDefaultValue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.ATTRIBUTE__DEFAULT_VALUE,
	...
	public void setDefaultValue(DefaultValue newDefaultValue) {
		if (newDefaultValue != defaultValue) {
			...
			if (defaultValue != null)
				msgs = ((InternalEObject) defaultValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.ATTRIBUTE__DEFAULT_VALUE,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__DEFAULT_VALUE, newDefaultValue,
					newDefaultValue));
	}
	...
	public void setIsOrdered(boolean newIsOrdered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__IS_ORDERED, oldIsOrdered,
					isOrdered, !oldIsOrderedESet));
	}
	...
	public void unsetIsOrdered() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.ATTRIBUTE__IS_ORDERED, oldIsOrdered,
					IS_ORDERED_EDEFAULT, oldIsOrderedESet));
	}
	...
	public void setIsReadOnly(boolean newIsReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__IS_READ_ONLY, oldIsReadOnly,
					isReadOnly, !oldIsReadOnlyESet));
	}
	...
	public void unsetIsReadOnly() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.ATTRIBUTE__IS_READ_ONLY, oldIsReadOnly,
					IS_READ_ONLY_EDEFAULT, oldIsReadOnlyESet));
	}
	...
	public void setIsStatic(boolean newIsStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__IS_STATIC, oldIsStatic, isStatic,
					!oldIsStaticESet));
	}
	...
	public void unsetIsStatic() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.ATTRIBUTE__IS_STATIC, oldIsStatic,
					IS_STATIC_EDEFAULT, oldIsStaticESet));
	}
	...
	public void setIsUnique(boolean newIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__IS_UNIQUE, oldIsUnique, isUnique,
					!oldIsUniqueESet));
	}
	...
	public void unsetIsUnique() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.ATTRIBUTE__IS_UNIQUE, oldIsUnique,
					IS_UNIQUE_EDEFAULT, oldIsUniqueESet));
	}
	...
	public void setMaximum(BigInteger newMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__MAXIMUM, oldMaximum, maximum,
					!oldMaximumESet));
	}
	...
	public void unsetMaximum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.ATTRIBUTE__MAXIMUM, oldMaximum,
	...
	public void setMinimum(BigInteger newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__MINIMUM, oldMinimum, minimum,
					!oldMinimumESet));
	}
	...
	public void unsetMinimum() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.ATTRIBUTE__MINIMUM, oldMinimum,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__NAME, oldName, name));
	}
	...
	public void setType(Object newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ATTRIBUTE__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.ATTRIBUTE__TYPE, oldType, TYPE_EDEFAULT,
					oldTypeESet));
	}
