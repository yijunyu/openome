...
public class ForLoopImpl extends ProcessImpl implements ForLoop {
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.FOR_LOOP;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLoopCondition(
			LoopConditionType newLoopCondition, NotificationChain msgs) {
		LoopConditionType oldLoopCondition = loopCondition;
		loopCondition = newLoopCondition;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.FOR_LOOP__LOOP_CONDITION,
	...
	public void setLoopCondition(LoopConditionType newLoopCondition) {
		if (newLoopCondition != loopCondition) {
			...
			if (loopCondition != null)
				msgs = ((InternalEObject) loopCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.FOR_LOOP__LOOP_CONDITION,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.FOR_LOOP__LOOP_CONDITION, newLoopCondition,
					newLoopCondition));
	}
