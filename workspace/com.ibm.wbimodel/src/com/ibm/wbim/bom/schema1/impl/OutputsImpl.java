...
public class OutputsImpl extends EObjectImpl implements Outputs {
	 ...
	 * @ordered
	 */
	protected EList<OutputCriterion> outputCriterion;
	...
	public EList<Output> getOutput() {
		if (output == null) {
			output = new EObjectContainmentEList<Output>(Output.class, this,
					Schema1Package.OUTPUTS__OUTPUT);
		}
		return output;
	}
	 ...
	 * @generated
	 */
	public EList<OutputCriterion> getOutputCriterion() {
		if (outputCriterion == null) {
			outputCriterion = new EObjectContainmentEList<OutputCriterion>(
					OutputCriterion.class, this,
					Schema1Package.OUTPUTS__OUTPUT_CRITERION);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.OUTPUTS__OUTPUT_CRITERION:
			...
			getOutputCriterion().addAll(
					(Collection<? extends OutputCriterion>) newValue);
			return;
		}
