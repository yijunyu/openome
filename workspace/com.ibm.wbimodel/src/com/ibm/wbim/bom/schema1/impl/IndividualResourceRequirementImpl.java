 ...
 * @generated
 */
public class IndividualResourceRequirementImpl extends EObjectImpl implements
	...
	public void setIndividualResource(String newIndividualResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.INDIVIDUAL_RESOURCE_REQUIREMENT__INDIVIDUAL_RESOURCE,
					oldIndividualResource, individualResource));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INDIVIDUAL_RESOURCE_REQUIREMENT__NAME,
					oldName, name));
	}
	...
	public void setTimeRequired(Duration newTimeRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.INDIVIDUAL_RESOURCE_REQUIREMENT__TIME_REQUIRED,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.INDIVIDUAL_RESOURCE_REQUIREMENT__INDIVIDUAL_RESOURCE:
			return INDIVIDUAL_RESOURCE_EDEFAULT == null ? individualResource != null
					: !INDIVIDUAL_RESOURCE_EDEFAULT.equals(individualResource);
		case Schema1Package.INDIVIDUAL_RESOURCE_REQUIREMENT__NAME:
