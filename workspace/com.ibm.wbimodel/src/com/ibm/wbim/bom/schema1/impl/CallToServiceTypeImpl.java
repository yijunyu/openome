 ...
 * @generated
 */
public class CallToServiceTypeImpl extends InvocationImpl implements
		CallToServiceType {
	/**
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.CALL_TO_SERVICE_TYPE;
	}
	...
	public void setService(String newService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.CALL_TO_SERVICE_TYPE__SERVICE, oldService,
					service));
	}
