 ...
 * @generated
 */
public class PersonSearchTypeImpl extends EObjectImpl implements
		PersonSearchType {
	/**
	...
	public void setUserId(String newUserId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__USER_ID, oldUserId,
					userId));
	}
	...
	public void setProfile(String newProfile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__PROFILE, oldProfile,
					profile));
	}
	...
	public void setLastName(String newLastName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__LAST_NAME, oldLastName,
					lastName));
	}
	...
	public void setFirstName(String newFirstName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__FIRST_NAME,
	...
	public void setMiddleName(String newMiddleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__MIDDLE_NAME,
	...
	public void setEMail(String newEMail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__EMAIL, oldEMail, eMail));
	}
	...
	public void setCompany(String newCompany) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__COMPANY, oldCompany,
					company));
	}
	...
	public void setDisplayName(String newDisplayName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__DISPLAY_NAME,
	...
	public void setSecretary(String newSecretary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__SECRETARY, oldSecretary,
					secretary));
	}
	...
	public void setAssistant(String newAssistant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__ASSISTANT, oldAssistant,
					assistant));
	}
	...
	public void setManager(String newManager) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__MANAGER, oldManager,
					manager));
	}
	...
	public void setDepartment(String newDepartment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__DEPARTMENT,
	...
	public void setEmployeeId(String newEmployeeId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__EMPLOYEE_ID,
	...
	public void setTaxPayerId(String newTaxPayerId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__TAX_PAYER_ID,
					oldTaxPayerId, taxPayerId));
	}
	...
	public void setPhone(String newPhone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__PHONE, oldPhone, phone));
	}
	...
	public void setFax(String newFax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__FAX, oldFax, fax));
	}
	...
	public void setGender(String newGender) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__GENDER, oldGender,
					gender));
	}
	...
	public void setTimeZone(String newTimeZone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__TIME_ZONE, oldTimeZone,
					timeZone));
	}
	...
	public void setPreferredLanguage(String newPreferredLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_SEARCH_TYPE__PREFERRED_LANGUAGE,
	...
	public boolean eIsSet(int featureID) {
		...
		case Schema1Package.PERSON_SEARCH_TYPE__MIDDLE_NAME:
			return MIDDLE_NAME_EDEFAULT == null ? middleName != null
					: !MIDDLE_NAME_EDEFAULT.equals(middleName);
		case Schema1Package.PERSON_SEARCH_TYPE__EMAIL:
		...
		case Schema1Package.PERSON_SEARCH_TYPE__EMPLOYEE_ID:
			return EMPLOYEE_ID_EDEFAULT == null ? employeeId != null
					: !EMPLOYEE_ID_EDEFAULT.equals(employeeId);
		case Schema1Package.PERSON_SEARCH_TYPE__TAX_PAYER_ID:
			return TAX_PAYER_ID_EDEFAULT == null ? taxPayerId != null
					: !TAX_PAYER_ID_EDEFAULT.equals(taxPayerId);
		case Schema1Package.PERSON_SEARCH_TYPE__PHONE:
			return PHONE_EDEFAULT == null ? phone != null : !PHONE_EDEFAULT
					.equals(phone);
		case Schema1Package.PERSON_SEARCH_TYPE__FAX:
			return FAX_EDEFAULT == null ? fax != null : !FAX_EDEFAULT
					.equals(fax);
		case Schema1Package.PERSON_SEARCH_TYPE__GENDER:
		...
		case Schema1Package.PERSON_SEARCH_TYPE__PREFERRED_LANGUAGE:
			return PREFERRED_LANGUAGE_EDEFAULT == null ? preferredLanguage != null
					: !PREFERRED_LANGUAGE_EDEFAULT.equals(preferredLanguage);
		}
