 ...
 * @generated
 */
public class AdditionalInputTypeImpl extends EObjectImpl implements
		AdditionalInputType {
	/**
	...
	public EList<InputCriterionRef> getInputCriterion() {
		if (inputCriterion == null) {
			inputCriterion = new EObjectContainmentEList<InputCriterionRef>(
					...
					Schema1Package.ADDITIONAL_INPUT_TYPE__INPUT_CRITERION);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.ADDITIONAL_INPUT_TYPE__NAME, oldName, name));
	}
