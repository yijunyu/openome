...
public class TaskImpl extends EObjectImpl implements Task {
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.TASK;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TASK__DESCRIPTION, oldDescription,
					description));
	}
	...
	public NotificationChain basicSetInputs(Inputs newInputs,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TASK__INPUTS, oldInputs,
					newInputs);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newInputs != inputs) {
			...
			if (inputs != null)
				msgs = ((InternalEObject) inputs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Schema1Package.TASK__INPUTS,
						null, msgs);
			if (newInputs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TASK__INPUTS, newInputs, newInputs));
	}
	...
	public NotificationChain basicSetOutputs(Outputs newOutputs,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TASK__OUTPUTS, oldOutputs,
					newOutputs);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOutputs != outputs) {
			...
			if (outputs != null)
				msgs = ((InternalEObject) outputs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Schema1Package.TASK__OUTPUTS,
						null, msgs);
			if (newOutputs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TASK__OUTPUTS, newOutputs, newOutputs));
	}
	...
	public EList<Expression> getPrecondition() {
		if (precondition == null) {
			precondition = new EObjectContainmentEList<Expression>(
					Expression.class, this, Schema1Package.TASK__PRECONDITION);
		}
		return precondition;
	}
	...
	public EList<Expression> getPostcondition() {
		if (postcondition == null) {
			postcondition = new EObjectContainmentEList<Expression>(
					Expression.class, this, Schema1Package.TASK__POSTCONDITION);
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetResources(Resources newResources,
			NotificationChain msgs) {
		Resources oldResources = resources;
		resources = newResources;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TASK__RESOURCES,
	...
	public void setResources(Resources newResources) {
		if (newResources != resources) {
			NotificationChain msgs = null;
			if (resources != null)
				msgs = ((InternalEObject) resources)
						.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.TASK__RESOURCES, null, msgs);
			if (newResources != null)
				msgs = ((InternalEObject) newResources)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TASK__RESOURCES, newResources, newResources));
	}
	...
	public NotificationChain basicSetOrganizations(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TASK__ORGANIZATIONS,
	...
	public void setOrganizations(Organizations newOrganizations) {
		if (newOrganizations != organizations) {
			...
			if (organizations != null)
				msgs = ((InternalEObject) organizations).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.TASK__ORGANIZATIONS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TASK__ORGANIZATIONS, newOrganizations,
					newOrganizations));
	}
	...
	public NotificationChain basicSetOperationalData(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TASK__OPERATIONAL_DATA,
		...
		if (newOperationalData != operationalData) {
			...
			if (operationalData != null)
				msgs = ((InternalEObject) operationalData).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.TASK__OPERATIONAL_DATA, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TASK__OPERATIONAL_DATA, newOperationalData,
					newOperationalData));
	}
	...
	public NotificationChain basicSetExtendedAttributes(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, Schema1Package.TASK__EXTENDED_ATTRIBUTES,
			...
			if (extendedAttributes != null)
				msgs = ((InternalEObject) extendedAttributes).eInverseRemove(
						this, EOPPOSITE_FEATURE_BASE
								- Schema1Package.TASK__EXTENDED_ATTRIBUTES,
						null, msgs);
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TASK__NAME, oldName, name));
	}
