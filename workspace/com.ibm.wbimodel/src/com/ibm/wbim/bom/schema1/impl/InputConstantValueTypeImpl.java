 ...
 * @generated
 */
public class InputConstantValueTypeImpl extends InputConstantValueImpl
		implements InputConstantValueType {
	/**
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.INPUT_CONSTANT_VALUE_TYPE;
	}
	...
	public void setInput(String newInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.INPUT_CONSTANT_VALUE_TYPE__INPUT, oldInput,
					input));
	}
