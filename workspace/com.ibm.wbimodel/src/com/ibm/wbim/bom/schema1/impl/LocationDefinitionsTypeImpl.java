 ...
 * @generated
 */
public class LocationDefinitionsTypeImpl extends EObjectImpl implements
	 ...
	 * @ordered
	 */
	protected EList<TypeDeclaration> locationDefinition;
	 ...
	 * @generated
	 */
	public EList<TypeDeclaration> getLocationDefinition() {
		if (locationDefinition == null) {
			locationDefinition = new EObjectContainmentEList<TypeDeclaration>(
					TypeDeclaration.class,
					this,
					Schema1Package.LOCATION_DEFINITIONS_TYPE__LOCATION_DEFINITION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.LOCATION_DEFINITIONS_TYPE__LOCATION_DEFINITION:
			return ((InternalEList<?>) getLocationDefinition()).basicRemove(
					otherEnd, msgs);
		}
