...
public class TargetTypeImpl extends EObjectImpl implements TargetType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.TARGET_TYPE;
	}
	...
	public void setContactPoint(String newContactPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TARGET_TYPE__CONTACT_POINT, oldContactPoint,
					contactPoint));
	}
	...
	public void setNode(String newNode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.TARGET_TYPE__NODE, oldNode, node));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.TARGET_TYPE__CONTACT_POINT:
			return CONTACT_POINT_EDEFAULT == null ? contactPoint != null
					: !CONTACT_POINT_EDEFAULT.equals(contactPoint);
		case Schema1Package.TARGET_TYPE__NODE:
			return NODE_EDEFAULT == null ? node != null : !NODE_EDEFAULT
					.equals(node);
		}
