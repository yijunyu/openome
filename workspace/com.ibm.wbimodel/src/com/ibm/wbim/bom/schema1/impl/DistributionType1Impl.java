 ...
 * @generated
 */
public class DistributionType1Impl extends DistributionTypeImpl implements
		DistributionType1 {
	/**
	...
	public void setTimeUnit(TimeUnit newTimeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.DISTRIBUTION_TYPE1__TIME_UNIT, oldTimeUnit,
					timeUnit, !oldTimeUnitESet));
	}
	...
	public void unsetTimeUnit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					Schema1Package.DISTRIBUTION_TYPE1__TIME_UNIT, oldTimeUnit,
					TIME_UNIT_EDEFAULT, oldTimeUnitESet));
	}
