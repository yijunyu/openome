 ...
 * @generated
 */
public class RecurringTimeIntervalTypeImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.RECURRING_TIME_INTERVAL_TYPE;
	}
	...
	public void setStartTime(XMLGregorianCalendar newStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RECURRING_TIME_INTERVAL_TYPE__START_TIME,
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStartDayOfWeek(
			StartDayOfWeekType newStartDayOfWeek, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					Schema1Package.RECURRING_TIME_INTERVAL_TYPE__START_DAY_OF_WEEK,
					oldStartDayOfWeek, newStartDayOfWeek);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setStartDayOfWeek(StartDayOfWeekType newStartDayOfWeek) {
		if (newStartDayOfWeek != startDayOfWeek) {
			...
			if (startDayOfWeek != null)
				msgs = ((InternalEObject) startDayOfWeek)
						.eInverseRemove(
								this,
			...
			if (newStartDayOfWeek != null)
				msgs = ((InternalEObject) newStartDayOfWeek)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.RECURRING_TIME_INTERVAL_TYPE__START_DAY_OF_WEEK,
			...
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					Schema1Package.RECURRING_TIME_INTERVAL_TYPE__START_DAY_OF_WEEK,
					newStartDayOfWeek, newStartDayOfWeek));
	}
	...
	public void setDuration(Duration newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RECURRING_TIME_INTERVAL_TYPE__DURATION,
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.RECURRING_TIME_INTERVAL_TYPE__NAME, oldName,
					name));
	}
