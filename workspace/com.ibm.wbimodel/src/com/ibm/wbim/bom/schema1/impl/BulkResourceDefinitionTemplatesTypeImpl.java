 ...
 * @generated
 */
public class BulkResourceDefinitionTemplatesTypeImpl extends EObjectImpl
		implements BulkResourceDefinitionTemplatesType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<TypeDeclaration> bulkResourceDefinitionTemplate;
	 ...
	 * @generated
	 */
	public EList<TypeDeclaration> getBulkResourceDefinitionTemplate() {
		if (bulkResourceDefinitionTemplate == null) {
			bulkResourceDefinitionTemplate = new EObjectContainmentEList<TypeDeclaration>(
					TypeDeclaration.class,
					this,
					Schema1Package.BULK_RESOURCE_DEFINITION_TEMPLATES_TYPE__BULK_RESOURCE_DEFINITION_TEMPLATE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case Schema1Package.BULK_RESOURCE_DEFINITION_TEMPLATES_TYPE__BULK_RESOURCE_DEFINITION_TEMPLATE:
			return ((InternalEList<?>) getBulkResourceDefinitionTemplate())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case Schema1Package.BULK_RESOURCE_DEFINITION_TEMPLATES_TYPE__BULK_RESOURCE_DEFINITION_TEMPLATE:
			...
			getBulkResourceDefinitionTemplate().addAll(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case Schema1Package.BULK_RESOURCE_DEFINITION_TEMPLATES_TYPE__BULK_RESOURCE_DEFINITION_TEMPLATE:
			return bulkResourceDefinitionTemplate != null
					&& !bulkResourceDefinitionTemplate.isEmpty();
		}
