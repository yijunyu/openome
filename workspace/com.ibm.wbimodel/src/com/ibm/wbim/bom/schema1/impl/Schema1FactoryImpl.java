...
public class Schema1FactoryImpl extends EFactoryImpl implements Schema1Factory {
	...
	public static Schema1Factory init() {
		try {
			Schema1Factory theSchema1Factory = (Schema1Factory) EPackage.Registry.INSTANCE
					.getEFactory("http://www.ibm.com/wbim/bomSchema1.0");
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case Schema1Package.MULTIPLE_INSTANCES_MATCH:
			return createMultipleInstancesMatchFromString(eDataType,
					initialValue);
		...
		case Schema1Package.PREDEFINED_ORGANIZATION_TYPE:
			return createPredefinedOrganizationTypeFromString(eDataType,
					initialValue);
		case Schema1Package.PREDEFINED_RESOURCE_TYPE:
			return createPredefinedResourceTypeFromString(eDataType,
					initialValue);
		...
		case Schema1Package.MULTIPLE_INSTANCES_MATCH_OBJECT:
			return createMultipleInstancesMatchObjectFromString(eDataType,
					initialValue);
		case Schema1Package.NO_INSTANCES_MATCH_OBJECT:
			return createNoInstancesMatchObjectFromString(eDataType,
					initialValue);
		...
		case Schema1Package.NON_NEGATIVE_DOUBLE_OBJECT:
			return createNonNegativeDoubleObjectFromString(eDataType,
					initialValue);
		...
		case Schema1Package.PERCENTAGE_VALUE_OBJECT:
			return createPercentageValueObjectFromString(eDataType,
					initialValue);
		case Schema1Package.PREDEFINED_ORGANIZATION_TYPE_OBJECT:
			return createPredefinedOrganizationTypeObjectFromString(eDataType,
					initialValue);
		case Schema1Package.PREDEFINED_RESOURCE_TYPE_OBJECT:
			return createPredefinedResourceTypeObjectFromString(eDataType,
					initialValue);
		...
		case Schema1Package.UNIT_OBJECT:
			return createUnitObjectFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		case Schema1Package.MULTIPLE_INSTANCES_MATCH:
			return convertMultipleInstancesMatchToString(eDataType,
					instanceValue);
		case Schema1Package.NO_INSTANCES_MATCH:
			return convertNoInstancesMatchToString(eDataType, instanceValue);
		case Schema1Package.PREDEFINED_ORGANIZATION_TYPE:
			return convertPredefinedOrganizationTypeToString(eDataType,
					instanceValue);
		case Schema1Package.PREDEFINED_RESOURCE_TYPE:
			return convertPredefinedResourceTypeToString(eDataType,
					instanceValue);
		case Schema1Package.TIME_UNIT:
		...
		case Schema1Package.MULTIPLE_INSTANCES_MATCH_OBJECT:
			return convertMultipleInstancesMatchObjectToString(eDataType,
					instanceValue);
		case Schema1Package.NO_INSTANCES_MATCH_OBJECT:
			return convertNoInstancesMatchObjectToString(eDataType,
					instanceValue);
		case Schema1Package.NON_NEGATIVE_DOUBLE:
			return convertNonNegativeDoubleToString(eDataType, instanceValue);
		case Schema1Package.NON_NEGATIVE_DOUBLE_OBJECT:
			return convertNonNegativeDoubleObjectToString(eDataType,
					instanceValue);
		case Schema1Package.PARENT_TEMPLATE_TYPE:
		...
		case Schema1Package.PERCENTAGE_VALUE_OBJECT:
			return convertPercentageValueObjectToString(eDataType,
					instanceValue);
		case Schema1Package.PREDEFINED_ORGANIZATION_TYPE_OBJECT:
			return convertPredefinedOrganizationTypeObjectToString(eDataType,
					instanceValue);
		case Schema1Package.PREDEFINED_RESOURCE_TYPE_OBJECT:
			return convertPredefinedResourceTypeObjectToString(eDataType,
					instanceValue);
		case Schema1Package.TIME_UNIT_OBJECT:
		...
		case Schema1Package.UNIT_OBJECT:
			return convertUnitObjectToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '"
					+ eDataType.getName() + "' is not a valid classifier");
		}
	 ...
	 * @generated
	 */
	public BasicDataType createBasicDataTypeFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertBasicDataTypeToString(EDataType eDataType,
	 ...
	 * @generated
	 */
	public Currency createCurrencyFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertCurrencyToString(EDataType eDataType,
			Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public DayOfWeek createDayOfWeekFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertDayOfWeekToString(EDataType eDataType,
			Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public MultipleInstancesMatch createMultipleInstancesMatchFromString(
			EDataType eDataType, String initialValue) {
		MultipleInstancesMatch result = MultipleInstancesMatch
				.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException("The value '" + initialValue
					+ "' is not a valid enumerator of '" + eDataType.getName()
	 ...
	 * @generated
	 */
	public String convertMultipleInstancesMatchToString(EDataType eDataType,
			Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public NoInstancesMatch createNoInstancesMatchFromString(
			EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public String convertNoInstancesMatchToString(EDataType eDataType,
			Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public TimeUnit createTimeUnitFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertTimeUnitToString(EDataType eDataType,
			Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public TypeType1 createTypeType1FromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertTypeType1ToString(EDataType eDataType,
			Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public Object createAssociatedDataTypeFromString(EDataType eDataType,
			String initialValue) {
		...
		try {
			result = createBasicDataTypeFromString(
					Schema1Package.Literals.BASIC_DATA_TYPE, initialValue);
			if (result != null
		...
		try {
			result = createElementNameFromString(
					Schema1Package.Literals.ELEMENT_NAME, initialValue);
			if (result != null
					&& Diagnostician.INSTANCE.validate(eDataType, result, null,
							null)) {
				return result;
	 ...
	 * @generated
	 */
	public String convertAssociatedDataTypeToString(EDataType eDataType,
			Object instanceValue) {
		if (instanceValue == null)
			return null;
		if (Schema1Package.Literals.BASIC_DATA_TYPE.isInstance(instanceValue)) {
			try {
				String value = convertBasicDataTypeToString(
						Schema1Package.Literals.BASIC_DATA_TYPE, instanceValue);
				if (value != null)
					return value;
			} catch (Exception e) {
		...
		if (Schema1Package.Literals.ELEMENT_NAME.isInstance(instanceValue)) {
			try {
				String value = convertElementNameToString(
						Schema1Package.Literals.ELEMENT_NAME, instanceValue);
				if (value != null)
					return value;
			} catch (Exception e) {
				// Keep trying other member types until all have failed.
	 ...
	 * @generated
	 */
	public BasicDataType createBasicDataTypeObjectFromString(
			EDataType eDataType, String initialValue) {
		return createBasicDataTypeFromString(
				Schema1Package.Literals.BASIC_DATA_TYPE, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertBasicDataTypeObjectToString(EDataType eDataType,
			Object instanceValue) {
	 ...
	 * @generated
	 */
	public Currency createCurrencyObjectFromString(EDataType eDataType,
			String initialValue) {
		return createCurrencyFromString(Schema1Package.Literals.CURRENCY,
				initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertCurrencyObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertCurrencyToString(Schema1Package.Literals.CURRENCY,
				instanceValue);
	}
	 ...
	 * @generated
	 */
	public DayOfWeek createDayOfWeekObjectFromString(EDataType eDataType,
			String initialValue) {
		return createDayOfWeekFromString(Schema1Package.Literals.DAY_OF_WEEK,
				initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertDayOfWeekObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertDayOfWeekToString(Schema1Package.Literals.DAY_OF_WEEK,
				instanceValue);
	}
	 ...
	 * @generated
	 */
	public String createElementNameFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertElementNameToString(EDataType eDataType,
			Object instanceValue) {
	 ...
	 * @generated
	 */
	public Object createInstanceOfTypeFromString(EDataType eDataType,
			String initialValue) {
		if (initialValue == null)
			return null;
		Object result = null;
		RuntimeException exception = null;
		try {
			result = createPredefinedResourceTypeFromString(
					Schema1Package.Literals.PREDEFINED_RESOURCE_TYPE,
					initialValue);
			if (result != null
					&& Diagnostician.INSTANCE.validate(eDataType, result, null,
							null)) {
		...
		try {
			result = createPredefinedOrganizationTypeFromString(
					Schema1Package.Literals.PREDEFINED_ORGANIZATION_TYPE,
					initialValue);
			if (result != null
					&& Diagnostician.INSTANCE.validate(eDataType, result, null,
							null)) {
	 ...
	 * @generated
	 */
	public String convertInstanceOfTypeToString(EDataType eDataType,
			Object instanceValue) {
		if (instanceValue == null)
			return null;
		if (Schema1Package.Literals.PREDEFINED_RESOURCE_TYPE
			...
			try {
				String value = convertPredefinedResourceTypeToString(
						Schema1Package.Literals.PREDEFINED_RESOURCE_TYPE,
						instanceValue);
				if (value != null)
					return value;
		...
		if (Schema1Package.Literals.PREDEFINED_ORGANIZATION_TYPE
				.isInstance(instanceValue)) {
			try {
				String value = convertPredefinedOrganizationTypeToString(
						Schema1Package.Literals.PREDEFINED_ORGANIZATION_TYPE,
						instanceValue);
				if (value != null)
					return value;
	 ...
	 * @generated
	 */
	public MultipleInstancesMatch createMultipleInstancesMatchObjectFromString(
			EDataType eDataType, String initialValue) {
		return createMultipleInstancesMatchFromString(
				Schema1Package.Literals.MULTIPLE_INSTANCES_MATCH, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertMultipleInstancesMatchObjectToString(
			EDataType eDataType, Object instanceValue) {
		return convertMultipleInstancesMatchToString(
				Schema1Package.Literals.MULTIPLE_INSTANCES_MATCH, instanceValue);
	}
	 ...
	 * @generated
	 */
	public NoInstancesMatch createNoInstancesMatchObjectFromString(
			EDataType eDataType, String initialValue) {
		return createNoInstancesMatchFromString(
				Schema1Package.Literals.NO_INSTANCES_MATCH, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertNoInstancesMatchObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertNoInstancesMatchToString(
				Schema1Package.Literals.NO_INSTANCES_MATCH, instanceValue);
	}
	 ...
	 * @generated
	 */
	public Double createNonNegativeDoubleFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertNonNegativeDoubleToString(EDataType eDataType,
			Object instanceValue) {
		return XMLTypeFactory.eINSTANCE.convertToString(
	 ...
	 * @generated
	 */
	public Double createNonNegativeDoubleObjectFromString(EDataType eDataType,
			String initialValue) {
		return createNonNegativeDoubleFromString(
				Schema1Package.Literals.NON_NEGATIVE_DOUBLE, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertNonNegativeDoubleObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertNonNegativeDoubleToString(
				Schema1Package.Literals.NON_NEGATIVE_DOUBLE, instanceValue);
	}
	 ...
	 * @generated
	 */
	public Object createParentTemplateTypeFromString(EDataType eDataType,
			String initialValue) {
		if (initialValue == null)
			return null;
		Object result = null;
	 ...
	 * @generated
	 */
	public String convertParentTemplateTypeToString(EDataType eDataType,
			Object instanceValue) {
		if (instanceValue == null)
			return null;
		if (Schema1Package.Literals.PREDEFINED_RESOURCE_TYPE
	 ...
	 * @generated
	 */
	public Double createPercentageValueFromString(EDataType eDataType,
			String initialValue) {
		return (Double) XMLTypeFactory.eINSTANCE.createFromString(
				XMLTypePackage.Literals.DOUBLE, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertPercentageValueToString(EDataType eDataType,
			Object instanceValue) {
		return XMLTypeFactory.eINSTANCE.convertToString(
				XMLTypePackage.Literals.DOUBLE, instanceValue);
	}
	 ...
	 * @generated
	 */
	public Double createPercentageValueObjectFromString(EDataType eDataType,
			String initialValue) {
		return createPercentageValueFromString(
				Schema1Package.Literals.PERCENTAGE_VALUE, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertPercentageValueObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertPercentageValueToString(
				Schema1Package.Literals.PERCENTAGE_VALUE, instanceValue);
	}
	 ...
	 * @generated
	 */
	public PredefinedOrganizationType createPredefinedOrganizationTypeObjectFromString(
			EDataType eDataType, String initialValue) {
		return createPredefinedOrganizationTypeFromString(
				Schema1Package.Literals.PREDEFINED_ORGANIZATION_TYPE,
				initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertPredefinedOrganizationTypeObjectToString(
			EDataType eDataType, Object instanceValue) {
	 ...
	 * @generated
	 */
	public PredefinedResourceType createPredefinedResourceTypeObjectFromString(
			EDataType eDataType, String initialValue) {
		return createPredefinedResourceTypeFromString(
				Schema1Package.Literals.PREDEFINED_RESOURCE_TYPE, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertPredefinedResourceTypeObjectToString(
			EDataType eDataType, Object instanceValue) {
		return convertPredefinedResourceTypeToString(
				Schema1Package.Literals.PREDEFINED_RESOURCE_TYPE, instanceValue);
	}
	 ...
	 * @generated
	 */
	public PredefinedOrganizationType createPredefinedOrganizationTypeFromString(
			EDataType eDataType, String initialValue) {
		PredefinedOrganizationType result = PredefinedOrganizationType
				.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException("The value '" + initialValue
					+ "' is not a valid enumerator of '" + eDataType.getName()
	 ...
	 * @generated
	 */
	public String convertPredefinedOrganizationTypeToString(
			EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public PredefinedResourceType createPredefinedResourceTypeFromString(
			EDataType eDataType, String initialValue) {
		PredefinedResourceType result = PredefinedResourceType
				.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException("The value '" + initialValue
					+ "' is not a valid enumerator of '" + eDataType.getName()
	 ...
	 * @generated
	 */
	public String convertPredefinedResourceTypeToString(EDataType eDataType,
			Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public TimeUnit createTimeUnitObjectFromString(EDataType eDataType,
			String initialValue) {
		return createTimeUnitFromString(Schema1Package.Literals.TIME_UNIT,
				initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertTimeUnitObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertTimeUnitToString(Schema1Package.Literals.TIME_UNIT,
				instanceValue);
	}
	 ...
	 * @generated
	 */
	public Object createTypeTypeFromString(EDataType eDataType,
			String initialValue) {
		if (initialValue == null)
			return null;
		Object result = null;
	 ...
	 * @generated
	 */
	public Object createTypeType2FromString(EDataType eDataType,
			String initialValue) {
		if (initialValue == null)
			return null;
		Object result = null;
	 ...
	 * @generated
	 */
	public String convertTypeType2ToString(EDataType eDataType,
			Object instanceValue) {
		if (instanceValue == null)
			return null;
		if (Schema1Package.Literals.BASIC_DATA_TYPE.isInstance(instanceValue)) {
	 ...
	 * @generated
	 */
	public TypeType1 createTypeTypeObjectFromString(EDataType eDataType,
			String initialValue) {
		return createTypeType1FromString(Schema1Package.Literals.TYPE_TYPE1,
				initialValue);
	}
	...
	public String convertTypeTypeObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertTypeType1ToString(Schema1Package.Literals.TYPE_TYPE1,
				instanceValue);
	}
	 ...
	 * @generated
	 */
	public Unit createUnitObjectFromString(EDataType eDataType,
			String initialValue) {
		return createUnitFromString(Schema1Package.Literals.UNIT, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertUnitObjectToString(EDataType eDataType,
			Object instanceValue) {
		return convertUnitToString(Schema1Package.Literals.UNIT, instanceValue);
	}
