 ...
 * @generated
 */
public class OutputBranchTypeImpl extends OutputBranchImpl implements
		OutputBranchType {
	/**
	...
	public NotificationChain basicSetCondition(Expression newCondition,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.OUTPUT_BRANCH_TYPE__CONDITION, oldCondition,
					newCondition);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setCondition(Expression newCondition) {
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- Schema1Package.OUTPUT_BRANCH_TYPE__CONDITION,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.OUTPUT_BRANCH_TYPE__CONDITION, newCondition,
					newCondition));
	}
	...
	public NotificationChain basicSetOperationalData(
			OutputPathOperationalData newOperationalData, NotificationChain msgs) {
		OutputPathOperationalData oldOperationalData = operationalData;
		operationalData = newOperationalData;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					Schema1Package.OUTPUT_BRANCH_TYPE__OPERATIONAL_DATA,
	...
	public void setOperationalData(OutputPathOperationalData newOperationalData) {
		if (newOperationalData != operationalData) {
			...
			if (operationalData != null)
				msgs = ((InternalEObject) operationalData)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OUTPUT_BRANCH_TYPE__OPERATIONAL_DATA,
			...
			if (newOperationalData != null)
				msgs = ((InternalEObject) newOperationalData)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- Schema1Package.OUTPUT_BRANCH_TYPE__OPERATIONAL_DATA,
