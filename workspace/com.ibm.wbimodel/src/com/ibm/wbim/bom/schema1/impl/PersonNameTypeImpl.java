...
public class PersonNameTypeImpl extends EObjectImpl implements PersonNameType {
	...
	protected EClass eStaticClass() {
		return Schema1Package.Literals.PERSON_NAME_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_NAME_TYPE__NAME, oldName, name));
	}
	...
	public void setAlternativeName1(String newAlternativeName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_NAME_TYPE__ALTERNATIVE_NAME1,
	...
	public void setAlternativeName2(String newAlternativeName2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Schema1Package.PERSON_NAME_TYPE__ALTERNATIVE_NAME2,
