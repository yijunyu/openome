 ...
 * @generated
 */
public class InputConstantValueImpl extends EObjectImpl implements
		InputConstantValue {
	/**
	 ...
	 * @ordered
	 */
	protected EList<PublicInstance> publicInstance;
	...
	public EList<String> getLiteralValue() {
		if (literalValue == null) {
			literalValue = new EDataTypeEList<String>(String.class, this,
					Schema1Package.INPUT_CONSTANT_VALUE__LITERAL_VALUE);
		}
		return literalValue;
	}
	...
	public EList<PublicInstance> getPublicInstance() {
		if (publicInstance == null) {
			publicInstance = new EObjectContainmentEList<PublicInstance>(
					PublicInstance.class, this,
					Schema1Package.INPUT_CONSTANT_VALUE__PUBLIC_INSTANCE);
		}
