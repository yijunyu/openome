...
public interface View {        
    ...
    /** Get the GUI side of this View. */
    //public Canvas getCanvas();

    
    /** Returns the unique (within the model) integer Id for the view. This
     *  helps with serialization, preventing name mangling, and the
    ...
    public void resize(ViewObject o, Double d);
    ...
    /** Displays up a save dialogue and returns a collection whose first
      ...
      * (both of which are <code>String</code>s).  Returns a null vector if no 
      * file was supplied by the user.
      */
